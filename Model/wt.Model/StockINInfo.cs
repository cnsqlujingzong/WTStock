...
namespace wt.Model
{
	public class StockINInfo
	{
		...
		private List<StockINDetailInfo> _stockindetailinfos;
		...
		public List<StockINDetailInfo> StockINDetailInfos
		{
			get
			{
				return this._stockindetailinfos;
			}
			set
			{
				this._stockindetailinfos = value;
			}
		}
