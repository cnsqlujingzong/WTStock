...
public partial class Branch_Basic_DeviceConfItem : Page, IRequiresSessionState
{
	...
	{
		int recordCount = 0;
		this.GridView1.DataSource = DALCommon.GetList_HL(1, "jc_deviceconfitem", "", this.pageSize, this.jsPager.CurrentPageIndex, " DeptID=" + (string)this.Session["Session_wtBranchID"], " ID Desc", out recordCount);
	...
	protected void btnAdd_Click(object sender, EventArgs e)
	{
		...
		else
		{
			...
			deviceConfItemInfo.DeptID = new int?(int.Parse((string)this.Session["Session_wtBranchID"]));
