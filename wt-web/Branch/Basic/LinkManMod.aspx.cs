...
public class Branch_Basic_LinkManMod : Page, IRequiresSessionState
{
	private int id;
	...
	protected HtmlInputText tbSex;

	protected HtmlInputText tbPosition;

	protected TextBox tbTel1;

	protected TextBox tbTel2;

	protected TextBox tbTel3;

	protected TextBox tbFax;

	protected TextBox tbBirthDay;

	protected TextBox tbEmail;

	protected TextBox tbAdr;

	protected TextBox tbRemark;

	protected UpdatePanel UpdatePanel1;

	protected HiddenField hfCusID;
