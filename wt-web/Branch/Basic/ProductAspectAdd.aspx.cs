...
public partial class Branch_Basic_ProductAspectAdd : Page, IRequiresSessionState
{
	private string f;   	
	...
	protected void btnAdd_Click(object sender, EventArgs e)
	{
		...
		string str;
		int num2;
		int num = dALBaseInfo.Add("ProductAspect", baseInfo, "物品外观", false, out str, out num2);
		if (num == 0)
		{
			if (this.f == "1")
			{
