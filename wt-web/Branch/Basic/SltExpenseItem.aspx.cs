...
public partial class Branch_Basic_SltExpenseItem : Page, IRequiresSessionState
{
	...
	protected void Page_Load(object sender, EventArgs e)
	{
		...
		if (!base.IsPostBack)
		{
			this.FillData(hfOrderName.Value, this.hfOrder.Value);
		}
	}
	...
	protected void FillData(string sortExpression, string direction)
	{
		...
		this.gvbranch.DataSource = DALCommon.GetList_HL(1, "ExpenseItem", "", this.pageSize, this.jsPager.CurrentPageIndex, text, fldSort, out recordCount);
