...
public partial class Branch_Services_SltStkAdm : Page, IRequiresSessionState
{
	...
	{
		string text = " DeptID=" + this.Session["Session_wtBranchID"].ToString() + " and bStockMan='√' and Status='在职' ";
