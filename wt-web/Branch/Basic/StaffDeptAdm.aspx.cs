...
public partial class Branch_Basic_StaffDeptAdm : Page, IRequiresSessionState
{
	...
	{
		int recordCount = 0;
		this.GridView1.DataSource = DALCommon.GetList_HL(1, "StaffDept", "", this.pageSize, this.jsPager.CurrentPageIndex, "DeptID=" + (string)this.Session["Session_wtBranchID"], " Array Asc", out recordCount);
	...
	protected void btnAdd_Click(object sender, EventArgs e)
	{
		...
		else
		{
			...
			baseInfo.DeptID = new int?(int.Parse(this.Session["Session_wtBranchID"].ToString()));
			int array = 0;
			...
			if (this.hfRecID.Value == "-1")
			{
				...
				string str;
				int num2;
				int num = dALBaseInfo.Add("StaffDept", baseInfo, "员工部门", true, out str, out num2);
				if (num == 0)
				{
			...
			else
			{
				...
				string str;
				int num = dALBaseInfo.Update("StaffDept", baseInfo, text, out str);
				if (num == 0)
				{
	...
	protected void btnMod_Click(object sender, EventArgs e)
	{
		...
		else
		{
			...
			string str2;
			int num = dALBaseInfo.Update("StaffDept", baseInfo, text, out str2);
			if (num == 0)
			{
				this.hfRecID.Value = baseInfo.ID.ToString();
				this.FillData();
	...
	protected void btnDel_Click(object sender, EventArgs e)
	{
		...
		int num = dALBaseInfo.Delete("StaffDept", iD, out empty);
		if (num == 0)
		{
			this.hfRecID.Value = "-1";
		}
	...
	protected void btnShow_Click(object sender, EventArgs e)
	{
		...
		{
			DALBaseInfo dALBaseInfo = new DALBaseInfo();
			BaseInfo model = dALBaseInfo.GetModel("StaffDept", int.Parse(this.hfRecID.Value));
