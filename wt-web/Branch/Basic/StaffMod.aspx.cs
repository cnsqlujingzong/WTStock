...
public partial class Branch_Basic_StaffMod : Page, IRequiresSessionState
{
	private int id;
	...
	protected void Page_Load(object sender, EventArgs e)
	{
		...
		if (!base.IsPostBack)
		{
			...
			if (model != null)
			{
				...
				OtherFunction.BindStaff(this.ddlSellFormula, "DeptID=" + (string)this.Session["Session_wtBranchID"]);
				OtherFunction.BindStaff(this.ddlSerFormula, "DeptID=" + (string)this.Session["Session_wtBranchID"]);
				OtherFunction.BindStaff(this.ddlStaffDeduct, "DeptID=" + (string)this.Session["Session_wtBranchID"]);
	...
	protected void btnAdd_Click(object sender, EventArgs e)
	{
		...
		if (staffListInfo.JobNO != this.hfName.Value)
		{
			...
			chkfld = " JobNO='" + staffListInfo.JobNO + "' and DeptID=" + (string)this.Session["Session_wtBranchID"];
		}
		DALStaffList dALStaffList = new DALStaffList();
		string str;
