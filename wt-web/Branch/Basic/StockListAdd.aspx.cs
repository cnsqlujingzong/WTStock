...
public partial class Branch_Basic_StockListAdd : Page, IRequiresSessionState
{
	private string f;
	...
	protected void Page_Load(object sender, EventArgs e)
	{
		...
		if (!base.IsPostBack)
		{
			...
			OtherFunction.BindStaff(this.ddlStkAdm, "bStockMan=1 and DeptID=" + (string)this.Session["Session_wtBranchID"]);
			OtherFunction.BindStaff(this.ddlStkAdm2, "bStockMan=1 and DeptID=" + (string)this.Session["Session_wtBranchID"]);
		}
	}
	...
	protected void btnAdd_Click(object sender, EventArgs e)
	{
		...
		stockListInfo.DeptID = new int?(int.Parse((string)this.Session["Session_wtBranchID"]));
