<%@ page language="C#"  CodeFile="sltfault.aspx.cs"     autoeventwireup="true" inherits="Branch_Basic_SltFault" theme="Themes" enableEventValidation="false" %>
   ...
   <div class="ftool">
        ...
        <table cellpadding="0" cellspacing="0" class="tb2">
                ...
                <td>
                    ...
                    <input id="btnNew" type="button" value="新建" class="bt1" onclick="parent.ShowDialog2(540, 200, '../Branch/Basic/FaultAdd.aspx?p=t'+strtel, '新建故障');" />
                    </td>
                 </tr>
            </table>   
        </div>
