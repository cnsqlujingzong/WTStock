<%@ page language="C#"  CodeFile="staffadd.aspx.cs"     autoeventwireup="true" inherits="Branch_Basic_StaffAdd" theme="Themes" enableEventValidation="false" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div id="divinfo1" class="divinfo" style="height:311px;">
            ...
            <ContentTemplate>
                <table cellpadding="0" cellspacing="0" class="tb3">
                    ...
                    <tr>
                        ...
                        <td colspan="3" style="padding-left:0px;"><asp:TextBox ID="tbAccount" runat="server" CssClass="pin pinw"></asp:TextBox></td>
                    </tr>
                    <tr>
            ...
            <Columns>
            <asp:BoundField DataField="ID" HeaderText="xu" />
