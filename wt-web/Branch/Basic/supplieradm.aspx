<%@ page language="C#"  CodeFile="supplieradm.aspx.cs"     autoeventwireup="true" inherits="Branch_Basic_SupplierAdm" theme="Themes" enableEventValidation="false" %>
        ...
        <div class="ftoolleft">
         <table cellpadding="0" cellspacing="0" class="tb2">
            ...
            <td>
                ...
                <input id="btnNew" type="button" value="新建" class="bt1" runat ="server" onclick="NewSup();" />
                <input id="btnMod" type="button" value="修改" class="bt1" runat ="server" onclick="ChkMod(540, 290,'Basic/SupplierMod.aspx','修改厂商');" />
    ...
    <div id="cnbut" style="overflow:hidden;">
        ...
        <div id="info1" style="height:175px;background:#ECE9D8;">
            ...
            <table cellpadding="0" cellspacing="0" class="tb2">
                <tr>
                <td>
                   <input id="btnNewLink" type="button" runat="server" value="新建" class="bt1" onclick="NewLink();" />
                   <input id="btnModLink" type="button" runat="server" value="修改" class="bt1" onclick="ModLink();" />
