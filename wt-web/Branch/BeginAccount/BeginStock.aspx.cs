...
public partial class Branch_BeginAccount_BeginStock : Page, IRequiresSessionState
{
	...
	protected void btnChk_Click(object sender, EventArgs e)
	{
		...
		else
		{
			...
			int num = dALBeginStock.Update(beginStockListInfo, int.Parse((string)this.Session["Session_wtBranchID"]), iOperator, out empty);
			if (num == 0)
			{
