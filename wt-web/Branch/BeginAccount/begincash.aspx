<%@ page language="C#"  CodeFile="begincash.aspx.cs"     autoeventwireup="true" inherits="Branch_BeginAccount_BeginCash" theme="Themes" enableEventValidation="false" %>
...
<body onload="Chkset();" onclick="parent.Sethidden1();">
    ...
    <div class="ftool">
        ...
        <table cellpadding="0" cellspacing="0" class="tb2">
            ...
            <td>
                ...
                <input id="btnMod" type="button" value="修改期初" class="bt1" onclick="ChkMod(380,137,'BeginAccount/CashMod.aspx','修改期初-现金银行');" />
                <asp:Button ID="btnBegin" runat="server" Text="初始化" CssClass="bt1" OnClientClick="if(ChkConfs()==false) return false;" UseSubmitBehavior="false" OnClick="btnBegin_Click"/>
        ...
        <div class="ftoolright">
            <table cellpadding="0" cellspacing="0" class="tb2">
                ...
                <asp:DropDownList ID="ddlKey" runat="server" CssClass="pindl" onchange="document.getElementById('tbCon').focus();">
                    <asp:ListItem Value="_Name">按帐户查询</asp:ListItem>
                    <asp:ListItem Value="BeginMoney">按期初金额查询</asp:ListItem>
    ...
    <asp:GridView ID="GvData" runat="server" AutoGenerateColumns="false" SkinID="gv1" OnRowDataBound="GvData_RowDataBound" EnableViewState="false" Width="50%">
        <Columns>
            ...
            <asp:BoundField HeaderText="期初金额" DataField="BeginMoney" />
        </Columns>
    </asp:GridView>
...
function ChkConfs()
{
    if(confirm("确认要初始化期初现金银行吗？初始化后将不能修改"))
    {
        return true;
    }
    else
...
function Chkbom()
{
    $("fbon").innerHTML=parent.DrawInfo("期初现金银行");
}
</script>
