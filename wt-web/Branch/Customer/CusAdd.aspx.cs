...
public partial class Branch_Customer_CusAdd : Page, IRequiresSessionState
{
	private string f;
	...
	protected void btnAdd_Click(object sender, EventArgs e)
	{
		...
		customerListInfo.TrackOperatorID = int.Parse((string)this.Session["Session_wtUserBID"]);
		...
		string str;
		int num3;
		int num2 = dALCustomerList.Add(customerListInfo, this.cbsys.Checked, out str, out num3);
		if (num2 == 0)
		{
	...
	{
		this.tbQQ.Text = (this.tbAccount.Text = (this.tbAdr.Text = (this.tbCusNO.Text = (this.tbEmail.Text = (this.tbFax.Text = (this.tbLinkMan.Text = (this.tbName.Text = (this.tbRemark.Text = (this.tbTel.Text = (this.tbTel2.Text = (this.tbZip.Text = string.Empty)))))))))));
