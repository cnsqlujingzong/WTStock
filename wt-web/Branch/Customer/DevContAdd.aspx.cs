...
public partial class Branch_Customer_DevContAdd : Page, IRequiresSessionState
{
	private int id;
	...
	protected void btnAdd_Click(object sender, EventArgs e)
	{
		...
		else
		{
			...
			maintenanceContractInfo.DeptID = int.Parse((string)this.Session["Session_wtBranchID"]);
			...
			maintenanceContractInfo.OperatorID = int.Parse((string)this.Session["Session_wtUserBID"]);
