...
public partial class Branch_Customer_DeviceListAdm : Page, IRequiresSessionState
{
	...
	protected void LoadField()
	{
		...
		if (dataTable.Rows.Count > 0)
		{
			...
			templateField.ItemTemplate = new MyTemplatexcus1("", DataControlRowType.DataRow);
	...
	protected void FillData(string sortExpression, string direction)
	{
		...
		{
			text += string.Format(" and (DeptID={0} or BranchID={0})", (string)this.Session["Session_wtBranchID"]);
		}
		...
		if (this.gvtrouble.Rows.Count > 0)
		{
			for (int i = 1; i < this.gvtrouble.HeaderRow.Cells.Count; i++)
			{
				...
				if (dataField != "ID")
				{
					...
					{
						HiddenField expr_3E4 = this.hfTbTitle;
						expr_3E4.Value = expr_3E4.Value + "," + text2;
					}
					...
					{
						HiddenField expr_436 = this.hfTbField;
						expr_436.Value = expr_436.Value + "," + dataField;
					}
				}
			}
		}
