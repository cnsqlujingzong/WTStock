...
public partial class Branch_Customer_MaintenanceContract : Page, IRequiresSessionState
{
			...
			for (int i = 0; i < this.gvdata.HeaderRow.Cells.Count; i++)
			{
				if (i > 1)
				{
					...
					if (dataField != "ID")
					{
						...
						{
							HiddenField expr_325 = this.hfTbTitle;
							expr_325.Value = expr_325.Value + "," + text2;
						}
						...
						{
							HiddenField expr_375 = this.hfTbField;
							expr_375.Value = expr_375.Value + "," + dataField;
						}
					}
				}
			}
