...
public partial class Branch_Customer_Mtnsconcd : Page, IRequiresSessionState
{
	...
	protected void Page_Load(object sender, EventArgs e)
	{
		...
		if (!base.IsPostBack)
		{
			...
			OtherFunction.BindStaff(this.ddlSeller, "DeptID=" + this.Session["Session_wtBranchID"].ToString() + " and Status=0");
