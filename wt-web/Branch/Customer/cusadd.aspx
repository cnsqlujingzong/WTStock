<%@ page language="C#"  CodeFile="cusadd.aspx.cs"     autoeventwireup="true" inherits="Branch_Customer_CusAdd" theme="Themes" enableEventValidation="false" %>
        ...
        <div id="divinfo1" class="divinfo" style="height:282px;">
            ...
            <div id="info2">
              ...
              <table cellpadding="0" cellspacing="0" class="tb3">
                    <tr>
                    <td style="padding-left:0px;">
                    <input id="btnNewLinkMan" type="button" value="新建" class="bt1" onclick="if(strtel!=''&&'<%=Str_D %>'=='3') return false;parent.ShowDialog<%=Str_D %>(460, 263, '../Branch/Customer/CusLinkManAdd.aspx?f=<%=Str_F %>'+strtel, '新建联系人');"/>
                    <input id="btnEditLinkMan" type="button" value="修改" class="bt1" onclick="if(strtel!=''&&'<%=Str_D %>'=='3') return false;ModLinkMan(460, 263,'../Branch/Customer/CusLinkManMod.aspx','修改联系人');"/>
...
function SltCoor()
{
    ...
    parent.ShowDialog<%=Str_D %>(800,520,"../Branch/Customer/SltCoor.aspx"+"?str="+escape(str)+"&f=<%=Str_F %>"+strtel,'选择坐标');
}
