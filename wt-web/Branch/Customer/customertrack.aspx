<%@ page language="C#"  CodeFile="customertrack.aspx.cs"     autoeventwireup="true" inherits="Branch_Customer_CustomerTrack" theme="Themes" enableEventValidation="false" %>
...
function ShowCus()
{
    ChkMod(600, 430,'Customer/CusMod.aspx','修改客户');
}
function ChkEditClass()
{
    ...
    {
        parent.ShowDialog(300, 242,'Customer/EditCusClass.aspx?id='+id,'批量修改跟踪信息');
    }
}
function NewT()
{
