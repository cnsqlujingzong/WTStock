<%@ page language="C#"  CodeFile="devcontadd.aspx.cs"     autoeventwireup="true" inherits="Branch_Customer_DevContAdd" theme="Themes" enableEventValidation="false" %>
...
<body>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional" RenderMode="Inline">
        ...
        <tr>
            ...
            <tr>
                ...
                金额：</td>
                <td style="padding-left:0px;">
                    <asp:TextBox ID="tbAmount" runat="server" CssClass="pin3" ></asp:TextBox>
                </td>
                <td align="right" class="sysred">
                现收金额：</td>
                <td style="padding-left:0px;">
                    <asp:TextBox ID="tbInCash" runat="server" CssClass="pin3" ></asp:TextBox>
                </td>
                <td align="right" colspan="2">起始日期：</td>
                <td style="padding-left:0px;">
                ...
                <ContentTemplate>
                    <asp:GridView ID="gvdata" runat="server" AutoGenerateColumns="false" SkinID="gv3" OnRowDataBound="gvdata_RowDataBound" OnRowDeleting="gvdata_RowDeleting">
                        ...
                        <asp:TemplateField HeaderText="选择">
                            <ItemTemplate>
                                <asp:RadioButton ID="rbxz" runat="server"/>
                            </ItemTemplate>
                        </asp:TemplateField>
                        ...
                        <asp:TemplateField HeaderText="序列号">
                            <ItemTemplate>
                                <asp:TextBox ID="tbSN" runat="server" CssClass="tbstyle" Text='<%# Eval("SN") %>' Width="100" onfocus="select();"></asp:TextBox>
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="机器编号">
                            <ItemTemplate>
                                <asp:TextBox ID="tbDevNO" runat="server" CssClass="tbstyle" Text='<%# Eval("DeviceNO") %>' Width="100" onfocus="select();"></asp:TextBox>
                            </ItemTemplate>
                        </asp:TemplateField>
                        ...
                        <asp:TemplateField HeaderText="备注">
                            <ItemTemplate>
                                <asp:TextBox ID="tbRemark" runat="server" CssClass="tbstyle" Text='<%# Eval("Remark") %>' Width="100" onfocus="select();"></asp:TextBox>
                            </ItemTemplate>
                        </asp:TemplateField>
    ...
    <table cellpadding="0" cellspacing="0" class="tb3">
        <tr>
            ...
            <td align="right" style="padding-right:10px;">
                ...
                <asp:Button ID="btnCopy" runat="server" Text="复制机器" CssClass="bcopy" UseSubmitBehavior="false" OnClientClick="if(ChkSlt()==false)return false;" OnClick="btnCopy_Click"/>
            </td>
        </tr>
    </table>
    </ContentTemplate>
    ...
    <tr>
        <td>
            <span class="si1">若手工输入机器序列号，输入完成后回车</span>
        </td>
        <td align="right">
...
function ViewCus()
{
    ...
    {
        //新建客户
        parent.ShowDialog1(600, 430, '../Headquarters/Customer/CusAdd.aspx?f=1', '新建客户');
    }
    else
    {
        //修改客户
        parent.ShowDialog1(600, 430, '../Headquarters/Customer/CusMod.aspx?f=1&id='+cusid, '客户信息');
    }
}
