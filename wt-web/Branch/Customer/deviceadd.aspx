<%@ page language="C#"  CodeFile="deviceadd.aspx.cs"     autoeventwireup="true" inherits="Branch_Customer_DeviceAdd" theme="Themes" enableEventValidation="false" %>
        ...
        <div class="sdiv">
            ...
            <td style="padding:0px;"><input id="btnSltStaff" type="button" value="" onclick="SltTec();" class="bview"/></td>
                ...
                <tr>
                    ...
                    <td style="padding-left:0px;">
                        <div class="isinDiv">
                            <asp:TextBox ID="tbBrand" runat="server" CssClass="pin pinin" AutoCompleteType="Disabled" onblur="ChkPBrand();" onmousedown="getSearchResult1('../Customer/SchBrand.aspx','tbBrand','hfBrand','1','',event);" onkeyup="getSearchResult1('../Customer/SchBrand.aspx','tbBrand','hfBrand','1','',event);"></asp:TextBox>
                    ...
                    <td style="padding-left:0px;">
                        <div class="isinDiv">
                            <asp:TextBox ID="tbClass" runat="server" CssClass="pin pinin" AutoCompleteType="Disabled" onblur="ChkPClass();" onmousedown="getSearchResult1('../Customer/SchClass.aspx','tbClass','hfClass','1','',event);" onkeyup="getSearchResult1('../Customer/SchClass.aspx','tbClass','hfClass','1','',event);">
                            </asp:TextBox>
                ...
                <tr>
                    ...
                    <td style="padding-left:0px;">
                        <div class="isinDiv">
                            <asp:TextBox ID="tbModel" runat="server" CssClass="pin pinin" AutoCompleteType="Disabled" onblur="ChkPModel();" onmousedown="getSearchResult1('../Customer/SchModel.aspx','tbModel','hfModel','1','',event);" onkeyup="getSearchResult1('../Customer/SchModel.aspx','tbModel','hfModel','1','',event);"></asp:TextBox>
                ...
                <tr>
                    ...
                    <td align="right"><asp:Label ID="lbuserdef1" runat="server" Text="Label"></asp:Label>：</td>
...
function SltTec()
{
    ...
    parent.ShowDialog1(400, 510, '../Branch/Services/SltTec.aspx?f=1', '技术员');
}
function SltCus()
{
    if("<%=Str_F %>"=="2")
    ...
    parent.ShowDialog1(800, 500, 'Customer/SltCus.aspx?f=1', '选择客户');
}
</script>
