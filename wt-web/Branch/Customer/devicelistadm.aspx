<%@ page language="C#"  CodeFile="devicelistadm.aspx.cs"     autoeventwireup="true" inherits="Branch_Customer_DeviceListAdm" theme="Themes" enableeventvalidation="false" %>
...
<body onload="Chkset();" onclick="parent.Sethidden1();">
    ...
    <div id="cnbut" style="overflow:hidden;">
       ...
       <table cellpadding="0" cellspacing="0" class="tb2" width="100%">
        ...
        <div class="cndiv2" id="cndiv25" style="height:116px;">
