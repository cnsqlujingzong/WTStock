<%@ page language="C#"  CodeFile="devicemod.aspx.cs"     autoeventwireup="true" inherits="Branch_Customer_DeviceMod" theme="Themes" enableEventValidation="false" %>
...
function SltCus()
{
    parent.ShowDialog1(800, 500, '../Branch/Customer/SltCus.aspx?f=1', '选择客户');
}
</script>
