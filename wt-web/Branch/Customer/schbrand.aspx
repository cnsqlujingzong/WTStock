<%@ page language="C#"  CodeFile="schbrand.aspx.cs"     autoeventwireup="true" inherits="Branch_Customer_SchBrand" theme="Themes" enableEventValidation="false" %>
...
<body>
    ...
    <asp:GridView ID="gvice" runat="server" AutoGenerateColumns="false" SkinID="sch" ShowHeader="false" OnRowDataBound="gvice_RowDataBound" EnableViewState="false" Width="100%">
        <Columns>
            ...
            <asp:BoundField HeaderText="机器品牌" DataField="_Name" />
        </Columns>
    </asp:GridView>
    </div>
