<%@ page language="C#"  CodeFile="schcuslist2.aspx.cs"     autoeventwireup="true" inherits="Branch_Customer_SchCusList2" theme="Themes" enableEventValidation="false" %>
    ...
    <table cellpadding="0" cellspacing="0" class="schtb" width="100%">
        <tr>
            <td align="right" style="padding-right:10px;">
                <input id="btnNew" type="button" value="新建客户" class="bt1" onclick="parent.ShowDialog<%=Str_F %>(600, 400, '../Branch/Customer/CusAdd.aspx?f=<%=Str_F %>', '新建客户');MoveDivTable();" />
