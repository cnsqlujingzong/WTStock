...
public partial class Branch_Financial_BankDetail : Page, IRequiresSessionState
{
	...
	{
		string text = " DeptID=" + (string)this.Session["Session_wtBranchID"] + " and Status='已审核' ";
		if (this.id > 0)
		{
			text = text + " and AccountID=" + this.id.ToString();
		}
