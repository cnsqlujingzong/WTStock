...
public partial class Branch_Financial_DueDetail : Page, IRequiresSessionState
{
	...
	{
		string text = " DeptID=" + this.Session["Session_wtBranchID"].ToString() + " and Status='待审核' and DueMoney>0 and AccountID=" + this.id.ToString();
