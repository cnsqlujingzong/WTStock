...
public partial class Branch_Financial_ManualHedge : Page, IRequiresSessionState
{
	private int id;
	...
	protected void Page_Load(object sender, EventArgs e)
	{
		...
		if (!base.IsPostBack)
		{
			...
			OtherFunction.BindChargeAccount(this.ddlAccount, " DeptID=" + (string)this.Session["Session_wtBranchID"] + "");
			...
			if (model != null)
			{
				...
				DataTable dataTable = DALCommon.GetDataList("zk_cusarrearage", "", string.Concat(new string[]
				{
					" DeptID=",
