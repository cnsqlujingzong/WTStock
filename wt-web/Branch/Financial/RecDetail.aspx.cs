...
public partial class Branch_Financial_RecDetail : Page, IRequiresSessionState
{
	...
	protected void FillData(string sortExpression, string direction)
	{
		...
		this.gvcus.DataSource = DALCommon.GetList_HL(1, "zk_incomeexpenses", "", this.pageSize, this.jsPager.CurrentPageIndex, text, fldSort, out recordCount);
		this.gvcus.DataBind();
	...
	{
		string text = " DeptID=" + this.Session["Session_wtBranchID"].ToString() + " and Status='待审核' and RecMoney>0 and AccountID=" + this.id.ToString();
