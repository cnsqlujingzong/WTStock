...
public partial class Branch_Financial_Transfer : Page, IRequiresSessionState
{
	...
	protected void Page_Load(object sender, EventArgs e)
	{
		...
		if (!base.IsPostBack)
		{
			...
			OtherFunction.BindChargeAccount(this.ddlFAccount, " DeptID=" + (string)this.Session["Session_wtBranchID"] + "");
			OtherFunction.BindChargeAccount(this.ddlSAccount, " DeptID=" + (string)this.Session["Session_wtBranchID"] + "");
	...
	protected int BillAdd(out int iTbid, out int iTbid2)
	{
		...
		incomeExpensesInfo2.DeptID = new int?(int.Parse((string)this.Session["Session_wtBranchID"]));
