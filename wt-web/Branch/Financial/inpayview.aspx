<%@ page language="C#"  CodeFile="InPayView.aspx.cs"     autoeventwireup="true" inherits="InPayView" enableEventValidation="false" %>
     ...
     <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional" RenderMode="Inline">
       <ContentTemplate>
        ...
        <tr>
            ...
            <td align="right">应<asp:Label ID="lbsya" runat="server" Text="Label"></asp:Label>款：</td>
            <td style="padding-left:0px;">
                <asp:TextBox ID="tbAmount" runat="server" CssClass="pinb" ReadOnly="true"></asp:TextBox>
            </td>
        </tr>
        <tr>
            <td>优惠金额：</td>
            <td style="padding-left:0px;">
                <asp:TextBox ID="tbYAmount" runat="server" CssClass="pinb" ReadOnly="true"></asp:TextBox>
            </td>
            <td align="right">实<asp:Label ID="lbsyb" runat="server"></asp:Label>款：</td>
            <td style="padding-left:0px;">
                <asp:TextBox ID="tbRealAmount" runat="server" CssClass="pinb" ReadOnly="true"></asp:TextBox>
            </td>
            <td>结算方式：</td>
            <td style="padding-left:0px;">
