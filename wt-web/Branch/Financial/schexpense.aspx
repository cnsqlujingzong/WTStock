<%@ page language="C#"  CodeFile="schexpense.aspx.cs"     autoeventwireup="true" inherits="Branch_Financial_SchExpense" theme="Themes" enableeventvalidation="false" %>
...
<body onload="Chkset();" onclick="parent.Sethidden1();">
    ...
    <div class="ftool">
        ...
        <div class="ftoolright">
            ...
            <asp:Button ID="btnExcelDetail" runat="server" CssClass="bsch" Text="明细导出" OnClientClick="if(ChkToExcel()==false)return false;" OnClick="btnExcelDetail_Click" /></td>
            </tr>
            </table>   
        </div>
    ...
    <asp:HiddenField ID="hfview" runat="server" Value="-1" />
    </ContentTemplate>
    <Triggers>
    ...
    <div id="cnbut">
        <div class="ftool2">
            <div id="mytabs" style="padding-left:2px;">
                ...
                <span id="tabs1" class="tabs_active" >报销明细</span>
        ...
        <ContentTemplate>
            <asp:GridView ID="GridView2" runat="server" AutoGenerateColumns="false" SkinID="gv4" EnableViewState="false" ShowFooter="true" OnRowDataBound="GridView2_RowDataBound" >
                <Columns>
                 <asp:BoundField HeaderText="序" />
                 <asp:BoundField DataField="_Name" HeaderText="项目名称" /> 
    ...
    <asp:UpdatePanel ID="UpdatePanel2" runat="server">
        <ContentTemplate>
            <span class="bs1" style="color:#ff0000;">未审核金额:<asp:Label ID="Label1" runat="server" Text=""></asp:Label></span>
            <span class="bs1" style="color:#0000ff;">未发放金额:<asp:Label ID="Label2" runat="server" Text=""></asp:Label></span>
