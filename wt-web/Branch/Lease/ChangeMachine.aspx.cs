...
public partial class Branch_Lease_ChangeMachine : Page, IRequiresSessionState
{
	...
	protected void btnExcel_Click(object sender, EventArgs e)
	{
		...
		DataTable dt = DALCommon.GetDataList("v_zl_leasedevice", this.hfTbField.Value, strCondition).Tables[0];
	...
	protected void GridView1_RowDataBound(object sender, GridViewRowEventArgs e)
	{
		...
		if (e.Row.RowType == DataControlRowType.DataRow)
		{
			...
			if (e.Row.Cells[4].Text == "阶梯式算法")
			{
				e.Row.Cells[4].Text = "阶梯式算法<a href=\"#\" onclick=\"ViewFormula('" + e.Row.Cells[0].Text + "')\">查看公式</a>";
			}
		}
	}
