...
public partial class Branch_Lease_LeaseCancel : Page, IRequiresSessionState
{
    private string id;
	...
	protected void btnAdd_Click(object sender, EventArgs e)
	{
		...
		for (int i = 0; i < array.Length; i++)
		{
			...
			if (num3 != 0)
			{
				int num4 = dALLease.ChkLeaseCancel(num3, int.Parse((string)this.Session["Session_wtUserBID"]), FunLibrary.ChkInput(this.tbCaReason.Value), out empty);
				if (num4 == 0)
				{
					num2++;
				}
