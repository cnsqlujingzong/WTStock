...
public partial class Branch_Lease_LeaseTX : Page, IRequiresSessionState
{
	...
	{
		string text = " DeptID=" + int.Parse((string)this.Session["Session_wtBranchID"]) + " and curStatus='正常' ";
