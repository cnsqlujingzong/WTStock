...
public partial class Branch_Lease_LeaseView : Page, IRequiresSessionState
{
	...
	protected void Page_Load(object sender, EventArgs e)
	{
		...
		if (!base.IsPostBack)
		{
			...
			if (dataTable.Rows.Count > 0)
			{
				...
				Branch_Lease_LeaseView.leaseType = (this.tbType.Text = dataTable.Rows[0]["Type"].ToString());
	...
	protected void gvdata_RowDataBound(object sender, GridViewRowEventArgs e)
	{
		...
		if (Branch_Lease_LeaseView.leaseType == "非抄表类租赁")
		{
	...
	protected void btnAdd_Click(object sender, EventArgs e)
	{
		...
		num3 = dALLease.Update(leaseInfo, (string)this.Session["Session_wtUserBID"], out str);
		if (num3 == 0)
		{
