...
public partial class Branch_Lease_SettleCharge : Page, IRequiresSessionState
{


	private int id;

	private decimal dec_Rec = 0m;
	...
	protected void Page_Load(object sender, EventArgs e)
	{
		...
		if (!base.IsPostBack)
		{
			...
			OtherFunction.BindChargeItem(this.ddlItem, " Type=0 and DeptID=" + int.Parse((string)this.Session["Session_wtBranchID"]) + "");
			OtherFunction.BindChargeStyle(this.ddlChargeStyle, "");
			OtherFunction.BindInviceClass(this.ddlInvoiceClass, "");
			OtherFunction.BindChargeAccount(this.ddlAccount, "DeptID=" + int.Parse((string)this.Session["Session_wtBranchID"]) + "");
	...
	protected void gvdata_RowDataBound(object sender, GridViewRowEventArgs e)
	{
		...
		if (e.Row.RowType == DataControlRowType.DataRow)
		{
			...
			textBox2.Attributes.Add("onchange", string.Concat(new object[]
			{
				"calcAmount3(",
				textBox2.ClientID,
				",",
