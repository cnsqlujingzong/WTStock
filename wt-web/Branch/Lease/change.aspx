<%@ page language="C#"  CodeFile="change.aspx.cs"     autoeventwireup="true" inherits="Branch_Lease_Change" theme="Themes" enableEventValidation="false" %>
    ...
    <fieldset style=" border: 1px #808080 solid; padding:5px 0; width:440px;">
      ...
      <table cellpadding="0" cellspacing="0" class="tb5">
            ...
            <tr>
                ...
                <td align="right">
                    <asp:Label ID="lbCount" runat="server" Text="计数器："></asp:Label>
                </td>
                <td align="left" style="padding-left:0px;"><a href="#" runat="server" id="edit" onclick="EditQty('tbQty');">编辑计数器</a>
                <span style="display:none;">
                <asp:TextBox ID="tbQty" runat="server"></asp:TextBox></span>
                    <asp:TextBox ID="tbOutCount" runat="server" CssClass="pin" Visible="false"></asp:TextBox>
                </td>
                <tr runat="server" id="tr">
                <td align="right">租机单价：</td>
                <td style="padding-left:0px;">
        ...
        <table cellpadding="0" cellspacing="0" class="tb5">
            ...
            <tr>
                ...
                <td>
                    ...
                    <asp:Label ID="lbInCount" runat="server" Text="入库数量"></asp:Label>
                </td>
                <td style="padding-left:0px;">
