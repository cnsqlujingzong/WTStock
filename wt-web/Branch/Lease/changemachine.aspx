<%@ page language="C#"  CodeFile="changemachine.aspx.cs"     autoeventwireup="true" inherits="Branch_Lease_ChangeMachine" theme="Themes" enableEventValidation="false" %>
...
<body onload="Chkset();" onclick="parent.Sethidden1();">
    ...
    <div class="ftool">
        ...
        <table cellpadding="0" cellspacing="0" class="tb2">
            ...
            <td>
                ...
                <input id="btnBack" type="button" value="退机" class="bt1" onclick="backMachine();" />
                <input id="btnChange" type="button" value="换机" class="bt1" onclick="changeMachine();" />
    ...
    <asp:GridView ID="gvdata" runat="server" AutoGenerateColumns="false" SkinID="gv1" OnRowDataBound="gvdata_RowDataBound" EnableViewState="false">
        <Columns>
            ...
            <asp:BoundField HeaderText="ID" DataField="BillID" />
            <asp:BoundField HeaderText="业务类别" DataField="Type" />
            <asp:BoundField HeaderText="业务编号" DataField="strBillID" />
    ...
    <div id="cnbut" style="overflow:hidden;">
        <div class="ftool2">
            <div id="mytabs" style="padding-left:2px;">
                ...
                <span id="tabs1" onclick="ChkTab('1');">计数器</span>
        ...
        <ContentTemplate>
            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="false" SkinID="gv4" OnRowDataBound="GridView1_RowDataBound"  EnableViewState="false" >
                <Columns>
                    ...
                    <asp:BoundField HeaderText="计算方式" DataField="ChargeStyle" />
...
function ModBill(id)
{
    parent.ShowDialog(800, 480,'Lease/LeaseView.aspx?id='+id,'业务单');
}
function ViewFormula(id)
{
    parent.ShowDialog(400, 300,'Lease/ViewFormula.aspx?id='+id, '查看公式');
}
function Chkset()
{
    Chkwhs();
...
function Chkbom()
{
    $("fbon").innerHTML=parent.DrawInfo("设备退换");
}
function backMachine()
{
    parent.ShowDialog(458, 165,'Lease/DevBack.aspx?id='+$("hfRecID").value,'退机');
}
function changeMachine()
{
    parent.ShowDialog(458, 325,'Lease/Change.aspx?id='+$("hfRecID").value,'换机');
}
</script>
