<%@ page language="C#"  CodeFile="devbackbat.aspx.cs"     autoeventwireup="true" inherits="Branch_Lease_DevBackBat" theme="Themes" enableEventValidation="false" %>
...
<body>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
        ...
        <asp:GridView ID="gvdata" runat="server" AutoGenerateColumns="false" SkinID="gv3" OnRowDataBound="gvdata_RowDataBound" OnRowDeleting="gvdata_RowDeleting">
            ...
            <ItemTemplate>
                <asp:TextBox ID="tbInCount" runat="server" Text='<%# Eval("iCount") %>' CssClass="tbstyle" oldNum='<%# Eval("iCount") %>' onfocus="select();"></asp:TextBox>
            </ItemTemplate>
            </asp:TemplateField>
