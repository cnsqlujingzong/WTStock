...
<head runat="server">
    <title></title>
    <link href="../../Headquarters/Mynavigation/css.css" rel="stylesheet" type="text/css" />
</head>
<body onclick="parent.parent.Sethidden1();" style="overflow:hidden;">
    <form id="form1" runat="server" style="height: 100%;">
        ...
        <div id="top">
            ...
            <div class="lefts" style="background: url(../../Headquarters/Mynavigation/images/R-top_01.jpg) no-repeat"></div>
            <div class="right">
            </div>
        </div>
        <div id="content" style="overflow:auto;">
            ...
            <div class="leftc">
                ...
                <table border="0" cellspacing="0" cellpadding="0">
                  ...
                  <tr>
                    <td width="40" align="left" valign="top"><img src="../../Headquarters/Mynavigation/images/XTTX_1.jpg" width="34" height="37" /></td>
                    <td align="left">
		            <ul>
		            <li class="texts">服务单</li>
		            <li class="text">
		              <a href="#d" onclick="parent.parent.SetFrame('sxqr','Services/ServicesConf.aspx','送修确认');">送修确认<asp:Label ID="lbt2" runat="server" Text="(0)" CssClass="red"></asp:Label></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		              <a href="#d" onclick="parent.parent.SetFrame('fwdcl','Services/ServicesAllot.aspx?iflag=1','服务中心-待处理')">待处理<asp:Label ID="lbt3" runat="server" Text="(0)" CssClass="red"></asp:Label></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		              <a href="#d" onclick="parent.parent.SetFrame('fwcl','Services/ServicesAllot.aspx?iflag=2','服务中心-处理中')">处理中<asp:Label ID="lbt4" runat="server" Text="(0)" CssClass="red"></asp:Label></a><br />
                ...
                <table border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    <td width="40" align="left" valign="top"><img src="../../Headquarters/Mynavigation/images/XTTX_2.jpg" width="34" height="37" /></td>
                    <td align="left">
		            <ul>
		            ...
		            <li class="text">
		              ...
		              <a href="#dd" onclick="parent.parent.SetFrame('bbhdbd','Stock/SchAllocate.aspx?iflag=1','被驳回的调拨申请');">被驳回的调拨申请<asp:Label ID="lbt17" runat="server" Text="(0)" CssClass="red"></asp:Label></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		              <a href="#dd" onclick="parent.parent.SetFrame('jdqjc','Stock/SchLendingReturn.aspx?iflag=1','将到期借出');">将到期借出<asp:Label ID="lbt18" runat="server" Text="(0)" CssClass="red"></asp:Label></a>
		              </li>
		            </ul>
		            </td>
                  </tr>
                ...
                <table border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    <td width="40" align="left" valign="top"><img src="../../Headquarters/Mynavigation/images/XTTX_5.jpg" width="34" height="37" /></td>
                    <td align="left">
		            <ul>
		            <li class="texts">帐款</li>
		            <li class="text">
		              <a href="#gy" onclick="parent.parent.SetFrame('dqysk','Financial/ArrearageTX.aspx?iflag=1','到期应收款');">到期应收款<asp:Label ID="lbt19" runat="server" Text="(0)" CssClass="red"></asp:Label></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                ...
                <table border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    <td width="40" align="left" valign="top"><img src="../../Headquarters/Mynavigation/images/XTTX_3.jpg" width="34" height="37" /></td>
                    <td align="left">
		            <ul>
		            ...
		            <li class="text">
		              ...
		              <a href="#d" onclick="parent.parent.SetFrame('wycldfwd','Services/ServicesAllot.aspx?iflag=3','服务中心-我要处理的服务单');">您要处理的服务单<asp:Label ID="lbt24" runat="server" Text="(0)" CssClass="red"></asp:Label></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		              <a href="#dds" onclick="parent.parent.SetFrame('nygzdkh','Customer/CustomerTrack.aspx?iFlag=1','客户跟踪');">您要跟踪的客户<asp:Label ID="lbt25" runat="server" Text="(0)" CssClass="red"></asp:Label></a>
		              </li>
		            </ul>
		            </td>
                  </tr>
                ...
                <table border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    <td width="40" align="left" valign="top"><img src="../../Headquarters/Mynavigation/images/XTTX_4.jpg" width="34" height="37" /></td>
                    <td align="left">
		            <ul>
		            ...
		            <li class="text">
		              ...
		              <a href="#jdby" onclick="parent.parent.SetFrame('jdqbyjh','Customer/MaintenanceAllot.aspx?iflag=1','将要到期的保养计划');">将要到期的保养计划<asp:Label ID="lbt29" runat="server" Text="(0)" CssClass="red"></asp:Label></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    ...
    <div class="title"><span class="stitle">系统提醒</span><span class="close" onclick="tips_pop()"><img alt="关闭" src="../../Public/Images/close.gif" style="cursor: default;" title="关闭" /></span></div>
        <div class="con">
            <ul>
            <li><a href="#dd" onclick="parent.parent.SetFrame('wycldfwd','Services/ServicesAllot.aspx?iflag=3','服务中心-要处理的服务单');">您要处理的服务单<asp:Label ID="lbt36" runat="server" Text="(0)" CssClass="red"></asp:Label></a></li>
