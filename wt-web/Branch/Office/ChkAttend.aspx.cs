...
public partial class Branch_Office_ChkAttend : Page, IRequiresSessionState
{
	private string id;
	...
	protected void Page_Load(object sender, EventArgs e)
	{
		...
		if (!base.IsPostBack)
		{
			this.ddlType.DataSource = DALCommon.GetDataList("AbsenceSet", "[ID],Type", " DeptID=" + (string)this.Session["Session_wtBranchID"]);
	...
	protected void btnAdd_Click(object sender, EventArgs e)
	{
		...
		attendanceDetailInfo.ChkOperatorID = int.Parse((string)this.Session["Session_wtUserBID"]);
