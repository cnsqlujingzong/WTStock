...
public partial class Branch_Office_ChkAttendance : Page, IRequiresSessionState
{
	...
	{
		int recordCount = 0;
		string text = (this.hfParm.Value == "-1") ? this.strParm() : (this.hfParm.Value + " and Properties=1 and DeptID=" + (string)this.Session["Session_wtBranchID"]);
			...
			for (int i = 0; i < this.gvdata.HeaderRow.Cells.Count; i++)
			{
				if (i > 1)
				{
					...
					if (dataField != "ID")
					{
						...
						{
							HiddenField expr_2E8 = this.hfTbTitle;
							expr_2E8.Value = expr_2E8.Value + "," + text2;
						}
						...
						{
							HiddenField expr_338 = this.hfTbField;
							expr_338.Value = expr_338.Value + "," + dataField;
						}
					}
				}
			}
	...
	{
		string text = " Properties=1 and DeptID=" + (string)this.Session["Session_wtBranchID"];
