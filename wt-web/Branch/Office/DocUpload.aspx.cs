...
public partial class Branch_Office_DocUpload : Page, IRequiresSessionState
{
				...
				else
				{
					...
					if (flag)
					{
						...
						else
						{
							...
							stringBuilder.Append("parent.iframeDialog.document.getElementById(\"hfFileSize\").value=\"" + contentLength.ToString() + "\";");
							stringBuilder.Append("parent.iframeDialog.document.getElementById(\"hfUpload\").value=\"" + this.hfPath.Value + "\";");
							stringBuilder.Append(string.Concat(new string[]
							{
								"parent.iframeDialog.document.getElementById(\"dUpload\").innerHTML=\"<img src='../../Public/Images/dmony.gif' title='附件1' /> <a href=../../Headquarters/Document/",
								this.hfPath.Value,
								" target=_blank >",
								text2,
								text,
