...
public partial class Branch_Purchase_PurPlanMod : Page, IRequiresSessionState
{
	...
	protected void Page_Load(object sender, EventArgs e)
	{
		...
		if (!base.IsPostBack)
		{
			...
			else
			{
				...
				OtherFunction.BindStaff(this.ddlOperator, "DeptID=" + this.Session["Session_wtBranchID"].ToString() + " and Status=0");
				OtherFunction.BindStocks(this.ddlStock, " DeptID=" + this.Session["Session_wtBranchID"].ToString() + " and bStop=0 and bReject=0 ");
				OtherFunction.BindSupplier(this.ddlProvider, "bSupplier=1 and bStop=0 and DeptID=" + this.Session["Session_wtBranchID"].ToString() + " ");
				...
				if (model != null)
				{
					...
					if (model.DeptID != int.Parse(this.Session["Session_wtBranchID"].ToString()))
					{
						this.btnAdd.Enabled = false;
						this.btnChk.Enabled = false;
						this.btnClean.Enabled = false;
