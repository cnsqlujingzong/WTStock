...
public partial class Branch_Purchase_PurchaseDeCd : Page, IRequiresSessionState
{
	...
	protected void Page_Load(object sender, EventArgs e)
	{
		...
		if (!base.IsPostBack)
		{
			...
			{
				OtherFunction.BindStocks(this.ddlStock, " DeptID=" + this.Session["Session_wtBranchID"].ToString() + " and bStop=0 ");
				DataTable dataSource = DALCommon.GetDataList("StaffList", "[ID],[_Name]", " DeptID=" + this.Session["Session_wtBranchID"].ToString() + " and Status=0 ").Tables[0];
