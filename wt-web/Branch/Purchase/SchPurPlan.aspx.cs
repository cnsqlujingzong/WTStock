...
public partial class Branch_Purchase_SchPurPlan : Page, IRequiresSessionState
{
		...
		if (this.gvdata.Rows.Count > 0)
		{
			for (int i = 0; i < this.gvdata.HeaderRow.Cells.Count; i++)
			{
				...
				if (dataField != "" && dataField != "ID")
				{
					...
					{
						HiddenField expr_30E = this.hfTbTitle;
						expr_30E.Value = expr_30E.Value + "," + text2;
					}
					...
					{
						HiddenField expr_35E = this.hfTbField;
						expr_35E.Value = expr_35E.Value + "," + dataField;
					}
				}
			}
		}
