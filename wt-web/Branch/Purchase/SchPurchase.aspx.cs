...
public partial class Branch_Purchase_SchPurchase : Page, IRequiresSessionState
{
	...
	protected void FillData(string sortExpression, string direction)
	{
		...
		text = text + " and DeptID=" + this.Session["Session_wtBranchID"].ToString();
		...
		if (this.gvdata.Rows.Count > 0)
		{
			for (int i = 0; i < this.gvdata.HeaderRow.Cells.Count; i++)
			{
				...
				if (dataField != "" && dataField != "ID")
				{
					...
					{
						HiddenField expr_385 = this.hfTbTitle;
						expr_385.Value = expr_385.Value + "," + text2;
					}
					...
					{
						HiddenField expr_3D5 = this.hfTbField;
						expr_3D5.Value = expr_3D5.Value + "," + dataField;
					}
				}
			}
		}
