...
public partial class Branch_Receive_SndSign : Page, IRequiresSessionState
{
	...
	{
		string text = " (RcvDeptID=" + (string)this.Session["Session_wtBranchID"] + " or RcvDept='') and Status='待收货确认' ";
	...
	protected void btnExcel_Click(object sender, EventArgs e)
	{
		...
		bool flag = false;
		DataToExcel.DataTableToExcel(dt, tbTitle, Guid.NewGuid().ToString() + ".xls", "签收确认", out flag, out empty);
		if (!flag)
		{
			this.FillData(this.hfOrderName.Value, this.hfOrder.Value);
