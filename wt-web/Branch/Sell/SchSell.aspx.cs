...
public partial class Branch_Sell_SchSell : Page, IRequiresSessionState
{
	...
	protected string strParm()
	{
		...
		{
			text = text + " and Operator='" + this.Session["Session_wtUserB"].ToString() + "' ";
		}
	...
	protected void btnChk_Click(object sender, EventArgs e)
	{
		...
		int num2 = dALSell.ChkSell(int.Parse((string)this.Session["Session_wtBranchID"]), num, iOperator, out empty);
		this.FillData(this.hfOrderName.Value, this.hfOrder.Value);
		string text = "";
		if (num2 != 0)
		{
	...
	protected void btnChkU_Click(object sender, EventArgs e)
	{
		...
		int iOperator = 0;
		int.TryParse((string)this.Session["Session_wtUserBID"], out iOperator);
		int num = dALSell.ChkSellU(int.Parse((string)this.Session["Session_wtBranchID"]), iTbid, iOperator, out empty);
		this.FillData(this.hfOrderName.Value, this.hfOrder.Value);
		string text = "";
		if (num != 0)
		{
	...
	protected void btnDel_Click(object sender, EventArgs e)
	{
		...
		int iOperator = 0;
		int.TryParse((string)this.Session["Session_wtUserBID"], out iOperator);
		int num = dALSell.Delete(int.Parse((string)this.Session["Session_wtBranchID"]), iTbid, iOperator, out empty);
		this.FillData(this.hfOrderName.Value, this.hfOrder.Value);
		if (num == 0)
		{
			this.hfRecID.Value = "-1";
	...
	protected void btnChk1_Click(object sender, EventArgs e)
	{
		...
		int num = dALSell.ChkSell1(1, iTbid, iOperator, out empty);
		this.FillData(this.hfOrderName.Value, this.hfOrder.Value);
		string text = "";
		if (num != 0)
		{
