...
public partial class Branch_Sell_SltSellPlan : Page, IRequiresSessionState
{
	...
	{
		string text = " DeptID=" + (string)this.Session["Session_wtBranchID"] + " and Status='已审核' and isnull(bEnd,1)=1 and EndStatus = '执行中' ";
		...
		if (this.hfSch.Value == "0")
		{
			if (this.ddlKey.SelectedValue != "-1")
			{
				...
				if (text2 != "")
				{
					...
					text += dALSellPlan.GetSchWhere(schid, text2);
				}
			}
		}
		return text;
	...
	protected void GridView2_RowDataBound(object sender, GridViewRowEventArgs e)
	{
		...
		if (e.Row.RowType == DataControlRowType.Footer)
		{
			...
			e.Row.Cells[9].Text = this.dsqty.ToString("#0.00");
