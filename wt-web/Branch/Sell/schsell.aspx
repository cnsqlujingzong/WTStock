<%@ page language="C#"  CodeFile="schsell.aspx.cs"     autoeventwireup="true" inherits="Branch_Sell_SchSell" theme="Themes" enableEventValidation="false" %>
...
function ModBill()
{
    ChkMod(800, 506,'Sell/SellMod.aspx','销售单');
}
