...
public partial class Branch_Services_AddI : Page, IRequiresSessionState
{
	...
	protected void GridView2_RowDataBound(object sender, GridViewRowEventArgs e)
	{
		...
		if (e.Row.RowType == DataControlRowType.DataRow)
		{
			...
			e.Row.Cells[5].Attributes.Add("class", "tbbg");
	...
	protected void btnAdd_Click(object sender, EventArgs e)
	{
		...
		if (num == 0)
		{
			DbHelperSQL.InsertErrorLogs(2, int.Parse((string)this.Session["Session_wtUserBID"]), this.id, "添加服务项目", 0);
