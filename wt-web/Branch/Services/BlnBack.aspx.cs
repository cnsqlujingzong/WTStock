...
public partial class Branch_Services_BlnBack : Page, IRequiresSessionState
{
	...
	protected void btnAdd_Click(object sender, EventArgs e)
	{
		...
		for (int i = 0; i < array.Length; i++)
		{
			...
			if (num3 != 0)
			{
				int num4 = dALServices.BlnBack(num3, int.Parse((string)this.Session["Session_wtUserBID"]), FunLibrary.ChkInput(this.tbReason.Text), out empty);
				if (num4 == 0)
				{
					num2++;
				}
