...
public partial class Branch_Services_HistorySnd : Page, IRequiresSessionState
{
	...
	protected void LoadField()
	{
		...
		DataTable dataTable = dALSys.GetLayoutDetail(1, deptID, 10, 0, userID).Tables[0];
	...
	protected void FillData(string sortExpression, string direction)
	{
		this.LoadField();
		int recordCount = 0;
		string text = (this.hfParm.Value == "-1") ? this.strParm() : (this.hfParm.Value + " and DisposalID=" + (string)this.Session["Session_wtBranchID"] + " and RepairStatus='送修完成' ");
	...
	{
		string text = " DisposalID=" + (string)this.Session["Session_wtBranchID"] + " and RepairStatus='送修完成' ";
