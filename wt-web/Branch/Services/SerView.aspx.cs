...
public partial class Branch_Services_SerView : Page, IRequiresSessionState
{
	private int id;
	...
	protected void Page_Load(object sender, EventArgs e)
	{
		...
		if (!base.IsPostBack)
		{
			...
			if (dataTable.Rows.Count > 0)
			{
				...
				OtherFunction.BindStaff(this.ddlVisitOperator, "DeptID=" + (string)this.Session["Session_wtBranchID"] + " and Status=0");
