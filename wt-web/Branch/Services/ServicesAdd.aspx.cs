...
public partial class Branch_Services_ServicesAdd : Page, IRequiresSessionState
{
	private int cusid;
	...
	protected void btnAdd_Click(object sender, EventArgs e)
	{
		...
		int iTbid;
		num4 = dALServices.Add(servicesInfo, this.hfFault.Value, out iTbid);
