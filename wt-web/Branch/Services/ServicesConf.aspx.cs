...
public partial class Branch_Services_ServicesConf : Page, IRequiresSessionState
{
	...
	protected void LoadField()
	{
		...
		DataTable dataTable = dALSys.GetLayoutDetail(1, deptID, 6, 0, userID).Tables[0];
	...
	protected void btnConf_Click(object sender, EventArgs e)
	{
		...
		if (num2 > 0)
		{
			num = dALServices.ChkConf(num2, int.Parse((string)this.Session["Session_wtUserBID"]), out empty);
		}
		if (num == 0)
		{
			this.hfRecID.Value = "-1";
