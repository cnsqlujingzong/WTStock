...
public partial class Branch_Services_SltCus : Page, IRequiresSessionState
{
	...
	protected string strParm()
	{
		...
		string text3 = FunLibrary.ChkInput(this.tbCon.Text);
		...
		if (this.ddlKey.SelectedValue != "-1")
		{
			...
			if (text3 != "")
			{
				...
				text += dALCustomerList.GetSchWhere(schid, text3);
			}
		}
		return text;
	}
	...
	{
		e.Row.Cells[0].Visible = (e.Row.Cells[19].Visible = false);
		...
		if (e.Row.RowType == DataControlRowType.DataRow)
		{
			...
			text6 = e.Row.Cells[19].Text.Replace("'", "").Replace("\"", "").Replace("&nbsp;", "");
