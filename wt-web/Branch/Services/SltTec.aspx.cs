...
public partial class Branch_Services_SltTec : Page, IRequiresSessionState
{
	...
	{
		int num = int.Parse((string)this.Session["Session_wtBranchID"]);
		if (base.Request.QueryString["dept"] != null)
		{
			int.TryParse(base.Request.QueryString["dept"], out num);
		}
		string text = " DeptID=" + num + " and bTechnician='√' and Status='在职' ";
