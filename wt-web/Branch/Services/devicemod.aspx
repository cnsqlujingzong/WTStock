<%@ page language="C#"  CodeFile="devicemod.aspx.cs"     autoeventwireup="true" inherits="Branch_Services_DeviceMod" enableEventValidation="false" %>
...
function SltAsp()
{
    parent.ShowDialog2(400, 510, '../Branch/Basic/SltAsp.aspx?f=x', '机器外观');
}
function SltAcc()
{
    parent.ShowDialog2(400, 510, '../Branch/Basic/SltAcc.aspx?f=x', '随机附件');
}
function SltFault()
{
    parent.ShowDialog2(600, 510, '../Branch/Basic/SltFault.aspx?f=x', '常见故障');
}
function ChkAdd(str)
{
    parent.iframeDialog.$("hfDevice").value=str;
    parent.iframeDialog.$("btnModD").click();
    parent.CloseDialog1();
}
