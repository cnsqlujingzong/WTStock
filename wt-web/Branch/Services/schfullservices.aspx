<%@ page language="C#"  CodeFile="schfullservices.aspx.cs"     autoeventwireup="true" inherits="Branch_Services_SchFullServices" theme="Themes" enableeventvalidation="false" %>
...
<body onload="Chkset();" onclick="parent.Sethidden1();">
        ...
        <div class="ftoolright">
            <table cellpadding="0" cellspacing="0" class="tb2">
                ...
                <asp:DropDownList ID="ddlKey" runat="server" CssClass="pindl" onchange="document.getElementById('tbCon').focus();">
                    ...
                    <asp:ListItem Value="24">按处理时长查询(天)</asp:ListItem>
            ...
            <td style="padding:0px;"><input id="btnSchsH" type="button" value="高级查询" class="bsch" onclick="parent.ShowDialog(470,596, 'Services/SerSchCd.aspx', '高级查询');" /></td>
            </tr>
            </table>   
        </div>
    ...
    <asp:GridView ID="gvdata" runat="server" AutoGenerateColumns="false" SkinID="gv1" OnRowDataBound="gvdata_RowDataBound" EnableViewState="false">
        <Columns>
            ...
            <asp:BoundField HeaderText="响应时间" DataField="AnsTime" />
            <asp:BoundField HeaderText="上门时间" DataField="VisDate" />
            <asp:BoundField HeaderText="完成维护时间" DataField="FinDate" />
            ...
            <asp:BoundField HeaderText="客户地址" DataField="Adr" />
