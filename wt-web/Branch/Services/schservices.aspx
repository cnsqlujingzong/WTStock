<%@ page language="C#"  CodeFile="schservices.aspx.cs"     autoeventwireup="true" inherits="Branch_Services_SchServices" theme="Themes" enableeventvalidation="false" %>
...
function ChkBack()
{
    ChkMod(460,124, 'Services/SchBack.aspx', '驳回');
}
function ChkView()
{
