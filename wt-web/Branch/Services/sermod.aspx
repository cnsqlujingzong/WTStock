<%@ page language="C#"  CodeFile="sermod.aspx.cs"     autoeventwireup="true" inherits="Branch_Services_SerMod" theme="Themes" enableeventvalidation="false" %>
    ...
    <div id="info1" style="padding:3px 0px 0px 3px; overflow:hidden;" >
        ...
        <ContentTemplate>
            ...
            <tr>
                ...
                <td style="padding-left:0px;">
                    <div class="isinDiv">
                        <asp:TextBox ID="tbModel" runat="server" CssClass="pin2 pinin2" AutoCompleteType="Disabled" onblur="ChkPModel();" onmousedown="getSearchResult1('../Customer/SchModel.aspx','tbModel','hfModel','1','',event);" onkeyup="getSearchResult1('../Customer/SchModel.aspx','tbModel','hfModel','1','',event);"></asp:TextBox>
...
function SltDev()
{
    ...
    if(cusid=="")
    {
        parent.ShowDialog1(800, 500, '../Branch/Customer/SltDev.aspx?f=1&psn='+escape($("tbSN1").value)+'&strname='+escape($("tbCusName").value), '选择机器档案');
    }
    else
    {
        parent.ShowDialog1(800, 500, '../Branch/Customer/SltDev.aspx?f=1&psn='+escape($("tbSN1").value)+'&strname='+escape($("tbCusName").value)+'&cusid='+cusid, '选择机器档案');
    }
}
function SltModel()
{
    parent.ShowDialog1(400, 510, '../Branch/Services/SltModel.aspx?f=1&sBrand='+escape($("tbBrand").value)+'&sClass='+escape($("tbClass").value), '选择型号');
}
function SltAsp()
{
...
function ViewCus()
{
    ...
    {
        //新建客户
        parent.ShowDialog1(600, 400, 'Customer/CusAdd.aspx?f=1', '新建客户');
    }
    else
    {
        //修改客户
        parent.ShowDialog1(600, 450, 'Customer/CusMod.aspx?f=1&id='+cusid, '客户信息');
    }
}
...
function ViewHistory()
{
    ...
    parent.ShowDialog1(800, 520, 'Customer/CusHistory.aspx?f=1&cusid='+cusid, '相关业务');
}
function ChkUpload()
{   
    if($("dUpload").innerHTML=="")
    {
        parent.ShowDialog1(600, 380, '../Branch/Services/UpLoad.aspx', '上传附件');
    }
    else
    {
