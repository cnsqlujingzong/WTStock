<%@ page language="C#"  CodeFile="servicesaddbat.aspx.cs"     autoeventwireup="true" inherits="Branch_Services_ServicesAddBat" theme="Themes" enableEventValidation="false" %>
...
<body>
    ...
    <div class="tldiv2">
        <table cellpadding="0" cellspacing="0" class="tb1">
            <tr>
                <td width="310"><a  href="#" onclick="parent.ShowDialog(870,600, '../Branch/Services/ServicesAdd.aspx', '服务受理');">切换到标准模式</a></td>
                ...
                <table cellpadding="0" cellspacing="0" class="tb1" width="100%">
                    <tr>
                        <td style="padding-left:5px;">
                            <input id="btnNewD" type="button" value="新建" class="bt1" onclick="parent.ShowDialog1(460, 353, '../Branch/Services/DeviceAdd.aspx', '新建机器');"/>
...
function ModD()
{
    if(ChkSlt()!=false)
    {
        ...
        parent.ShowDialog1(460, 353,'../Branch/Services/DeviceMod.aspx?str='+escape(str),'修改机器');
    }
}

function SltCus()
{
    parent.ShowDialog1(800, 500, '../Branch/Services/SltCus.aspx?f=1&strname='+escape($("tbCusName").value), '选择客户');
}
