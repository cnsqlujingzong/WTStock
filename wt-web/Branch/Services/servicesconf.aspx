<%@ page language="C#"  CodeFile="servicesconf.aspx.cs"     autoeventwireup="true" inherits="Branch_Services_ServicesConf" theme="Themes" enableEventValidation="false" %>
...
<body onload="Chkset();" onclick="parent.Sethidden1();">
    ...
    <div class="ftool">
        ...
        <table cellpadding="0" cellspacing="0" class="tb2">
            ...
            <asp:Button ID="btnConf" runat="server" Text="确认" CssClass="bt1" UseSubmitBehavior="false" OnClientClick="if(ChkConfirm()==false)return false;" OnClick="btnConf_Click"/>
...
function ChkConfirm()
{
    if(ChkSlt()==false)
        return false;
    var curSt=$($("hfRecID").value).cells[1].innerHTML;
    if(curSt=="待网点确认")
    {
        ChkMod(480, 293, 'Services/SerChkFin.aspx?t=1', '确认通过');
        return false;
    }
    return true;
}
function ChkBack()
{
    ...
    if(curSt=="待网点确认")
    {
        ChkMod(480, 293, 'Services/SerChkFin.aspx?t=2', '建议');
    }
    else
