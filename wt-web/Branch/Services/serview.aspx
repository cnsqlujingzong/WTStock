<%@ page language="C#"  CodeFile="serview.aspx.cs"     autoeventwireup="true" inherits="Branch_Services_SerView" theme="Themes" enableEventValidation="false" %>
    ...
    <div id="info1" style="padding:3px 0px 0px 3px; overflow:hidden;" >
        <div id="divinfo1" class="divinfo" style="height:100%;">
            ...
            <tr>
                <td>联系地址：</td>
                <td colspan="3" style="padding-left:0px;">
                    <asp:TextBox ID="tbAdr" runat="server" CssClass="pin" Width="321"></asp:TextBox>
                </td>
                <td  class="sysred" style="padding-left:0px;">
                受理人：</td>
                <td style="padding-left:0px;">
