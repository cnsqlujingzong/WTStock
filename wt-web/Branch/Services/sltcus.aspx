<%@ page language="C#"  CodeFile="sltcus.aspx.cs"     autoeventwireup="true" inherits="Branch_Services_SltCus" theme="themes" enableEventValidation="false" %>
   ...
   <div class="ftool">
    ...
    <asp:GridView ID="gvcus" runat="server" AutoGenerateColumns="false" SkinID="gv1" OnRowDataBound="gvcus_RowDataBound" EnableViewState="false">
        <Columns>
            ...
            <asp:BoundField HeaderText="客户级别" DataField="Member" />
        </Columns>
    </asp:GridView>
...
function NewCus()
{
    ...
    parent.ShowDialog2(600, 400, '../Branch/Customer/CusAdd.aspx?f=2'+strtel, '新建客户');
}
