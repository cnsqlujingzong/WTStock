...
// Type: Branch_Stat_BroughBackSellDetail
...
public partial class Branch_Stat_BroughBackSellDetail : Page, IRequiresSessionState
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (this.deptid == -1)
            ...
            strCondition = str + (object)" and ChkDate between '" + this.startdate + "' and '" + this.enddate + " 23:59:59'  and GoodsNO = '" + this.GoodsNO + "' and AppID='" + (string)(object)this.appID + "' and DeptID = " + (string)(object)this.deptid;
