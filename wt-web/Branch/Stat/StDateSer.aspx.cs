...
public partial class Branch_Stat_StDateSer : Page, IRequiresSessionState
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (RightID > 0 && !new DALRight().GetRight(RightID, "tj_r29"))
        {
        ...
        this.ddlBranch_SelectedIndexChanged(sender, e);
