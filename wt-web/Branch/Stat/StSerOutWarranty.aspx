<%@ page language="C#"  CodeFile="StSerOutWarranty.aspx.cs"     autoeventwireup="true" inherits="Branch_Stat_StSerOutWarranty" theme="Themes" enableEventValidation="false" %>
...
function ChkView(cid)
{
    ...
    //alert(dates+'|'+datee+'|'+dept);
    parent.ShowDialog(800, 480, 'Stat/StSerOutWarrantyDe.aspx?cid='+cid+'&deptid='+dept+'&startdate='+dates+'&enddate='+datee, '明细');
}
function Chkset()
{
    Chkwh();
