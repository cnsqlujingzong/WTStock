...
public partial class Branch_Stat_StSerWarranty : Page, IRequiresSessionState
{
	...
	protected void Page_Load(object sender, EventArgs e)
	{
		...
		if (!base.IsPostBack)
		{
			...
			if (num > 0)
			{
				...
				if (!dALRight.GetRight(num, "tj_r61"))
				{
	...
	protected void FillData()
	{
		...
		DataSet dataSet = dALServices.StSerCosts(2, text3, text, text2);
		...
		boundField3.DataField = "ProductClass";
		this.gvdata.Columns.Add(boundField3);
		BoundField boundField4 = new BoundField();
		boundField4.HeaderText = "免费保修台数";
		boundField4.DataField = "allcount";
		this.gvdata.Columns.Add(boundField4);
		BoundField boundField5 = new BoundField();
		boundField5.HeaderText = "维修台数";
		boundField5.DataField = "fwcount";
		this.gvdata.Columns.Add(boundField5);
		BoundField boundField6 = new BoundField();
		boundField6.HeaderText = "重复维修台数";
		boundField6.DataField = "Again";
		this.gvdata.Columns.Add(boundField6);
		BoundField boundField7 = new BoundField();
		boundField7.HeaderText = "故障率";
		boundField7.DataField = "faultrate";
		this.gvdata.Columns.Add(boundField7);
		BoundField boundField8 = new BoundField();
		boundField8.HeaderText = "备件成本";
		boundField8.DataFormatString = "{0:f2}";
		boundField8.DataField = "MaterialCost";
		this.gvdata.Columns.Add(boundField8);
		string text4 = "机器类别,免费保修台数,维修台数,重复维修台数,故障率,备件成本";
		string text5 = "ProductClass,allcount,fwcount,Again,faultrate,MaterialCost";
		for (int i = 0; i < dataSet.Tables[0].Columns.Count; i++)
		{
			...
			boundField9.HeaderText = text6.Substring(1);
			boundField9.DataField = text6;
			boundField9.DataFormatString = "{0:f2}";
	...
	protected void gvdata_RowDataBound(object sender, GridViewRowEventArgs e)
	{
		...
		if (e.Row.RowType == DataControlRowType.Header)
		{
			...
			cells[5].Text = "故障率(%)";
			cells.Add(new TableHeaderCell());
			cells[6].ColumnSpan = count - 2;
			cells[6].Text = "费用支出</th></tr><tr class=\"tdHead8\">";
	...
	protected void btnExcel_Click(object sender, EventArgs e)
	{
		...
		DataTable dataTable = dALServices.StSerCosts(2, text3, text, text2).Tables[0];
