...
public partial class Branch_Stat_StTechnician : Page, IRequiresSessionState
{
		...
		if (this.gvdata.Rows.Count > 0)
		{
			for (int i = 0; i < this.gvdata.HeaderRow.Cells.Count; i++)
			{
				if (i > 0)
				{
					...
					{
						HiddenField expr_AA5 = this.hfTbTitle;
						expr_AA5.Value = expr_AA5.Value + "," + text4;
					}
					...
					{
						HiddenField expr_AF5 = this.hfTbField;
						expr_AF5.Value = expr_AF5.Value + "," + dataField;
					}
				}
			}
		}
