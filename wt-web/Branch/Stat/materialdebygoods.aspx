<%@ page language="C#"  CodeFile="materialdebygoods.aspx.cs"     autoeventwireup="true" inherits="Branch_Stat_MaterialDeByGoods" theme="Themes" enableEventValidation="false" %>
<%@ Register Assembly="AspNetPager" Namespace="Wuqi.Webdiyer" TagPrefix="webdiyer" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
<title>备件(商品)汇总表</title>
...
<body onload="Chkset();" onclick="parent.Sethidden1();">
    ...
    <asp:GridView ID="gvdata" runat="server" AutoGenerateColumns="false" SkinID="statf" OnRowDataBound="gvdata_RowDataBound" EnableViewState="false" ShowFooter="true">
        <Columns>
            <asp:BoundField HeaderText="仓库ID" DataField="StockID" />
            ...
            <asp:BoundField HeaderText="结存量" DataField="Stock" />
        </Columns>
    </asp:GridView>
    ...
    <table cellpadding="0" cellspacing="0" class="pages">
        ...
        <asp:HiddenField ID="hfTbTitle" runat="server" Value="仓库,产品编号,产品名称,规格,单位,领料数量,领料成本,退料数量(良品),退料成本,退料数量(废品),退料成本(废品),结存量" />
