<%@ page language="C#"  CodeFile="stbroughtback.aspx.cs"     autoeventwireup="true" inherits="Branch_Stat_StBroughtBack" theme="Themes" enableEventValidation="false" %>
...
<body onload="Chkset();" onclick="parent.Sethidden1();">
    ...
    <asp:HiddenField ID="hfTbTitle" runat="server" Value="产品编号,名称,规格,品牌,单位,领料数量,领料金额,领料成本,退料数量,退料金额,退料成本" />
    <asp:HiddenField ID="hfTbField" runat="server" Value="GoodsNO,_Name,Spec,Brand,Unit,LLSL,LLJE,LLCB,TLSL,TLJE,TLCB"/>
