<%@ page language="C#"  CodeFile="stmonthseller.aspx.cs"     autoeventwireup="true" inherits="Branch_Stat_StMonthSeller" theme="Themes" enableEventValidation="false" %>
...
<body onload="Chkset();" onclick="parent.Sethidden1();">
    ...
    <asp:GridView ID="gvdata" runat="server" AutoGenerateColumns="false" SkinID="statf" OnRowDataBound="gvdata_RowDataBound" EnableViewState="false" ShowFooter="true">
        <Columns>
            ...
            <asp:BoundField HeaderText="业务月度" DataField="by_curmonth"/>
    ...
    <asp:HiddenField ID="hfTbTitle" runat="server" Value="业务月度,服务营业额,服务毛利,销售营业额,销售毛利,合计营业额,合计毛利" />
...
function ChkView()
{
    ...
    parent.ShowDialog(870,513, 'Stat/DaySellerDe.aspx?iflag=2&billdate='+billdate+'&deptid='+deptid, '明细');
}

function Chkbom()
{
    $("fbon").innerHTML=parent.DrawInfo("月营业额汇总表");
}
</script>
