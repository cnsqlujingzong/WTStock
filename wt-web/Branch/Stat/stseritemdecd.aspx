<%@ page language="C#"  CodeFile="stseritemdecd.aspx.cs"     autoeventwireup="true" inherits="Branch_Stat_StSerItemDeCd" enableEventValidation="false" %>
            ...
            <ContentTemplate>
               <table cellpadding="0" cellspacing="0" class="tb3">
                ...
                <tr>
                    ...
                    <td style="padding-left:0px;">
                        <asp:TextBox ID="tbTec" runat="server" CssClass="pin"></asp:TextBox>
                    </td>
