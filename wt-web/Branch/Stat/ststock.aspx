<%@ page language="C#"  CodeFile="ststock.aspx.cs"     autoeventwireup="true" inherits="Branch_Stat_StStock" theme="Themes" enableEventValidation="false" %>
    ...
    <div class="ftool">
        <div class="ftoolleft">
          <table cellpadding="0" cellspacing="0" class="tb2">
            ...
            <td style="padding-left:0px;"><span id="stock" runat="server">仓库</span></td>
            <td>
                <asp:DropDownList ID="ddlStock" runat="server" CssClass="pindl" Width="100">
