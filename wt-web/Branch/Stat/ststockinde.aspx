<%@ page language="C#"  CodeFile="ststockinde.aspx.cs"     autoeventwireup="true" inherits="Branch_Stat_StStockINDe" theme="Themes" enableEventValidation="false" %>
    ...
    <div class="ftool">
        ...
        <table cellpadding="0" cellspacing="0" class="tb2">
            ...
            <asp:ListItem Value="BillID">按单据编号查询</asp:ListItem>
                ...
                <asp:ListItem Value="Reason">按入库原因查询</asp:ListItem>
            ...
            <td>
                <input id="btnSchsH" type="button" value="高级查询" class="bsch" onclick="parent.ShowDialog(460,316, 'Stat/StStockDeCd.aspx', '高级查询');" />
            </td>
            <td>
...
function Chkbom()
{
    $("fbon").innerHTML=parent.DrawInfo("入库明细汇总表");
}
</script>
