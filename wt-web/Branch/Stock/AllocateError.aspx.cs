...
public partial class Branch_Stock_AllocateError : Page, IRequiresSessionState
{
	...
	private decimal deqty = 0m;

	private decimal derqty = 0m;

	private decimal dteqty = 0m;
	...
	{
		string text = " Status=5 and ToDeptID=" + (string)this.Session["Session_wtBranchID"] + " ";
	...
	protected void GridView2_RowDataBound(object sender, GridViewRowEventArgs e)
	{
		...
		if (e.Row.RowType == DataControlRowType.Footer)
		{
			...
			e.Row.Cells[9].Text = this.dqtyr.ToString("#0.00");
			e.Row.Cells[10].Text = this.derqty.ToString("#0.00");
			...
			e.Row.Cells[15].Text = this.dteqty.ToString("#0.00");
		}
	}
