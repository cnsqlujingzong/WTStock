...
public partial class Branch_Stock_AllocateSigned : Page, IRequiresSessionState
{
	...
	{
		string text = " FromDeptID=" + (string)this.Session["Session_wtBranchID"] + " and Status=3 ";
	...
	protected void btnExcel_Click(object sender, EventArgs e)
	{
		...
		bool flag = false;
		DataToExcel.DataTableToExcel(dt, tbTitle, Guid.NewGuid().ToString() + ".xls", "调拨签收", out flag, out empty);
		if (!flag)
		{
			this.FillData(this.hfOrderName.Value, this.hfOrder.Value);
