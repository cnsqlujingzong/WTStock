...
public partial class Branch_Stock_BroughtBack : Page, IRequiresSessionState
{
				...
				if (this.hfType.Value == "2")
				{
					...
					if (dataTable.Rows.Count > 0)
					{
						for (int i = 0; i < dataTable.Rows.Count; i++)
						{
							...
							DataTable dataTable2 = DALCommon.GetGoodsPriceList(3, int.Parse(this.Session["Session_wtBranchID"].ToString()), iGoodsid, iUnitid, 0, int.Parse(this.ddlStock.SelectedValue)).Tables[0];
