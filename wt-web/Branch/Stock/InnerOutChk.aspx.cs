...
public partial class Branch_Stock_InnerOutChk : Page, IRequiresSessionState
{
	...
	protected string strParm()
	{
		...
		if (num > 0 && this.hfSeparate.Value == "1")
		{
			...
			{
				obj,
				" and StockOutID in(select StockID from dbo.getStocks(",
	...
	protected void btnChk_Click(object sender, EventArgs e)
	{
		...
		int num = dALInnerAllocate.ChkInnerStockOut(int.Parse((string)this.Session["Session_wtBranchID"]), iTbid, iOperator, out empty);
		this.FillData(this.hfOrderName.Value, this.hfOrder.Value);
		string text = "";
		if (num != 0)
		{
