...
public partial class Branch_Stock_RegulateMod : Page, IRequiresSessionState
{
	private int id;
	...
	protected void btnChk_Click(object sender, EventArgs e)
	{
		...
		else
		{
			...
			if (num == 0)
			{
				...
				dALRegulate.ChkRegulate(int.Parse((string)this.Session["Session_wtBranchID"]), this.id, iOperator, out str);
