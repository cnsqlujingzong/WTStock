...
public partial class Branch_Stock_SNAdm : Page, IRequiresSessionState
{
	...
	protected void LoadClass()
	{
		...
		Branch_Stock_SNAdm.BindTreeNode(treeNode, dt, treeNode.Value);
	...
	public static void BindTreeNode(TreeNode node, DataTable dt, string parentid)
	{
		...
		for (int i = 0; i < array2.Length; i++)
		{
			...
			Branch_Stock_SNAdm.BindTreeNode(treeNode, dt, dataRow["ID"].ToString());
		}
	}
	...
	protected void LoadField()
	{
		...
		DataTable dataTable = dALSys.GetLayoutDetail(1, deptID, 4, 0, userID).Tables[0];
