...
public partial class Branch_Stock_SltStockOut : Page, IRequiresSessionState
{
	...
	protected void FillData(string sortExpression, string direction)
	{
		...
		this.gvdata.DataSource = DALCommon.GetList_HL(1, "sn_stockoutdetail", "", this.pageSize, this.jsPager.CurrentPageIndex, text, fldSort, out recordCount);
	...
	{
		string text = " Status=2 and DeptID=" + (string)this.Session["Session_wtBranchID"] + " and SNID=0 ";
		if (this.ddlKey.SelectedValue == "d")
		{
			text = text + " and _Date='" + DateTime.Now.ToString("yyyy-MM-dd") + "'";
		}
