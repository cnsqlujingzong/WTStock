...
public partial class Branch_Stock_StockOutMod : Page, IRequiresSessionState
{
	...
	protected void btnChk_Click(object sender, EventArgs e)
	{
		...
		else
		{
			...
			if (num == 0)
			{
				...
				dALStockOUT.ChkStockOut(int.Parse((string)this.Session["Session_wtBranchID"]), this.id, iOperator, out str);
