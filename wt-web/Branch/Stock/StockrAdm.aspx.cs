...
public partial class Branch_Stock_StockrAdm : Page, IRequiresSessionState
{
    ...
    protected void LoadClass()
    {
        ...
        Branch_Stock_StockrAdm.BindTreeNode(treeNode, dt, treeNode.Value);
    ...
    public static void BindTreeNode(TreeNode node, DataTable dt, string parentid)
    {
        foreach (DataRow dataRow in dt.Select(" Father=" + parentid))
        {
            ...
            Branch_Stock_StockrAdm.BindTreeNode(treeNode, dt, dataRow["ID"].ToString());
        }
    }
    ...
    protected void LoadField()
    {
        ...
        DataTable dataTable = new DALSys().GetLayoutDetail(1, result2, 3, 0, result1).Tables[0];
