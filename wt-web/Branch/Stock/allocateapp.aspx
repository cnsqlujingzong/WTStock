<%@ page language="C#"  CodeFile="allocateapp.aspx.cs"     autoeventwireup="true" inherits="Branch_Stock_AllocateApp" theme="Themes" enableEventValidation="false" %>
...
<body onload="Chkset();" onclick="parent.Sethidden1();">
    ...
    <ContentTemplate>
        ...
        <tr>
            ...
            <td>日期：</td>
            <td style="padding-left:0px;"><asp:TextBox ID="tbDate" runat="server" CssClass="Wdate" onfocus="WdatePicker({startDate:'%y-%M-01 00:00:00',dateFmt:'yyyy-MM-dd HH:mm:ss',alwaysUseStartDate:true});"></asp:TextBox></td>
            <td>申请人：</td>
