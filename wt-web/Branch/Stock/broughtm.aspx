<%@ page language="C#"  CodeFile="broughtm.aspx.cs"     autoeventwireup="true" inherits="Branch_Stock_BroughtM" theme="Themes" enableEventValidation="false" %>
    ...
    <table cellpadding="0" cellspacing="0" class="tb4">
        <tr>
            ...
            <td>
                ...
                <input id="tbSltGoods" type="button" style="display:none;" value="选择产品" runat="server" class="bt1" onclick="$('hfType').value='2';parent.ShowDialog1(800, 520, 'Stock/SltGoods.aspx', '选择产品');" />
            </td>
