<%@ page language="C#"  CodeFile="goodsbimg.aspx.cs"     autoeventwireup="true" inherits="Branch_Stock_GoodsBImg" enableEventValidation="false" %>
...
function preview()
{
    ...
    document.getElementById("dpic").innerHTML="<a href='../../Headquarters/Images/" + m + "' target='_blank'><img src='../../Headquarters/Images/" + m + "' border='0' /></a>";
