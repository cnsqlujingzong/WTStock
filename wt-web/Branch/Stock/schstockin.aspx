<%@ page language="C#"  CodeFile="schstockin.aspx.cs"     autoeventwireup="true" inherits="Branch_Stock_SchStockIN" theme="Themes" enableEventValidation="false" %>
    ...
    <div class="ftool">
        ...
        <table cellpadding="0" cellspacing="0" class="tb2">
            ...
            <td>
                ...
                <asp:Button ID="btnChk" runat="server" Text="审核" CssClass="bt1" UseSubmitBehavior="false" OnClientClick="if(ChkConf('审核该[入库单]')==false) return false;" OnClick="btnChk_Click"/>
                <asp:Button ID="btnChkU" runat="server" Text="反审核" CssClass="bt1" UseSubmitBehavior="false" OnClientClick="if(ChkConf('反审核该[入库单]')==false) return false;" OnClick="btnChkU_Click"/>
                <asp:Button ID="btnDel" runat="server" Text="删除" CssClass="bt1" UseSubmitBehavior="false" OnClientClick="if(ChkDel('入库单')==false) return false;" OnClick="btnDel_Click"/>
        ...
        <div class="ftoolright">
            <table cellpadding="0" cellspacing="0" class="tb2">
                <tr>
                <td>
                <input id="btnPrint" runat="server" type="button" value="打印" class="iprint" onclick="ChkPrint('RKD');" />
                </td>
                ...
                <asp:DropDownList ID="ddlKey" runat="server" CssClass="pindl" onchange="document.getElementById('tbCon').focus();">
                    ...
                    <asp:ListItem Value="5">按入库原因查询</asp:ListItem>
    ...
    <div id="cnbut">
        <div class="ftool2">
            <div id="mytabs" style="padding-left:2px;">
                ...
                <span id="tabs1" class="tabs_active" >入库明细</span>
...
function ModBill()
{
    ChkMod(800, 520, 'Stock/StockINMod.aspx', '入库单');
}
...
function Chkbom()
{
    $("fbon").innerHTML=parent.DrawInfo("入库单查询");
}
