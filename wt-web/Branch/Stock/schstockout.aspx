<%@ page language="C#"  CodeFile="schstockout.aspx.cs"     autoeventwireup="true" inherits="Branch_Stock_SchStockOut" theme="Themes" enableEventValidation="false" %>
...
<body onload="Chkset();" onclick="parent.Sethidden1();">
    ...
    <div class="ftool">
        ...
        <table cellpadding="0" cellspacing="0" class="tb2">
            ...
            <td>
                ...
                <asp:Button ID="btnChk" runat="server" Text="审核" CssClass="bt1" UseSubmitBehavior="false" OnClientClick="if(ChkConf('审核该[出库单]')==false) return false;" OnClick="btnChk_Click"/>
                <asp:Button ID="btnChkU" runat="server" Text="反审核" CssClass="bt1" UseSubmitBehavior="false" OnClientClick="if(ChkConf('反审核该[出库单]')==false) return false;" OnClick="btnChkU_Click"/>
                <asp:Button ID="btnDel" runat="server" Text="删除" CssClass="bt1" UseSubmitBehavior="false" OnClientClick="if(ChkDel('出库单')==false) return false;" OnClick="btnDel_Click"/>
        ...
        <div class="ftoolright">
            <table cellpadding="0" cellspacing="0" class="tb2">
                <tr>
                <td>
                <input id="btnPrint" runat="server" type="button" value="打印" class="iprint" onclick="ChkPrint('CKD');" />
                </td>
                ...
                <asp:DropDownList ID="ddlKey" runat="server" CssClass="pindl" onchange="document.getElementById('tbCon').focus();">
                    ...
                    <asp:ListItem Value="5">按出库原因查询</asp:ListItem>
                    <asp:ListItem Value="6">按业务编号查询</asp:ListItem>
                    <asp:ListItem Value="7">按审核日期查询</asp:ListItem>
                    <asp:ListItem Value="8">按审核人查询</asp:ListItem>
                    <asp:ListItem Value="9">按备注查询</asp:ListItem>
                    <asp:ListItem Value="10">按仓库查询</asp:ListItem>
    ...
    <asp:HiddenField ID="hfvalue" runat="server" Value="1" />
    </ContentTemplate>
    <Triggers>
    ...
    <div id="cnbut">
        <div class="ftool2">
            <div id="mytabs" style="padding-left:2px;">
                ...
                <span id="tabs1" class="tabs_active" >出库明细</span>
...
function ModBill()
{
    ChkMod(800, 520,'Stock/StockOutMod.aspx','出库单');
}
...
function Chkbom()
{
    $("fbon").innerHTML=parent.DrawInfo("出库单查询");
}
