<%@ page language="C#"  CodeFile="stockinmod.aspx.cs"     autoeventwireup="true" inherits="Branch_Stock_StockINMod" theme="Themes" enableEventValidation="false" %>
...
<body>
    ...
    <ContentTemplate>
        ...
        <tr>
            ...
            <td>备注：</td>
            <td colspan="3" style="padding-left:0px;"><asp:TextBox ID="tbRemark" runat="server" CssClass="pin" Width="328"></asp:TextBox>
...
function EditSN(unitid,SN,nums)
{
   ...
   parent.ShowDialog1(400, 300, 'Stock/EditSN.aspx?unitid='+unitid+'&snvalue='+escape($(SN).value)+'&snid='+SN+'&gdsnum='+escape(gdsnum), '编辑序列号');
}
</script>
