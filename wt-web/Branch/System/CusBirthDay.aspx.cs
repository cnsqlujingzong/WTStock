...
public partial class Branch_System_CusBirthDay : Page, IRequiresSessionState
{
	...
	protected void FillData(string sortExpression, string direction)
	{
		...
		this.gvdata.DataSource = DALCommon.GetList_HL(1, "ks_customerlinkman", "", this.pageSize, this.jsPager.CurrentPageIndex, text, fldSort, out recordCount);
	...
	{
		string text = " DeptID=" + (string)this.Session["Session_wtBranchID"] + " and  month(Birthday)=month(getdate()) and day(Birthday)=day(getdate()) ";
