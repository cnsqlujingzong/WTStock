...
public partial class Branch_System_DeviceWExpire : Page, IRequiresSessionState
{
	...
	{
		string text = " DeptID=" + (string)this.Session["Session_wtBranchID"] + " and Warranty='厂家保修期' and datediff(d,getdate(),WarrantyEnd)<0 ";
