...
public partial class Branch_System_ExtendedServices : Page, IRequiresSessionState
{
	...
	protected void FillData(string sortExpression, string direction)
	{
		...
		text += " and (curStatus='待处理' or curStatus='处理中') and ((yPoint>bPoint and bPoint>0) or csPoint > 0) ";
		this.hfSql.Value = text;
		this.gvdata.DataSource = DALCommon.GetList_HL(1, "fw_extendedservices", "", this.pageSize, this.jsPager.CurrentPageIndex, text, fldSort, out recordCount);
	...
	{
		string text = " DisposalID=" + (string)this.Session["Session_wtBranchID"];
