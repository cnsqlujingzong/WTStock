...
public partial class Branch_System_NOMod : Page, IRequiresSessionState
{
	...
	protected void Page_Load(object sender, EventArgs e)
	{
		...
		if (this.id.ToString().Length < 2 || !this.id.ToString().Substring(2).Equals(this.Session["Session_wtBranchID"].ToString()))
		{
			base.Response.End();
		}
		FunLibrary.ChkBran();
