...
public partial class Branch_System_StockB : Page, IRequiresSessionState
{
	...
	protected void FillData(string sortExpression, string direction)
	{
		...
		if (this.hfSchH.Value != "")
		{
			text = text + " and " + this.hfSchH.Value;
		}
		this.gvdata.DataSource = DALCommon.GetList_HL(1, "ck_stockdepthb", "", this.pageSize, this.jsPager.CurrentPageIndex, text, fldSort, out recordCount);
	...
	{
		string text = " DeptID=" + (string)this.Session["Session_wtBranchID"] + " and downWarning<>0 and Stock<downWarning and bStop='' ";
		...
		if (this.hfSch.Value == "0")
		{
			if (this.ddlKey.SelectedValue != "-1")
			{
				...
				if (text2 != "")
				{
					...
					text += dALGoods.GetSchWhere(num, text2);
				}
				if (num == 10)
				{
