...
public partial class Branch_System_StockH : Page, IRequiresSessionState
{
	...
	{
		string text = " DeptID=" + (string)this.Session["Session_wtBranchID"] + " and upWarning<>0 and Stock>upWarning and bStop='' ";
