...
public partial class Branch_System_UserPwd : Page, IRequiresSessionState
{
	...
	protected void btnSave_Click(object sender, EventArgs e)
	{
		...
		int staffID = 0;
		int.TryParse(this.Session["Session_wtUserBID"].ToString(), out staffID);
		UserManageInfo model = dALUserManage.GetModel(staffID, int.Parse((string)this.Session["Session_wtBranchID"]));
		if (model != null)
		{
