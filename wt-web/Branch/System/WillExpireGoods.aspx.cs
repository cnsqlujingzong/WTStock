...
public partial class Branch_System_WillExpireGoods : Page, IRequiresSessionState
{
	...
	protected void FillData(string sortExpression, string direction)
	{
		...
		this.gvdata.DataSource = DALCommon.GetList_HL(1, "ck_stockinbatch", "*,EndDate=dateadd(day,Valid,_Date)", this.pageSize, this.jsPager.CurrentPageIndex, text, fldSort, out recordCount);
	...
	{
		string text = " DeptID=" + (string)this.Session["Session_wtBranchID"] + " and Valid>0 ";
		...
		return text + " and dateadd(day,Valid-" + this.ddlWaring.SelectedValue + ",_Date)<getdate() and dateadd(day,Valid,_Date)>getdate() ";
	}
