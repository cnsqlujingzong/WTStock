<%@ page language="C#"  CodeFile="usermanage.aspx.cs"     autoeventwireup="true" inherits="Branch_System_UserManage" theme="Themes" enableEventValidation="false" %>
...
<body onload="Chkset();" onclick="parent.Sethidden1();">
    ...
    <div class="ftool">
        ...
        <table cellpadding="0" cellspacing="0" class="tb2">
            ...
            <td>
                ...
                <input id="btnNew" type="button" value="新建" class="bt1" onclick="parent.ShowDialog(700, 180, 'System/UserManageAdd.aspx', '新建用户');" />
                <input id="btnMod" type="button" value="修改" class="bt1" onclick="ChkMod(700, 180,'System/UserManageMod.aspx','修改用户');" />
                <asp:Button ID="btnDel" runat="server" Text="删除" CssClass="bt1" OnClientClick="if(ChkDel('用户')==false) return false;"  UseSubmitBehavior="false" OnClick="btnDel_Click"/>
        ...
        <div class="ftoolright">
            <table cellpadding="0" cellspacing="0" class="tb2">
                ...
                <asp:DropDownList ID="ddlKey" runat="server" CssClass="pindl" onchange="document.getElementById('tbCon').focus();">
                    <asp:ListItem Value="_Name">按用户名查询</asp:ListItem>
                    <asp:ListItem Value="RightName">按权限组名查询</asp:ListItem>
                    <asp:ListItem Value="Status">按用户状态查询</asp:ListItem>
    ...
    <asp:GridView ID="gvdata" runat="server" AutoGenerateColumns="false" SkinID="gv1" OnRowDataBound="gvdata_RowDataBound" Width="70%" EnableViewState="false">
        <Columns>
            ...
            <asp:BoundField HeaderText="用户名" DataField="_Name" />
            <asp:BoundField HeaderText="权限组" DataField="RightName" />
...
function Chkbom()
{
    $("fbon").innerHTML=parent.DrawInfo("用户管理");
}
</script>
