...
public partial class Branch_Tool_LayoutClass : Page, IRequiresSessionState
{
	...
	{
		int recordCount = 0;
		this.GridView1.DataSource = DALCommon.GetList_HL(1, "LayoutClass", "", this.pageSize, this.jsPager.CurrentPageIndex, " DeptID=" + (string)this.Session["Session_wtBranchID"] + " and bSys=0 ", " ID Desc", out recordCount);
