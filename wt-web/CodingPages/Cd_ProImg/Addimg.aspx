<%@ Page Language="C#" MasterPageFile="~/MasterPage2.master"  AutoEventWireup="true" CodeFile="Addimg.aspx.cs" Inherits="CodingPages_Cd_ProImg_Addimg" %>
    ...
    <script>
        $(function () {
            ...
            $("#delImg").click(function () {
                ...
                Base.ajaxPost("/CodingPages/js/imgUpload/Upload.ashx", { delid: imgid, type: 'proimg' }, function (data) {
                    if (data=="1") {
        ...
        function initImgUpload(id) {
            $("#uploadify").uploadify({
                ...
                'onSelect': function (event, queueID, fileObj) {
                    $("#uploadify").uploadifySettings("script", "/CodingPages/js/imgUpload/Upload.ashx?type=proimg&&pid=" + id); //动态更新配(执行此处时可获得值)
        ...
        <form id="formxx" runat="server">           
            <div id="imgView">
                <asp:Repeater ID="Repeater1" runat="server">
                    <ItemTemplate>
                        <div class='imgDiv' currid='<%# Eval("ID") %>'><img src='<%# Eval("ImgSrc") %>' /></div>
                    </ItemTemplate>
