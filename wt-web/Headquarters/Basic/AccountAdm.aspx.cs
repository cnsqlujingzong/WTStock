...
public partial class Headquarters_Basic_AccountAdm : Page, IRequiresSessionState
{
	...
	protected void Page_Load(object sender, EventArgs e)
	{
		...
		if (!base.IsPostBack)
		{
			...
			if (num > 0)
			{
				...
				if (!dALRight.GetRight(num, "jc_r23"))
				{
	...
	{
		int recordCount = 0;
		this.GridView1.DataSource = DALCommon.GetList_HL(1, "Account", "", pageSize, jsPager.CurrentPageIndex, "DeptID=1", " ID Desc", out recordCount);
	...
	protected void btnAdd_Click(object sender, EventArgs e)
	{
		...
		else
		{
			...
			else
			{
				...
				{
					chkfld = "_Name='" + accountInfo._Name + "' and DeptID=1";
				}
				string str;
