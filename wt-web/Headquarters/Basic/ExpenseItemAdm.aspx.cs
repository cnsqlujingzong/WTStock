...
public partial class Headquarters_Basic_ExpenseItemAdm : Page, IRequiresSessionState
{
	...
	protected void Page_Load(object sender, EventArgs e)
	{
		...
		if (!base.IsPostBack)
		{
			...
			if (num > 0)
			{
				...
				if (!dALRight.GetRight(num, "jc_r25"))
				{
	...
	{
		int recordCount = 0;
		this.GridView1.DataSource = DALCommon.GetList_HL(1, "ExpenseItem", "", this.pageSize, this.jsPager.CurrentPageIndex, " DeptID=1 ", " ID Desc", out recordCount);
	...
	protected void btnAdd_Click(object sender, EventArgs e)
	{
		...
		else
		{
			...
			else
			{
				...
				{
					text = text + " DeptID=1 and _Name='" + baseInfo._Name + "'";
				}
				string str;
