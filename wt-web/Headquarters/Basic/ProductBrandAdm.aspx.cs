...
public partial class Headquarters_Basic_ProductBrandAdm : Page, IRequiresSessionState
{
	...
	{
		int recordCount = 0;
		this.GridView1.DataSource = DALCommon.GetList_HL(1, "ProductBrand", "", this.pageSize, this.jsPager.CurrentPageIndex, "", " ID Desc", out recordCount);
	...
	protected void btnAdd_Click(object sender, EventArgs e)
	{
		...
		else
		{
			...
			else
			{
				...
				string str;
				int num = dALBaseInfo.Update("ProductBrand", baseInfo, text, out str);
				if (num == 0)
				{
	...
	protected void btnMod_Click(object sender, EventArgs e)
	{
		...
		else
		{
			...
			string str2;
			int num = dALBaseInfo.Update("ProductBrand", baseInfo, text, out str2);
			if (num == 0)
			{
				this.hfRecID.Value = baseInfo.ID.ToString();
				this.FillData();
	...
	protected void btnDel_Click(object sender, EventArgs e)
	{
		...
		int num = dALBaseInfo.Delete("ProductBrand", iD, out empty);
		if (num == 0)
		{
			this.hfRecID.Value = "-1";
		}
	...
	protected void btnShow_Click(object sender, EventArgs e)
	{
		...
		{
			DALBaseInfo dALBaseInfo = new DALBaseInfo();
			BaseInfo model = dALBaseInfo.GetModel("ProductBrand", int.Parse(this.hfRecID.Value));
