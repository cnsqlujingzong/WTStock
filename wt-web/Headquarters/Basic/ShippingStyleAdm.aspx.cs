...
public partial class Headquarters_Basic_ShippingStyleAdm : Page, IRequiresSessionState
{
	...
	protected void Page_Load(object sender, EventArgs e)
	{
		...
		if (!base.IsPostBack)
		{
			...
			if (num > 0)
			{
				...
				if (!dALRight.GetRight(num, "jc_r26"))
				{
	...
	{
		int recordCount = 0;
		this.GridView1.DataSource = DALCommon.GetList_HL(1, "ShippingStyle", "", this.pageSize, this.jsPager.CurrentPageIndex, " DeptID=1 ", " ID Desc", out recordCount);
	...
	protected void btnAdd_Click(object sender, EventArgs e)
	{
		...
		else
		{
			...
			shippingStyleInfo.DeptID = new int?(1);
			...
			else
			{
				...
				{
					chkfld = "_Name='" + shippingStyleInfo._Name + "' and DeptID=1 ";
				}
				string str;
