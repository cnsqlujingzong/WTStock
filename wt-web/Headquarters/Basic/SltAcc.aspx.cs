...
public partial class Headquarters_Basic_SltAcc : Page, IRequiresSessionState
{
	...
	protected void FillData(string sortExpression, string direction)
	{
		...
		this.gvdata.DataSource = DALCommon.GetList_HL(1, "ProductAccessory", "", this.pageSize, this.jsPager.CurrentPageIndex, text, fldSort, out recordCount);
