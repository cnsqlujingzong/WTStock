...
public partial class Headquarters_Basic_SltSerItem : Page, IRequiresSessionState
{
	...
	protected void FillData(string sortExpression, string direction)
	{
		...
		this.gvbranch.DataSource = DALCommon.GetList_HL(1, "ServicesItemList", "", this.pageSize, this.jsPager.CurrentPageIndex, text, fldSort, out recordCount);
