...
public partial class Headquarters_Basic_StaffDeptAdm : Page, IRequiresSessionState
{
	...
	{
		int recordCount = 0;
		this.GridView1.DataSource = DALCommon.GetList_HL(1, "StaffDept", "", this.pageSize, this.jsPager.CurrentPageIndex, "DeptID=1", " Array Asc", out recordCount);
