...
public partial class Headquarters_Basic_SupplierAdm : Page, IRequiresSessionState
{
	...
	protected void Page_Load(object sender, EventArgs e)
	{
		...
		if (!base.IsPostBack)
		{
			...
			if (num > 0)
			{
				...
				if (!dALRight.GetRight(num, "jc_r32"))
				{
				...
				if (!dALRight.GetRight(num, "jc_r35"))
				{
	...
	protected void LoadClass()
	{
		...
		Headquarters_Basic_SupplierAdm.BindTreeNode(treeNode, dt, treeNode.Value);
	...
	public static void BindTreeNode(TreeNode node, DataTable dt, string parentid)
	{
		...
		for (int i = 0; i < array2.Length; i++)
		{
			...
			Headquarters_Basic_SupplierAdm.BindTreeNode(treeNode, dt, dataRow["ID"].ToString());
		}
	}
	...
	protected void LoadField()
	{
		...
		if (dataTable.Rows.Count > 0)
		{
			...
			templateField.ItemTemplate = new MyTemplatexgdsadf("", DataControlRowType.DataRow);
