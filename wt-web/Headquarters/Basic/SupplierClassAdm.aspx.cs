...
public partial class Headquarters_Basic_SupplierClassAdm : Page, IRequiresSessionState
{
	...
	protected void Page_Load(object sender, EventArgs e)
	{
		...
		if (!base.IsPostBack)
		{
			...
			if (num > 0)
			{
				...
				if (!dALRight.GetRight(num, "jc_r31"))
				{
	...
	protected void btnAdds_Click(object sender, EventArgs e)
	{
		...
		else
		{
			...
			string str;
			int num = dALDataClass.Add("SupplierClass", dataClassInfo, out str);
			if (num == 0)
			{
	...
	protected void btnMod_Click(object sender, EventArgs e)
	{
		...
		else
		{
			...
			string str;
			int num = dALDataClass.Update(0, "SupplierClass", dataClassInfo, chkfld, 0, out str);
			if (num == 0)
			{
	...
	protected void btnDel_Click(object sender, EventArgs e)
	{
		...
		int num = dALDataClass.Delete("SupplierClass", iD, out empty);
		if (num == 0)
		{
			this.hfRecID.Value = "-1";
			this.FillData();
	...
	protected void TreeView1_SelectedNodeChanged(object sender, EventArgs e)
	{
		...
		DALDataClass dALDataClass = new DALDataClass();
		DataClassInfo model = dALDataClass.GetModel("SupplierClass", int.Parse(this.hfRecID.Value));
		if (model != null)
		{
