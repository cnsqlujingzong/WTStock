...
public partial class Headquarters_Basic_TroubleReasonAdm : Page, IRequiresSessionState
{
	...
	protected void Page_Load(object sender, EventArgs e)
	{
		...
		if (!base.IsPostBack)
		{
			...
			if (num > 0)
			{
				...
				if (!dALRight.GetRight(num, "jc_r16"))
				{
	...
	{
		int recordCount = 0;
		this.GridView1.DataSource = DALCommon.GetList_HL(1, "TroubleReason", "", this.pageSize, this.jsPager.CurrentPageIndex, "", " ID Desc", out recordCount);
	...
	protected void btnAdd_Click(object sender, EventArgs e)
	{
		...
		else
		{
			...
			if (this.hfRecID.Value == "-1")
			{
				...
				string str;
				int num2;
				int num = dALBaseInfo.Add("TroubleReason", baseInfo, "故障原因", false, out str, out num2);
				if (num == 0)
				{
			...
			else
			{
				...
				string str;
				int num = dALBaseInfo.Update("TroubleReason", baseInfo, text, out str);
				if (num == 0)
				{
	...
	protected void btnMod_Click(object sender, EventArgs e)
	{
		...
		else
		{
			...
			string str2;
			int num = dALBaseInfo.Update("TroubleReason", baseInfo, text, out str2);
			if (num == 0)
			{
				this.hfRecID.Value = baseInfo.ID.ToString();
				this.FillData();
	...
	protected void btnDel_Click(object sender, EventArgs e)
	{
		...
		int num = dALBaseInfo.Delete("TroubleReason", iD, out empty);
		if (num == 0)
		{
			this.hfRecID.Value = "-1";
		}
	...
	protected void btnShow_Click(object sender, EventArgs e)
	{
		...
		{
			DALBaseInfo dALBaseInfo = new DALBaseInfo();
			BaseInfo model = dALBaseInfo.GetModel("TroubleReason", int.Parse(this.hfRecID.Value));
