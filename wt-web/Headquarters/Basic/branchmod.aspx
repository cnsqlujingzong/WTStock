<%@ page language="C#"  CodeFile="branchmod.aspx.cs"     autoeventwireup="true" inherits="Headquarters_Basic_BranchMod" enableEventValidation="false" %>
        ...
        <div id="sa" style="width:558px;">
            ...
            <ContentTemplate>
                <table cellpadding="0" cellspacing="0" class="tb3">
                    ...
                    <tr>
                        <td></td>
                        <td style="padding-left:0px;"><asp:CheckBox ID="bStop" runat="server" Checked="true" /> <span class="sysred">停用标志</span>
