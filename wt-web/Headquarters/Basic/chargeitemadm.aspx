<%@ page language="C#"  CodeFile="chargeitemadm.aspx.cs"     autoeventwireup="true" inherits="Headquarters_Basic_ChargeItemAdm" theme="Themes" enableEventValidation="false" %>
...
<body>
    ...
    <table cellpadding="0" cellspacing="0" class="tb4">
        ...
        <tr>
            <td>名称：</td>
            <td style="padding-left:0px;"><asp:TextBox ID="tbName" runat="server" CssClass="pin" ToolTip="输入收支项目" Width="160"></asp:TextBox>
    ...
    <tr>
        <td>
            ...
            <asp:Button ID="btnDel" runat="server" Text="删除" CssClass="bt1" OnClientClick="if(ChkDel('收支项目')==false)return false;" OnClick="btnDel_Click" UseSubmitBehavior="false" />
        </td>
        <td align="right">
