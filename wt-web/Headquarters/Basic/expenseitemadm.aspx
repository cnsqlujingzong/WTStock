<%@ page language="C#"  CodeFile="expenseitemadm.aspx.cs"     autoeventwireup="true" inherits="Headquarters_Basic_ExpenseItemAdm" theme="Themes" enableEventValidation="false" %>
...
<body>
    ...
    <div class="sdiv">
        ...
        <table cellpadding="0" cellspacing="0" class="tb3">
            <tr>
                ...
                <asp:TextBox ID="tbName" runat="server" CssClass="pin" ToolTip="输入项目名称" Width="160"></asp:TextBox>
    ...
    <tr>
        <td>
            ...
            <asp:Button ID="btnDel" runat="server" Text="删除" CssClass="bt1" OnClientClick="if(ChkDel('报销项目')==false)return false;" OnClick="btnDel_Click" UseSubmitBehavior="false" />
        </td>
        <td align="right">
