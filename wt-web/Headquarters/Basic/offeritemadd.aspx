<%@ page language="C#"  CodeFile="offeritemadd.aspx.cs"     autoeventwireup="true" inherits="Headquarters_Basic_OfferItemAdd" enableEventValidation="false" %>
        ...
        <div id="sa" style="width:316px;">
            ...
            <ContentTemplate>
                ...
                <tr>
                 ...
                 <tr>
                    <td>备注：</td>
                    <td style="padding-left:0px;"><asp:TextBox ID="tbRemark" runat="server" CssClass="pin" Width="200"></asp:TextBox></td>
                </tr>
            </table>
            </ContentTemplate>
            <Triggers>
