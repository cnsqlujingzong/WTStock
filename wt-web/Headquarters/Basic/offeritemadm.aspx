<%@ page language="C#"  CodeFile="offeritemadm.aspx.cs"     autoeventwireup="true" inherits="Headquarters_Basic_OfferItemAdm" theme="Themes" enableEventValidation="false" %>
...
<body>
    ...
    <div class="sdiv">
        ...
        <table cellpadding="0" cellspacing="0" class="tb4">
            <tr>
                <td>名称：</td>
                <td style="padding-left:0px;"><asp:TextBox ID="tbName" runat="server" CssClass="pin" ToolTip="输入名称"></asp:TextBox>
    ...
    <tr>
        <td>
            ...
            <asp:Button ID="btnDel" runat="server" Text="删除" CssClass="bt1" OnClientClick="if(ChkDel('报价项目')==false)return false;" OnClick="btnDel_Click" UseSubmitBehavior="false" />
        </td>
        <td align="right">
