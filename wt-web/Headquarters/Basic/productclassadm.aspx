<%@ page language="C#"  CodeFile="productclassadm.aspx.cs"     autoeventwireup="true" inherits="Headquarters_Basic_ProductClassAdm" theme="Themes" enableEventValidation="false" %>
...
<body>
    ...
    <tr>
        <td>
            ...
            <asp:Button ID="btnDel" runat="server" Text="删除" CssClass="bt1" OnClientClick="if(ChkDel('类别')==false)return false;" OnClick="btnDel_Click" UseSubmitBehavior="false" />
...
function ChkInput()
{
    parent.ShowDialog1(480, 193,'Basic/InputBase.aspx?str='+escape('机器类别'), '导入基础信息');
}
function ChkFocus()
{
    $("tbName").select();
