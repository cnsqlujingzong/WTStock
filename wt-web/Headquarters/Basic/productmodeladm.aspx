<%@ page language="C#"  CodeFile="productmodeladm.aspx.cs"     autoeventwireup="true" inherits="Headquarters_Basic_ProductModelAdm" theme="Themes" enableEventValidation="false" %>
...
<body>
    ...
    <ContentTemplate>
        ...
        <asp:GridView ID="GridView1" runat="server" SkinID="gv4" AutoGenerateColumns="False" OnRowDataBound="GridView1_RowDataBound" Width="90%">
            <Columns>
                ...
                <asp:BoundField HeaderText="型号" DataField="_Name" />
                <asp:BoundField HeaderText="保修期" DataField="Period" />
            </Columns>
        </asp:GridView>
    ...
    <div class="sdiv">
        ...
        <table cellpadding="0" cellspacing="0" class="tb4">
            ...
            <tr>
                <td>型号：</td>
                <td style="padding-left:0px;"><asp:TextBox ID="tbName" runat="server" CssClass="pin" ToolTip="输入型号名称"></asp:TextBox>
                    <asp:HiddenField ID="hfTemp" runat="server" />
                </td>
                <td align="right">保修期：</td>
                <td style="padding-left:0px;"><asp:TextBox ID="tbPeriod" runat="server" CssClass="pin" ToolTip="输入保修期"></asp:TextBox>
                    天
    ...
    <tr>
        <td>
            ...
            <asp:Button ID="btnDel" runat="server" Text="删除" CssClass="bt1" OnClientClick="if(ChkDel('型号')==false)return false;" OnClick="btnDel_Click" UseSubmitBehavior="false" />
...
function ChkInput()
{
    parent.ShowDialog1(480, 193,'Basic/InputMacModel.aspx', '导入机器型号');
}
function ChkFocus()
{
    $("tbName").focus();
