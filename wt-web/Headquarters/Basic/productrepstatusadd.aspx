<%@ page language="C#"  CodeFile="productrepstatusadd.aspx.cs"     autoeventwireup="true" inherits="Headquarters_Basic_ProductRepStatusAdd" enableEventValidation="false" %>
    ...
    <asp:ScriptManager ID="ScriptManager1" runat="server">
        ...
        <div id="sa" style="width:286px;">
            ...
            <ContentTemplate>
                ...
                <tr>
                    <td>保修情况：</td>
                    <td style="padding-left:0px;"><asp:TextBox ID="tbName" runat="server" CssClass="pin" Width="170"></asp:TextBox></td>
                </tr>
            </table>
            </ContentTemplate>
            <Triggers>
