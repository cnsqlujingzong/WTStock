...
<body>
    ...
    <ContentTemplate>
        ...
        <asp:GridView ID="GridView1" runat="server" SkinID="gv4" AutoGenerateColumns="False" OnRowDataBound="GridView1_RowDataBound" Width="70%">
            <Columns>
                ...
                <asp:BoundField HeaderText="服务类别" DataField="_Name" />
    ...
    <div class="sdiv">
        ...
        <table cellpadding="0" cellspacing="0" class="tb3">
            <tr>
                ...
                <asp:TextBox ID="tbName" runat="server" CssClass="pin" ToolTip="输入服务类别" Width="160"></asp:TextBox>
    ...
    <tr>
        <td>
            ...
            <asp:Button ID="btnDel" runat="server" Text="删除" CssClass="bt1" OnClientClick="if(ChkDel('服务类别')==false)return false;" OnClick="btnDel_Click" UseSubmitBehavior="false" />
        </td>
        <td align="right">
