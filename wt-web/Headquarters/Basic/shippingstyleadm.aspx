<%@ page language="C#"  CodeFile="shippingstyleadm.aspx.cs"     autoeventwireup="true" inherits="Headquarters_Basic_ShippingStyleAdm" theme="Themes" enableEventValidation="false" %>
...
<body>
    ...
    <ContentTemplate>
        ...
        <asp:GridView ID="GridView1" runat="server" SkinID="gv4" AutoGenerateColumns="False" OnRowDataBound="GridView1_RowDataBound" Width="80%">
            <Columns>
                ...
                <asp:BoundField HeaderText="公司名称" DataField="_Name" />
    ...
    <table cellpadding="0" cellspacing="0" class="tb4">
        ...
        <tr>
            ...
            <td style="padding-left:0px;"><asp:TextBox ID="tbRemark" runat="server" CssClass="pin" Width="260"></asp:TextBox>
    ...
    <tr>
        <td>
            ...
            <asp:Button ID="btnDel" runat="server" Text="删除" CssClass="bt1" OnClientClick="if(ChkDel('货运方式')==false)return false;" OnClick="btnDel_Click" UseSubmitBehavior="false" />
        </td>
        <td align="right">
