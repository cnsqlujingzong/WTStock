<%@ page language="C#"  CodeFile="sltacc.aspx.cs"     autoeventwireup="true" inherits="Headquarters_Basic_SltAcc" theme="Themes" enableEventValidation="false" %>
   ...
   <div class="ftool">
    ...
    <asp:GridView ID="gvdata" runat="server" AutoGenerateColumns="false" SkinID="gv1" OnRowDataBound="gvdata_RowDataBound" EnableViewState="false">
        <Columns>
            ...
            <asp:BoundField HeaderText="随机附件" DataField="_Name" />
        </Columns>
    </asp:GridView>
