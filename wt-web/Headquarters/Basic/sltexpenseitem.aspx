<%@ page language="C#"  CodeFile="sltexpenseitem.aspx.cs"     autoeventwireup="true" inherits="Headquarters_Basic_SltExpenseItem" theme="themes" enableEventValidation="false" %>
...
<body>
   ...
   <div class="ftool">
    ...
    <div id="cndiv" style="height:480px; width:500px;">
    <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
    <ContentTemplate>
    <asp:GridView ID="gvbranch" runat="server" AutoGenerateColumns="false" SkinID="gv1" OnRowDataBound="gvbranch_RowDataBound" EnableViewState="false" Width="70%">
        <Columns>
