<%@ page language="C#"  CodeFile="sltqtytype.aspx.cs"     autoeventwireup="true" inherits="Headquarters_Basic_SltQtyType" theme="Themes" enableEventValidation="false" %>
   ...
   <div class="ftool">
        ...
        <table cellpadding="0" cellspacing="0" class="tb2">
                ...
                <td>
                    ...
                    <input id="btnNew" type="button" value="新建" class="bt1" onclick="parent.ShowDialog1(300, 95, 'Basic/QtyTypeAdd.aspx', '新建计数器类型');"/>
                    </td>
                 </tr>
            </table>   
        </div>
