<%@ page language="C#"  CodeFile="sltstkadm.aspx.cs"     autoeventwireup="true" inherits="Headquarters_Services_SltStkAdm" theme="Themes" enableEventValidation="false" %>
...
function ChkPass()
{
    ...
    if("<%=Str_X %>"=="2")
        parent.<%=Str_Fid %>.$("tbStkAdms").value=m;
    else
