<%@ page language="C#"  CodeFile="stocklistadd.aspx.cs"     autoeventwireup="true" inherits="Headquarters_Basic_StockListAdd" enableEventValidation="false" %>
                    ...
                    <tr>
                        ...
                        <td style="padding-left:0px;"><asp:DropDownList ID="ddlStkAdm2" runat="server"  CssClass="pindl">
                         ...
                         <td style="padding-left:0px;">
                             <asp:DropDownList ID="ddlAttr" runat="server"  CssClass="pindl">
