<%@ page language="C#"  CodeFile="supplieradd.aspx.cs"     autoeventwireup="true" inherits="Headquarters_Basic_SupplierAdd" enableEventValidation="false" %>
            ...
            <ContentTemplate>
                <table cellpadding="0" cellspacing="0" class="tb3">
                    ...
                    <td class="sysred" style="padding-left:5px;">
                        <asp:CheckBox ID="cbsys1" runat="server" Text="系统默认" Checked="true" onclick="ChkSysNO1()" /></td>
                    <tr>
                       <td>厂商类别：</td>
