<%@ page language="C#"  CodeFile="supplierclassadm.aspx.cs"     autoeventwireup="true" inherits="Headquarters_Basic_SupplierClassAdm" enableEventValidation="false" %>
    ...
    <ContentTemplate>
        ...
        <tr>
            <td>
                ...
                <asp:Button ID="btnDel" runat="server" ToolTip="删除" Text="删除"  CssClass="bt1" OnClientClick="if(ChkDel('厂商类别')==false)return false;" OnClick="btnDel_Click" UseSubmitBehavior="false" />
            </td>
            <td align="right">
