<%@ page language="C#"  CodeFile="troublereasonadm.aspx.cs"     autoeventwireup="true" inherits="Headquarters_Basic_TroubleReasonAdm" theme="themes" enableEventValidation="false" %>
...
<body>
    ...
    <ContentTemplate>
        ...
        <asp:GridView ID="GridView1" runat="server" SkinID="gv4" AutoGenerateColumns="False" OnRowDataBound="GridView1_RowDataBound" Width="70%">
            <Columns>
                ...
                <asp:BoundField HeaderText="故障原因" DataField="_Name" />
    ...
    <div class="sdiv">
        ...
        <table cellpadding="0" cellspacing="0" class="tb3">
            <tr>
                ...
                <asp:TextBox ID="tbName" runat="server" CssClass="pin" ToolTip="输入故障原因" Width="160"></asp:TextBox>
    ...
    <tr>
        <td>
            ...
            <asp:Button ID="btnDel" runat="server" Text="删除" CssClass="bt1" OnClientClick="if(ChkDel('故障原因')==false)return false;" OnClick="btnDel_Click" UseSubmitBehavior="false" />
...
function ChkInput()
{
    parent.ShowDialog1(480, 193,'Basic/InputBase.aspx?str='+escape('故障原因'), '导入基础信息');
}
function ChkFocus()
{
    $("tbName").focus();
