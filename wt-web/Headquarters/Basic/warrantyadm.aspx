<%@ page language="C#"  CodeFile="warrantyadm.aspx.cs"     autoeventwireup="true" inherits="Headquarters_Basic_WarrantyAdm" theme="Themes" enableEventValidation="false" %>
...
<body>
    ...
    <ContentTemplate>
        ...
        <asp:GridView ID="GridView1" runat="server" SkinID="gv4" AutoGenerateColumns="False" OnRowDataBound="GridView1_RowDataBound" Width="70%">
            <Columns>
                ...
                <asp:BoundField HeaderText="保修情况" DataField="_Name" />
                <asp:BoundField HeaderText="回访标志" DataField="bCall" />
                <asp:BoundField HeaderText="停用标志" DataField="bStopUse" />
    ...
    <div class="sdiv">
        ...
        <table cellpadding="0" cellspacing="0" class="tb3">
            <tr>
                ...
                <asp:TextBox ID="tbName" runat="server" CssClass="pin" ToolTip="输入保修情况" Width="160"></asp:TextBox>
                <asp:HiddenField ID="hfTemp" runat="server" />
                </td>
                <td class="red">回访标志：</td>
                <td style="padding-left:0px;">
                    <asp:CheckBox ID="cbCall" runat="server" />
                </td>
                <td class="red">停用标志：</td>
                <td style="padding-left:0px;">
                    <asp:CheckBox ID="cbStopUse" runat="server" />
                </td>
                <td>排序：</td>
                <td style="padding-left:0px;">
    ...
    <tr>
        <td>
            ...
            <asp:Button ID="btnDel" runat="server" Text="删除" CssClass="bt1" OnClientClick="if(ChkDel('保修情况')==false)return false;" OnClick="btnDel_Click" UseSubmitBehavior="false" />
        </td>
        <td align="right">
