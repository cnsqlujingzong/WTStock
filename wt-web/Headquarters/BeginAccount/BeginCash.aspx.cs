...
public partial class Headquarters_BeginAccount_BeginCash : Page, IRequiresSessionState
{
	...
	protected void FillData(string sortExpression, string direction)
	{
		...
		this.GvData.DataSource = DALCommon.GetList_HL(1, "Account", "[ID],_Name,CAST(BeginMoney AS decimal(10, 2)) as BeginMoney", this.pageSize, this.jsPager.CurrentPageIndex, text, fldSort, out recordCount);
	...
	protected void btnBegin_Click(object sender, EventArgs e)
	{
		...
		int num = dALAccount.ChkBegin(1, iOperator, out empty);
		this.FillData(this.hfOrderName.Value, this.hfOrder.Value);
