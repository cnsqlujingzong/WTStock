...
public partial class Headquarters_BeginAccount_BraBeginArr : Page, IRequiresSessionState
{
	...
	protected void btnChk_Click(object sender, EventArgs e)
	{
		...
		else
		{
			...
			int num = dALBeginArrearage.Update(beginArrearageInfo, 1, 3, iOperator, out empty);
			if (num == 0)
			{
