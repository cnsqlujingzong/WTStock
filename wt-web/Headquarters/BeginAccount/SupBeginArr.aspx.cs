...
public partial class Headquarters_BeginAccount_SupBeginArr : Page, IRequiresSessionState
{
	...
	protected void btnChk_Click(object sender, EventArgs e)
	{
		...
		else
		{
			...
			int num = dALBeginArrearage.Update(beginArrearageInfo, 1, 2, iOperator, out empty);
			if (num == 0)
			{
