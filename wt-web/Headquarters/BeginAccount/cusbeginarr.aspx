<%@ page language="C#"  CodeFile="cusbeginarr.aspx.cs"     autoeventwireup="true" inherits="Headquarters_BeginAccount_CusBeginArr" theme="Themes" enableEventValidation="false" %>
            ...
            <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
                <ContentTemplate>
                    <asp:GridView ID="gvdata" runat="server" AutoGenerateColumns="false" SkinID="gv5" OnRowDataBound="gvdata_RowDataBound" OnRowDeleting="gvdata_RowDeleting">
                        ...
                        <asp:BoundField HeaderText="客户编号" DataField="CusNO" />
        ...
        <tr>
            <td style="padding-left:15px;">
                <asp:DropDownList ID="ddlSchFld" runat="server" CssClass="pindl" Width="70">
                    <asp:ListItem Value="CustomerNO">按编号</asp:ListItem>
            ...
            <td><input id="tbSltGoods" type="button" value="选择客户" class="bt1" onclick="parent.ShowDialog(800, 520, 'BeginAccount/SltCus.aspx', '选择客户');" /></td>
        </tr>
    </table>
    </ContentTemplate>
    <Triggers>
...
function ChkSave()
{
    if(confirm("确认要建立期初客户应收应付吗？建立后将不能修改"))
    {
        return true;
    }
    else
...
function Chkbom()
{
    $("fbon").innerHTML=parent.DrawInfo("客户期初应收应付");
}
</script>
