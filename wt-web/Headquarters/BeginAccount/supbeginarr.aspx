<%@ page language="C#"  CodeFile="supbeginarr.aspx.cs"     autoeventwireup="true" inherits="Headquarters_BeginAccount_SupBeginArr" theme="Themes" enableEventValidation="false" %>
            ...
            <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
                <ContentTemplate>
                    <asp:GridView ID="gvdata" runat="server" AutoGenerateColumns="false" SkinID="gv5" OnRowDataBound="gvdata_RowDataBound" OnRowDeleting="gvdata_RowDeleting">
                        ...
                        <asp:BoundField HeaderText="厂商编号" DataField="CusNO" />
        ...
        <tr>
            <td style="padding-left:15px;">
                <asp:DropDownList ID="ddlSchFld" runat="server" CssClass="pindl" Width="70">
                    <asp:ListItem Value="SupNO">按编号</asp:ListItem>
            ...
            <td><input id="tbSltGoods" type="button" value="选择厂商" class="bt1" onclick="parent.ShowDialog(800, 520, 'BeginAccount/SltSup.aspx', '选择厂商');" /></td>
        </tr>
    </table>
    </ContentTemplate>
    <Triggers>
...
function ChkSave()
{
    ...
    if(confirm("确认要建立期初厂商应收应付吗？建立后将不能修改"))
    {
        return true;
    }
    else
...
function Chkbom()
{
    $("fbon").innerHTML=parent.DrawInfo("厂商期初应收应付");
}
</script>
