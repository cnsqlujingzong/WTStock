...
public partial class Headquarters_Customer_AssAdm : Page, IRequiresSessionState
{
	...
	protected void FillData(string sortExpression, string direction)
	{
		...
		this.gvdata.DataSource = DALCommon.GetList_HL(1, "ks_associator", "", this.pageSize, this.jsPager.CurrentPageIndex, text, fldSort, out recordCount);
	...
	protected void gvdata_RowDataBound(object sender, GridViewRowEventArgs e)
	{
		...
		if (e.Row.RowType == DataControlRowType.DataRow)
		{
			...
			if (e.Row.Cells[9].Text != "")
			{
				...
				{
					"<a href=\"#\" style=\"color:#0000ff\" onclick=\"ShowCus('",
					e.Row.Cells[2].Text,
					"')\">",
					e.Row.Cells[9].Text,
					"</a>"
	...
	protected void btnDel_Click(object sender, EventArgs e)
	{
		...
		if (value != "")
		{
			...
			while (i < array2.Length)
			{
				...
				int num = DALCommon.DeteleData("Associator", "[ID]=" + str, out empty);
				if (num == 0)
				{
					this.hfRecID.Value = "-1";
					this.hfcbID.Value = "-1";
	...
	protected void btnExcel_Click(object sender, EventArgs e)
	{
		...
		DataTable dt = DALCommon.GetDataList("ks_associator", this.hfTbField.Value, strCondition).Tables[0];
		...
		string empty = string.Empty;
		bool flag = false;
		DataToExcel.DataTableToExcel(dt, tbTitle, Guid.NewGuid().ToString() + ".xls", "Ass", out flag, out empty);
		if (!flag)
		{
			this.FillData(this.hfOrderName.Value, this.hfOrder.Value);
			this.SysInfo("window.alert('" + empty + "');");
