...
public partial class Headquarters_Customer_CusAccAdd : Page, IRequiresSessionState
{
	private int id;
	...
	protected void btnAdd_Click(object sender, EventArgs e)
	{
		...
		customerAccessoryInfo.OperatorID = int.Parse((string)this.Session["Session_wtUserID"]);
