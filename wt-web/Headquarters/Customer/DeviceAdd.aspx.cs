...
// Type: Headquarters_Customer_DeviceAdd
...
public partial class Headquarters_Customer_DeviceAdd : Page, IRequiresSessionState
{
    private int id;
    private string f;
    ...
    protected void btnAdd_Click(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            if (DALCommon.GetDataList("ks_device", "[ID]", " ProductSN1='" + model.ProductSN1 + "' or ProductSN2='" + model.ProductSN1 + "'").Tables[0].Rows.Count > 0)
            {
    ...
    protected void btnCusInfo_Click(object sender, EventArgs e)
    {
        ...
        this.ddlDept.DataBind();
        this.ddlDept.Items.Insert(0, new ListItem("", ""));
        DataTable dataTable = DALCommon.GetList("CustomerList", "*", " [ID] =" + this.hfCusID.Value).Tables[0];
