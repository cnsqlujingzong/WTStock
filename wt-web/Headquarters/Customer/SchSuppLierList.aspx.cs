...
public partial class Headquarters_Customer_SchSuppLierList : Page, IRequiresSessionState
{
	...
	protected void Page_Load(object sender, EventArgs e)
	{
		...
		if (!base.IsPostBack)
		{
			...
			string str = " bSupplier=1 and bStop=0 ";
			...
			this.gvice.DataSource = DALCommon.GetList("SuppLierList", " [ID],[_Name] ", str + str2);
			this.gvice.DataBind();
		}
	}
