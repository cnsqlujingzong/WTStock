...
public partial class Headquarters_Customer_c_getbrandch : Page, IRequiresSessionState
{
	private string f;
	...
	protected void Page_Load(object sender, EventArgs e)
	{
		...
		if (!base.IsPostBack)
		{
            ...
            this.gvice.DataSource = DALCommon.GetList("BranchList", " top 10 [ID],BranchNO,_Name"," 1=1 "+ str);
			this.gvice.DataBind();
		}
	}
