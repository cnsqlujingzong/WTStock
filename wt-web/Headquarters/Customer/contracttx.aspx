<%@ page language="C#"  CodeFile="contracttx.aspx.cs"     autoeventwireup="true" inherits="Headquarters_Customer_ContractTX" theme="Themes" enableEventValidation="false" %>
        ...
        <table cellpadding="0" cellspacing="0" class="tb2">
            ...
            <td>
                <asp:DropDownList ID="ddlType" runat="server" CssClass="pindl" Width="120">
                    <asp:ListItem Value="0">已到期</asp:ListItem>
                    <asp:ListItem Value="7" Selected="true">7天内将要到期</asp:ListItem>
                    <asp:ListItem Value="15">15天内将要到期</asp:ListItem>
                    <asp:ListItem Value="30">30天内将要到期</asp:ListItem>
                    <asp:ListItem Value="60">60天内将要到期</asp:ListItem>
                    <asp:ListItem Value="120">120天内将要到期</asp:ListItem>
                </asp:DropDownList>
            </td>
            <td>
...
function Chkbom()
{
    $("fbon").innerHTML=parent.DrawInfo("将要到期的服务合同");
}
</script>
