        ...
        <div id="divinfo1" class="divinfo" style="height:282px;">
            ...
            <ContentTemplate>
                <table cellpadding="0" cellspacing="0" class="tb3">
                    ...
                    <tr>
                        ...
                        <td>
                            信誉额度：<asp:TextBox ID="tbPosition" runat="server" Width="70px"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td style="padding-left:15px;">
                            <asp:CheckBox ID="cbCall" runat="server" Checked="true" /> 回访
                             <asp:CheckBox ID="cbTrack" runat="server" Checked="true"/> 跟踪
                        </td>
                    </tr>
                    <tr>
            ...
            <div id="info2">
              ...
              <table cellpadding="0" cellspacing="0" class="tb3">
                    <tr>
                    <td style="padding-left:0px;">
                    <input id="btnNewLinkMan" type="button" value="新建" class="bt1" onclick="if(strtel!=''&&'<%=Str_D %>'=='3') return false;parent.ShowDialog<%=Str_D %>(460, 360, '../Headquarters/Customer/CusLinkManAdd.aspx?f=<%=Str_F %>'+strtel, '新建联系人');"/>
                    <input id="btnEditLinkMan" type="button" value="修改" class="bt1" onclick="if(strtel!=''&&'<%=Str_D %>'=='3') return false;ModLinkMan(460, 363,'../Headquarters/Customer/CusLinkManMod.aspx','修改联系人');"/>
...
function SltCoor()
{
    ...
    parent.ShowDialog<%=Str_D %>(800,520,"../Headquarters/Customer/SltCoor.aspx"+"?str="+escape(str)+"&f=<%=Str_F %>"+strtel,'选择坐标');
}
