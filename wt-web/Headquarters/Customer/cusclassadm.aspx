<%@ page language="C#"  CodeFile="cusclassadm.aspx.cs"     autoeventwireup="true" inherits="Headquarters_Customer_CusClassAdm" enableEventValidation="false" %>
    ...
    <ContentTemplate>
        ...
        <tr>
            <td>
                ...
                <asp:Button ID="btnDel" runat="server" ToolTip="删除" Text="删除"  CssClass="bt1" OnClientClick="if(ChkDel('客户类别')==false)return false;" OnClick="btnDel_Click" UseSubmitBehavior="false" />
            </td>
            <td align="right">
