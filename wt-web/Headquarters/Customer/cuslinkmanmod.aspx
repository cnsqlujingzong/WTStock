<%@ page language="C#"  CodeFile="cuslinkmanmod.aspx.cs"     autoeventwireup="true" inherits="Headquarters_Customer_CusLinkManMod" enableEventValidation="false" %>
               ...
               <table cellpadding="0" cellspacing="0" class="tb3">
                ...
                <tr>
                    ...
                    <td style="padding-left:0px;"><asp:TextBox ID="tbFax" runat="server" CssClass="pin"></asp:TextBox></td>
                       ...
                       <tr>
                    <td align="right">个人手机：</td>
                    <td style="padding-left:0px;"><asp:TextBox ID="tbmoblie" runat="server" CssClass="pin"></asp:TextBox></td>
                    <td align="right">第二手机：</td>
                    <td style="padding-left:0px;"><asp:TextBox ID="tbmoblie2" runat="server" CssClass="pin"></asp:TextBox></td>
                </tr>
                          <tr>
                    <td align="right">QQ：</td>
                    <td style="padding-left:0px;"><asp:TextBox ID="tbQQ" runat="server" CssClass="pin"></asp:TextBox></td>
                    <td align="right">微信：</td>
                    <td style="padding-left:0px;"><asp:TextBox ID="tbWeixin" runat="server" CssClass="pin"></asp:TextBox></td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td colspan="3" style="padding-left:0px;"><asp:TextBox ID="tbAdr" runat="server" CssClass="pin" Width="341"></asp:TextBox></td>
                     ...
                     <tr>
                    <td align="right">个人地址：</td>
                    <td colspan="3" style="padding-left:0px;"><asp:TextBox ID="tbprivateAdr" runat="server" CssClass="pin" Width="341"></asp:TextBox></td>
                </tr>
                <tr>
...
function ChkAdd(str)
{
    ...
    parent.iframeDialog<%=Str_F %>.$("btnModLinkMan").click();
