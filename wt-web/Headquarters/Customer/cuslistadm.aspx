<%@ page language="C#"  CodeFile="cuslistadm.aspx.cs"     autoeventwireup="true" inherits="Headquarters_Customer_CusListAdm" theme="Themes" enableEventValidation="false" %>
...
<body onload="Chkset();" onclick="parent.Sethidden1();">
        ...
        <div class="ftoolleft">
         <table cellpadding="0" cellspacing="0" class="tb2">
            ...
            <td>
                ...
                <input id="btnMod" type="button" value="修改" class="bt1" onclick="ChkMod(600, 450, 'Customer/CusMod.aspx', '修改客户');" />
    ...
    <table cellpadding="0" cellspacing="0" class="pages">
        ...
        <asp:HiddenField ID="hfCusTrackLog" runat="server" />
...
function ChkEditClass()
{
    ...
    {
        parent.ShowDialog(300, 330,'Customer/EditCusClass.aspx?id='+id,'批量修改客户分类');
    }
}
function SmsSndCBat()
{
...
function ChkInput()
{
    parent.ShowDialog(600, 473,'Customer/InputCus.aspx?iflag=1', '导入客户资料');
}
function ChkAllot()
{
    var id=$("hfcbID").value;
