<%@ page language="C#"  CodeFile="devcontmodforsale.aspx.cs"     autoeventwireup="true" inherits="Headquarters_Customer_DevContModForSale" theme="Themes" enableEventValidation="false" %>
...
<body>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional" RenderMode="Inline">
        ...
        <tr>
            ...
            <tr>
                ...
                <td style="padding-left:0px;">
                <asp:TextBox ID="tbStartDate" runat="server" CssClass="pinb3" onfocus="WdatePicker()"></asp:TextBox>
                </td>
                <td align="right">
                终止日期：</td>
                <td style="padding-left:0px;">
                    <asp:TextBox ID="tbEndDate" runat="server" CssClass="pinb3" onfocus="WdatePicker()"></asp:TextBox>
                </td>
                <td align="right"></td>
                <td style="padding-left:0px;">
                    <asp:TextBox ID="tbAmount1" runat="server" CssClass="pinb3" style="display:none;"></asp:TextBox>
                </td>
                <td align="right" class="sysred"></td>
                <td style="padding-left:0px;">
                    <asp:TextBox ID="tbInCash" runat="server" CssClass="pinb3" style="display:none;"></asp:TextBox>
                </td>
            </tr>
            <tr>
    ...
    <table cellpadding="0" cellspacing="0" class="tb2" width="100%">
        <tr>
            ...
            <td><asp:Label runat="server" ID="lbMod"></asp:Label></td>
