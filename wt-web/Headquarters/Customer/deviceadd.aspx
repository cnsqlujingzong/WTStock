<%@ page language="C#"  CodeFile="deviceadd.aspx.cs"     autoeventwireup="true" inherits="Headquarters_Customer_DeviceAdd" theme="Themes" enableEventValidation="false" %>
        ...
        <div class="sdiv">
            ...
            <td style="padding:0px;"><input id="btnSltStaff" type="button" value="" onclick="SltTec();" class="bview"/></td>
                ...
                <tr>
                    ...
                    <td style="padding-left:0px;">
                        <div class="isinDiv">
                            <asp:TextBox ID="tbModel" runat="server" CssClass="pin pinin" AutoCompleteType="Disabled" onblur="ChkPModel();" onmousedown="getSearchResult1('../Customer/SchModel.aspx','tbModel','hfModelID','1','',event);" onkeyup="getSearchResult1('../Customer/SchModel.aspx','tbModel','hfModelID','1','',event);" ></asp:TextBox>
