<%@ page language="C#"  CodeFile="maitenterminateforsale.aspx.cs"     autoeventwireup="true" inherits="Headquarters_Customer_MaitenTerminateForSale" enableEventValidation="false" %>
        ...
        <table cellpadding="0" cellspacing="0" class="tb1">
            <tr>
                ...
                <td style="padding-left:0px;">
                    <input type="text" id="tbCaReason" runat="server" class="pin" style="width:263px;" />
                </td>
            </tr>
        </table>
        </ContentTemplate>
