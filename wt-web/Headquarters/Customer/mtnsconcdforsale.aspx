<%@ page language="C#"  CodeFile="mtnsconcdforsale.aspx.cs"     autoeventwireup="true" inherits="Headquarters_Customer_MtnsconcdForSale" enableEventValidation="false" %>
               ...
               <tr>
                    ...
                    <td style="padding-left:0px;">
                        <asp:DropDownList ID="ddlStatus" runat="server" CssClass="pindl">
                            ...
                            <asp:ListItem Value="1">待执行</asp:ListItem>
                            <asp:ListItem Value="2">执行中</asp:ListItem>
                            <asp:ListItem Value="3">已执行</asp:ListItem>
