<%@ page language="C#"  CodeFile="schclass.aspx.cs"     autoeventwireup="true" inherits="Headquarters_Customer_SchClass" theme="Themes" enableEventValidation="false" %>
...
<body>
    ...
    <asp:GridView ID="gvice" runat="server" AutoGenerateColumns="false" SkinID="sch" ShowHeader="false" OnRowDataBound="gvice_RowDataBound" EnableViewState="false" Width="100%">
        <Columns>
            ...
            <asp:BoundField HeaderText="机器类别" DataField="_Name" />
        </Columns>
    </asp:GridView>
    </div>
