<%@ page language="C#"  CodeFile="schdepartment.aspx.cs"     autoeventwireup="true" inherits="Headquarters_Customer_SchDepartment" theme="Themes" enableEventValidation="false" %>
...
<body>
    ...
    <div class="schlist" style="overflow:auto;height:200px;width:122px;">
    <asp:GridView ID="gvice" runat="server" AutoGenerateColumns="false" SkinID="sch" ShowHeader="false" OnRowDataBound="gvice_RowDataBound" EnableViewState="false" Width="100%">
        <Columns>
            ...
            <asp:BoundField HeaderText="部门名称" DataField="_Name" />
        </Columns>
    </asp:GridView>
    </div>
