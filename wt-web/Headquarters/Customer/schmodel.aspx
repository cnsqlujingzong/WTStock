<%@ page language="C#"  CodeFile="schmodel.aspx.cs"     autoeventwireup="true" inherits="Headquarters_Customer_SchModel" theme="Themes" enableEventValidation="false" %>
...
<body>
    ...
    <asp:GridView ID="gvice" runat="server" AutoGenerateColumns="false" SkinID="sch" ShowHeader="false" OnRowDataBound="gvice_RowDataBound" EnableViewState="false" Width="100%">
        <Columns>
            ...
            <asp:BoundField HeaderText="»úÆ÷ÐÍºÅ" DataField="_Name" />
        </Columns>
    </asp:GridView>
    </div>
