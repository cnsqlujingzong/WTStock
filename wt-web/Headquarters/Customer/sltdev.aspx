<%@ page language="C#"  CodeFile="sltdev.aspx.cs"     autoeventwireup="true" inherits="Headquarters_Customer_SltDev" theme="Themes" enableEventValidation="false" %>
   ...
   <div class="ftool">
        ...
        <table cellpadding="0" cellspacing="0" class="tb2">
            ...
            <td>
                ...
                <input id="btnNew" type="button" runat="server" value="新建" class="bt1" onclick="parent.ShowDialog2(750, 430, '../Headquarters/Customer/DeviceAdd.aspx?f=2'+strtel, '新建机器档案');" />
                </td>
             </tr>
            </table>   
        </div>
