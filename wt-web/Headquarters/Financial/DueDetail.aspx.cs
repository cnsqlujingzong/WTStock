...
public partial class Headquarters_Financial_DueDetail : Page, IRequiresSessionState
{
	...
	{
		string text = " DeptID=1 and Status='待审核' and DueMoney>0 and AccountID=" + this.id.ToString();
