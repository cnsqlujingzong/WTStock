...
public partial class Headquarters_Financial_Expense : Page, IRequiresSessionState
{
	...
	protected int BillAdd(int iflag, out int iTbid)
	{
		...
		else
		{
			...
			expenseInfo.ChkOperatorID = int.Parse(this.Session["Session_wtUserID"].ToString());
		}
