...
public partial class Headquarters_Financial_IncomeCd : Page, IRequiresSessionState
{
	...
	protected void Page_Load(object sender, EventArgs e)
	{
		...
		if (!base.IsPostBack)
		{
			...
			OtherFunction.BindStaff(this.ddlChkOperator, " DeptID=1");
			...
			OtherFunction.BindChargeItem(this.ddlItem, " DeptID=1");
		}
	}
