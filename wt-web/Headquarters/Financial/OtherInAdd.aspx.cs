...
public partial class Headquarters_Financial_OtherInAdd : Page, IRequiresSessionState
{
	...
	protected void Page_Load(object sender, EventArgs e)
	{
		...
		if (!base.IsPostBack)
		{
			...
			if (num > 0)
			{
				...
				if (!dALRight.GetRight(num, "zk_r3"))
				{
	...
	protected void btnAdd_Click(object sender, EventArgs e)
	{
		...
		{
			this.SysInfo("window.alert('操作成功！其他收款已保存！');");
			this.ClearText();
	...
	protected int BillAdd(out int iTbid)
	{
		...
		incomeExpensesInfo.RecType = "其他收款";
