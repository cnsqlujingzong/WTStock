...
public partial class Headquarters_Financial_OtherPayAdd : Page, IRequiresSessionState
{
	...
	protected void Page_Load(object sender, EventArgs e)
	{
		...
		if (!base.IsPostBack)
		{
			...
			if (num > 0)
			{
				...
				if (!dALRight.GetRight(num, "zk_r6"))
				{
	...
	protected void btnAdd_Click(object sender, EventArgs e)
	{
		...
		{
			this.SysInfo("window.alert('操作成功！其他付款已保存！');");
			this.ClearText();
