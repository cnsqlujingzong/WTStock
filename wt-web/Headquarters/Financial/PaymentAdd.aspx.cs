...
public partial class Headquarters_Financial_PaymentAdd : Page, IRequiresSessionState
{
	...
	protected void btnId_Click(object sender, EventArgs e)
	{
		...
		if (this.hfCusID.Value != "")
		{
			...
			DataTable gridViewSource = this.GridViewSource;
			DataTable dataTable2 = DALCommon.GetDataList("zk_cusarrearage", "", " DeptID=1 and Status=1 and NotChargeAmount>0 and Type='应付款' and CustomerID=" + text + " and CusType=" + this.hfType.Value).Tables[0];
