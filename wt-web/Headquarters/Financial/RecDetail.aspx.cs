...
public partial class Headquarters_Financial_RecDetail : Page, IRequiresSessionState
{
	...
	{
		string text = " DeptID=1 and Status='待审核' and RecMoney>0 and AccountID=" + this.id.ToString();
