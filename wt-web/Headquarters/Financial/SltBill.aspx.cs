...
public partial class Headquarters_Financial_SltBill : Page, IRequiresSessionState
{
	...
	{
		string text = " NotChargeAmount>0 and Status=1 and DeptID=1 and CusType=" + this.custype.ToString() + " and CustomerID=" + this.cusid.ToString();
		if (this.iflag == 1)
		{
			text += " and Type='应收款' ";
		}
