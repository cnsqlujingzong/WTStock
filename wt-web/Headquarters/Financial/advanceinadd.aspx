<%@ page language="C#"  CodeFile="advanceinadd.aspx.cs"     autoeventwireup="true" inherits="Headquarters_Financial_AdvanceInAdd" theme="Themes" enableEventValidation="false" %>
        ...
        <table cellpadding="0" cellspacing="0" class="tb1">
            ...
            <tr>
               <td class="sysred">往来单位：</td>
                ...
                <td align="right" class="sysred">预收金额：</td>
                <td style="padding-left:0px;">
...
function Chkbom()
{
    $("fbon").innerHTML=parent.DrawInfo("收预收款");
}
</script>
