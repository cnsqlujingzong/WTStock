<%@ page language="C#"  CodeFile="advancepayadd.aspx.cs"     autoeventwireup="true" inherits="Headquarters_Financial_AdvancePayAdd" theme="Themes" enableEventValidation="false" %>
    ...
    <ContentTemplate>
        <table cellpadding="0" cellspacing="0" class="tb1">
            ...
            <tr>
                ...
                <td align="right" class="sysred">预付金额：</td>
                <td style="padding-left:0px;">
            ...
            <tr>
                ...
                <td align="right" colspan="2">开票日期：</td>
                <td style="padding-left:0px;">
            ...
            <tr>
                ...
                <td align="right" colspan="2">发票类别：</td>
                <td style="padding-left:0px;">
...
function Chkbom()
{
    $("fbon").innerHTML=parent.DrawInfo("付预付款");
}
</script>
