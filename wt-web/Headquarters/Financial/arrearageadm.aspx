<%@ page language="C#"  CodeFile="arrearageadm.aspx.cs"     autoeventwireup="true" inherits="Headquarters_Financial_ArrearageAdm" theme="Themes" enableEventValidation="false" %>
...
<body onload="Chkset();" onclick="parent.Sethidden1();">
    ...
    <div id="cnbut" style="overflow:hidden;">
        ...
        <table cellpadding="0" cellspacing="0" class="tb2" width="100%">
            ...
            <input id="btnAddArr" type="button" value="新增" class="bt1" onclick="addArr();" />
            <input id="btnEditArr" type="button" value="修改" class="bt1" onclick="editArr();" />
            <input id="btnCancelDetailRec" type="button" value="注销坏账" class="bt1" onclick="CancelArr1();" />
            </td>
        ...
        <table cellpadding="0" cellspacing="0" class="tb2" width="100%">
            ...
            <input id="Button1" type="button" value="新增" class="bt1" onclick="addArr2();" />
            <input id="Button2" type="button" value="修改" class="bt1" onclick="editArr();" />
            <input id="btnCancelDetailPay" type="button" value="注销坏账" class="bt1" onclick="CancelArr2();" />
            </td>
            <td align="right" style="padding-right:30px;">
...
function CancelArr1()
{
    ...
    ChkMod(400,100, 'Financial/CancelArrDetail.aspx?f=1&detailid='+id, '应收明细注销');
}
function addArr()
{
    ...
    parent.ShowDialog(300, 290, 'Financial/ModRemindDateAdd.aspx?x=s&id='+id, '新增');
}
function editArr()
{
    var id=$("hfRecID2").value;
    ...
    parent.ShowDialog(300, 290, 'Financial/ModRemindDate.aspx?id='+id, '修改');
}
...
function addArr2()
{
    ...
    parent.ShowDialog(300, 290, 'Financial/ModRemindDateAdd.aspx?x=f&id='+id, '新增');
}
...
function CancelArr2()
{
    ...
    ChkMod(400,100, 'Financial/CancelArrDetail.aspx?f=2&detailid='+id, '应付明细注销');
}
