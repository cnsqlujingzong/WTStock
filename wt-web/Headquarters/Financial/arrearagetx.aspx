<%@ page language="C#"  CodeFile="arrearagetx.aspx.cs"     autoeventwireup="true" inherits="Headquarters_Financial_ArrearageTX" theme="Themes" enableEventValidation="false" %>
            ...
            <span style="display:none;">
                ...
                <td>
                    <asp:DropDownList ID="ddlType" runat="server" CssClass="pindl" Width="120">
                        ...
                        <asp:ListItem Value="7">7天内将要到期</asp:ListItem>
...
function ChkView()
{
    ChkMod(300, 290, 'Financial/ModRemindDate.aspx?v=1', '修改提醒日期');
}
