<%@ page language="C#"  CodeFile="chkexpense.aspx.cs"     autoeventwireup="true" inherits="Headquarters_Financial_ChkExpense" theme="Themes" enableEventValidation="false" %>
    ...
    <Triggers>
        ...
        <tr>
            <td align="right" style="padding-right:20px;">
                <asp:Button ID="btnSave" runat="server" Text="审核" CssClass="bt1" UseSubmitBehavior="false" OnClientClick="if(ChkSave()==false) return false" OnClick="btnSave_Click" />
...
function Chkbom()
{
    $("fbon").innerHTML=parent.DrawInfo("主管审核");
}
</script>
