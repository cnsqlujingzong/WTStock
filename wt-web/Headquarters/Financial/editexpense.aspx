...
<body onload="aload()">
    ...
    <ContentTemplate>
        <table cellpadding="0" cellspacing="0" class="tb1">
            <tr>
                ...
                <td style="padding-left:0px;">结算方式：</td>
            ...
            <tr>
                ...
                <td style="padding-left:0px;">结算帐户：</td>
                <td style="padding-left:0px;">
    ...
    <table cellpadding="0" cellspacing="0" width="100%">
        <tr>
            <td align="left"><font color="red">*已审核状态则不会被修改</font></td>
            <td align="right">
...
function ChkSave()
{
    if(document.getElementById("CheckBox1").checked==true )
    {
        ...
        {
            if(confirm("未选择结算方式，若点击确定将修改'结算方式'为空，否则取消操作！"))
            {
            }else
            {        
                return false
    ...
    if(document.getElementById("CheckBox2").checked==true)
    {
        ...
        {
             if(confirm("未选择结算帐户，若点击确定将修改'结算帐户'为空，否则取消操作！"))
            {
            }else
            {        
                return false
