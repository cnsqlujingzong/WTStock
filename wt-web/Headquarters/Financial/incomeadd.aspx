<%@ page language="C#"  CodeFile="incomeadd.aspx.cs"     autoeventwireup="true" inherits="Headquarters_Financial_IncomeAdd" theme="Themes" enableEventValidation="false" %>
    ...
    <div class="tldiv">
        ...
        <table cellpadding="0" cellspacing="0" class="tb1">
            ...
            <tr>
                ...
                <td  class="sysred" align="right">实收款：</td>
            ...
            <tr>
                ...
                <td align="right" colspan="2">收支项目：</td>
                <td style="padding-left:0px;">
...
function SltBill()
{
    ...
    cusid=$("hfCusID").value;
    parent.ShowDialog(800, 520, 'Financial/SltBill.aspx?iFlag=1&custype='+$("hfType").value+'&cusid='+cusid, '选择单据');
}
function Purchase(id)
{
    parent.ShowDialog(800, 480,'Purchase/PurchaseMod.aspx?ids='+id,'采购退货单');
}
function Sell(id)
{
    parent.ShowDialog(800, 480,'Sell/SellMod.aspx?ids='+id,'销售单');
}
function Lease(id)
{
    parent.ShowDialog(700, 480,'Lease/ShowCharge.aspx?id=0&ids='+id, '结算明细');
}
...
function Chkbom()
{
    $("fbon").innerHTML=parent.DrawInfo("收应收款");
}
</script>
