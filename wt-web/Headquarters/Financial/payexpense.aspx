<%@ page language="C#"  CodeFile="payexpense.aspx.cs"     autoeventwireup="true" inherits="Headquarters_Financial_PayExpense" theme="Themes" enableeventvalidation="false" %>
...
<body onload="Chkset();" onclick="parent.Sethidden1();">
    ...
    <asp:GridView ID="gvdata" runat="server" AutoGenerateColumns="false" SkinID="gv1" OnRowDataBound="gvdata_RowDataBound" EnableViewState="false">
        <Columns>
            ...
            <asp:BoundField HeaderText="网点" DataField="Dept" />
