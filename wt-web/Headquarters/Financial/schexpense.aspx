<%@ page language="C#"  CodeFile="schexpense.aspx.cs"     autoeventwireup="true" inherits="Headquarters_Financial_SchExpense" theme="Themes" enableeventvalidation="false" %>
...
function Displaybtn()
{
    $("btntoexcel").style.display="none";
    $("datatoexcel").style.display="";
}
</script>
