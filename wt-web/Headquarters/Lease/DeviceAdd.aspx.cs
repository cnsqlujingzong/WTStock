...
public partial class Headquarters_Lease_DeviceAdd : Page, IRequiresSessionState
{
	...
	protected void Page_Load(object sender, EventArgs e)
	{
		...
		if (!base.IsPostBack)
		{
			...
			if (dataTable.Rows.Count > 0)
			{
				...
				Headquarters_Lease_DeviceAdd.type = dataTable.Rows[0]["Type"].ToString();
			...
			if (Headquarters_Lease_DeviceAdd.type == "非抄表类租赁")
			{
	...
	protected void btnAdd_Click(object sender, EventArgs e)
	{
		...
		else
		{
			...
			int num = dALLease.UpdateAdd(leaseInfo, (string)this.Session["Session_wtUserID"], out str);
			if (num == 0)
			{
