...
public partial class Headquarters_Lease_ViewQty : Page, IRequiresSessionState
{
	...
	protected void btnSave_Click(object sender, EventArgs e)
	{
		...
		ScriptManager.RegisterStartupScript(this, base.GetType(), "关闭对话框", "document.getElementById('btnClose').click()", true);
	}
}
