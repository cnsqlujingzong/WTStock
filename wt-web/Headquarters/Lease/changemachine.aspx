<%@ page language="C#"  CodeFile="changemachine.aspx.cs"     autoeventwireup="true" inherits="Headquarters_Lease_ChangeMachine" theme="Themes" enableEventValidation="false" %>
    ...
    <div class="ftool">
        ...
        <table cellpadding="0" cellspacing="0" class="tb2">
            ...
            <td>
                ...
                <input id="btnBack" type="button" value="退机" class="bt1" onclick="ChkMod(458, 165,'Lease/DevBack.aspx','退机');" />
                <input id="btnChange" type="button" value="换机" class="bt1" onclick="ChkMod(458, 325,'Lease/Change.aspx','换机');" />
