<%@ page language="C#"  CodeFile="leaseadd.aspx.cs"     autoeventwireup="true" inherits="Headquarters_Lease_LeaseAdd" theme="Themes" enableEventValidation="false" %>
...
<body onload="Chkset();" onclick="parent.Sethidden1();">
    ...
    <ContentTemplate>
        ...
        <tr>
            <td align="right">
                <asp:Label ID="lbRent" runat="server" Text="基础月租："></asp:Label></td>
