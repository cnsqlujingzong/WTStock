<%@ page language="C#"  CodeFile="leasetx.aspx.cs"     autoeventwireup="true" inherits="Headquarters_Lease_LeaseTX" theme="Themes" enableEventValidation="false" %>
...
function Chkbom()
{
    $("fbon").innerHTML=parent.DrawInfo("将要到期的租赁/全保");
}
