<%@ page language="C#"  CodeFile="leaseview.aspx.cs"     autoeventwireup="true" inherits="Headquarters_Lease_LeaseView" theme="Themes" enableEventValidation="false" %>
                ...
                <ContentTemplate>
                    <asp:GridView ID="gvdata" runat="server" AutoGenerateColumns="false" SkinID="gv3" OnRowDataBound="gvdata_RowDataBound">
                        <Columns>
                            ...
                            <asp:BoundField HeaderText="数量" DataField="iCount" />
