<%@ page language="C#"  CodeFile="release.aspx.cs"     autoeventwireup="true" inherits="Headquarters_Lease_Release" theme="Themes" enableEventValidation="false" %>
    ...
    <div class="ftool">
        ...
        <table cellpadding="0" cellspacing="0" class="tb2">
            ...
            <td>
                ...
                <input id="btnRelease" type="button" value="合同解约" class="bt1" onclick="ChkRelease();" />
...
function ChkRelease()
{
    ChkMod(600, 340,'Lease/CRelease.aspx','合同解约');
}
function Chkset()
{
    Chkwhs();
...
function Chkbom()
{
    $("fbon").innerHTML=parent.DrawInfo("合同解约");
}
