<%@ page language="C#"  CodeFile="schlease.aspx.cs"     autoeventwireup="true" inherits="Headquarters_Lease_SchLease" theme="Themes" enableEventValidation="false" %>
...
function Chkbom()
{
    $("fbon").innerHTML=parent.DrawInfo("业务查询");
}
