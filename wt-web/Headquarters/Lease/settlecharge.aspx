<%@ page language="C#"  CodeFile="settlecharge.aspx.cs"     autoeventwireup="true" inherits="Headquarters_Lease_SettleCharge" theme="Themes" enableEventValidation="false" %>
      ...
      <table cellpadding="0" cellspacing="0" class="tb5">
            <tr>
             ...
             <tr>
                ...
                <td style="padding-left:0px;">
                    <asp:TextBox ID="tbInCash" runat="server" CssClass="pin" Width="120" onfocus="select();"></asp:TextBox>
                </td>
                <td>结算帐户：</td>
                <td style="padding-left:0px;">
