<%@ page language="C#"  CodeFile="sltcus.aspx.cs"     autoeventwireup="true" inherits="Headquarters_Lease_SltCus" theme="themes" enableEventValidation="false" %>
...
function ChkIDCus(strname,strlinkman,strtel,strarea,stradr)
{
