...
public partial class Headquarters_Office_FeedBackAdm : Page, IRequiresSessionState
{
	...
	protected void Page_Load(object sender, EventArgs e)
	{
		...
		if (!base.IsPostBack)
		{
			...
			if (num > 0)
			{
				...
				if (!dALRight.GetRight(num, "bg_r31"))
				{
	...
	protected void btnDel_Click(object sender, EventArgs e)
	{
		...
		else if ((feedBackInfo.DeptID == 1 && feedBackInfo.CreateOperator == this.Session["Session_wtUser"].ToString()) || num == 0)
		{
	...
	protected void btnChk_Click(object sender, EventArgs e)
	{
		...
		feedBackInfo.CheckOperator = this.Session["Session_wtUser"].ToString();
