...
public partial class Headquarters_Office_FeedBackMod : Page, IRequiresSessionState
{
	...
	protected void Page_Load(object sender, EventArgs e)
	{
		...
		if (!base.IsPostBack)
		{
			...
			if (feedBackInfo != null)
			{
				...
				if ((feedBackInfo.DeptID != 1 || !(feedBackInfo.CreateOperator == this.Session["Session_wtUser"].ToString())) && num != 0)
				{
					this.btnAdd.Enabled = false;
				}
