...
public partial class Headquarters_Office_MailUpload : Page, IRequiresSessionState
{
			...
			if (this.FileUpload1.HasFile)
			{
				...
				else
				{
					...
					if (flag)
					{
						...
						str = base.Server.MapPath("../Document");
						text3 = str + "\\" + text2;
						...
						else
						{
							...
							stringBuilder.Append(string.Concat(new string[]
							{
								"parent.iframeDialog.document.getElementById(\"dUpload\").innerHTML=parent.iframeDialog.document.getElementById(\"dUpload\").innerHTML+\"<img src='../../Public/Images/dmony.gif' title='附件1' /> <a href=../Document/",
								this.hfPath.Value,
								" target=_blank >附件",
								this.p,
								"</a> (",
