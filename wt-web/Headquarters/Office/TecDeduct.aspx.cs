...
public partial class Headquarters_Office_TecDeduct : Page, IRequiresSessionState
{
	...
	protected void Page_Load(object sender, EventArgs e)
	{
		...
		if (!base.IsPostBack)
		{
			...
			if (num > 0)
			{
				...
				if (dALRight.GetRight(num, "bg_r32"))
				{
					Headquarters_Office_TecDeduct.power = "1";
				}
			}
	...
	protected void FillData(string sortExpression, string direction)
	{
		...
		this.gvgds.DataSource = DALCommon.GetList_HL(0, "tc_detail", "", this.pageSize, this.jsPager.CurrentPageIndex, text, fldSort, out recordCount);
		this.gvgds.DataBind();
	...
	protected string strParm()
	{
		...
		if (Headquarters_Office_TecDeduct.power == "1")
		{
