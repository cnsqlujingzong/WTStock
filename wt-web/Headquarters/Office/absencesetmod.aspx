<%@ page language="C#"  CodeFile="absencesetmod.aspx.cs"     autoeventwireup="true" inherits="Headquarters_Office_AbsenceSetMod" enableEventValidation="false" %>
               ...
               <table cellpadding="0" cellspacing="0" class="tb3">
                <tr>
                    ...
                    <td style="padding-left:0px;">
                        <asp:TextBox ID="tbType" runat="server" CssClass="pin"></asp:TextBox>
                    </td>
