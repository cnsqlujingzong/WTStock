<%@ page language="C#"  CodeFile="attendance.aspx.cs"     autoeventwireup="true" inherits="Headquarters_Office_Attendance" theme="Themes" enableEventValidation="false" %>
...
function ChkInput()
{
    parent.ShowDialog(480, 305,'Office/InputAtt.aspx', '导入考勤明细');
}
function Chkset()
{
    Chkwh3();
...
function Chkbom()
{
    $("fbon").innerHTML=parent.DrawInfo("考勤汇总");
}
</script>
