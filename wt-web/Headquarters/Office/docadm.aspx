<%@ page language="C#"  CodeFile="docadm.aspx.cs"     autoeventwireup="true" inherits="Headquarters_Office_DocAdm" theme="Themes" enableEventValidation="false" %>
...
<body onload="Chkset();" onclick="parent.Sethidden1();">
        ...
        <div class="ftoolleft">
         <table cellpadding="0" cellspacing="0" class="tb2">
            ...
            <td>
                ...
                <input id="btnNew" type="button" value="新建" class="bt1" onclick="parent.ShowDialog(500, 150, 'Office/DocAdd.aspx', '新建文档');" />
                <input id="btnMod" type="button" value="修改" class="bt1" onclick="ChkMod(500,150,'Office/DocMod.aspx','修改文档');" />
                <asp:Button ID="btnDel" runat="server" Text="删除" CssClass="bt1" OnClientClick="if(ChkDel('文档')==false) return false;"  UseSubmitBehavior="false" OnClick="btnDel_Click"/>
                <input id="btnClass" type="button" value="分类管理" class="bt1" onclick="parent.ShowDialog(600, 380, 'Office/DocClassAdm.aspx', '文档分类');" />
            ...
            <table cellpadding="0" cellspacing="0" class="tb2">
                ...
                <td>
                    <asp:DropDownList ID="ddlKey" runat="server" onchange="document.getElementById('tbCon').focus();" CssClass="pindl">
                        <asp:ListItem Value="Title">按摘要查询</asp:ListItem>
    ...
    <asp:GridView ID="GvData" runat="server" AutoGenerateColumns="false" SkinID="gv1" EmptyDataText="没有数据" OnRowDataBound="GvData_RowDataBound" EnableViewState="false">
        <Columns>
            ...
            <asp:BoundField HeaderText="文档摘要" DataField="Title" />
            <asp:BoundField HeaderText="创建者" DataField="Author" />
            <asp:BoundField HeaderText="创建日期" DataField="_Date" />
            <asp:BoundField HeaderText="类型" DataField="FileName" />
            <asp:BoundField HeaderText="文档" DataField="FilePath" />
            <asp:BoundField HeaderText="大小(KB)" DataField="FileSize" />
            <asp:BoundField HeaderText="下载次数" DataField="Hit" />
...
function Chkbom()
{
    $("fbon").innerHTML=parent.DrawInfo("文档管理");
}
</script>
