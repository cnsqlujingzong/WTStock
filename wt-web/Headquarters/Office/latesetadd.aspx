<%@ page language="C#"  CodeFile="latesetadd.aspx.cs"     autoeventwireup="true" inherits="Headquarters_Office_LateSetAdd" enableEventValidation="false" %>
...
function ChkSave()
{
    ...
    {
        window.alert("操作失败！起始分钟不能为空");
        $("tbStart").focus();
        return false
    }
    if(isNull($("tbEnd").value))
    {
        window.alert("操作失败！截止分钟不能为空");
        $("tbEnd").focus();
        return false
    }
}
