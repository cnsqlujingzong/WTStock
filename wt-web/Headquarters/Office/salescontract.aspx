<%@ page language="C#"  CodeFile="salescontract.aspx.cs"     autoeventwireup="true" inherits="Headquarters_Office_SalesContract" theme="Themes" enableEventValidation="false" %>
...
<body onload="Chkset();" onclick="parent.Sethidden1();">
    ...
    <div class="ftool">
        ...
        <table cellpadding="0" cellspacing="0" class="tb2">
           ...
           <asp:Button ID="btnDelCont" runat="server" Text="删除" CssClass="bt1" OnClientClick="if(ChkDel('销售合同')==false) return false;"  UseSubmitBehavior="false" OnClick="btnDelCont_Click" />
        ...
        <div class="ftoolright">
            ...
            <td style="padding:0px;"><input id="btnSchsH" type="button" value="高级查询" class="bsch" onclick="parent.ShowDialog(470,284, 'Customer/MtnsconcdForSale.aspx', '高级查询');" /></td>
            </tr>
            </table>   
        </div>
    ...
    <asp:HiddenField ID="hfgeli" runat="server" Value="-1" />
    </ContentTemplate>
    <Triggers>
    ...
    <div id="cnbut" style="overflow:hidden;">
        ...
        <div id="mytabs" style="padding-left:2px;">
            ...
            <span id="tabs1" onclick="ChkTab('1');">订单信息</span>
...
function ChkCancel()
{
    ...
    parent.ShowDialog(460, 95, 'Customer/MaitenTerminateForSale.aspx?id='+id, '终止合同');
}
function NewCont()
{
    parent.ShowDialog(820, 510, 'Customer/DevContAddForSale.aspx', '新建销售合同')
}
...
function ModCont()
{
    ...
    {
        parent.ShowDialog(820, 510, 'Customer/DevContModForSale.aspx?id='+id, '修改销售合同');
    }
}
function Chkset()
{
...
function Chkbom()
{
    $("fbon").innerHTML=parent.DrawInfo("销售合同");
}
</script>
