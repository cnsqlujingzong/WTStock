<%@ page language="C#"  CodeFile="taskexe.aspx.cs"     autoeventwireup="true" inherits="Headquarters_Office_TaskExe" enableEventValidation="false" %>
        ...
        <table cellpadding="0" cellspacing="0" class="tb3">
            <tr>
                ...
                <td style="padding-left:0px;" colspan="3">
                    <asp:TextBox ID="tbSummary" runat="server" CssClass="pinb" Width="341" ReadOnly="true"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td align="right">
                ...
                <td style="padding-left:0px; height:84px;" colspan="3">
                    <asp:TextBox ID="tbTaskRemark" runat="server" CssClass="pinb" Width="341" Height="70" TextMode="MultiLine" ReadOnly="true"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td align="right">
                ...
                <td style="padding-left:0px;" colspan="3">
                    <asp:TextBox ID="tbRemark" runat="server" CssClass="pinb" Width="341" ReadOnly="true"></asp:TextBox>
                </td>
            </tr>
         </table>
        </div>
