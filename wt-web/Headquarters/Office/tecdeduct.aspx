<%@ page language="C#"  CodeFile="tecdeduct.aspx.cs"     autoeventwireup="true" inherits="Headquarters_Office_TecDeduct" theme="Themes" enableEventValidation="false" %>
        ...
        <div class="ftoolleft">
         <table cellpadding="0" cellspacing="0" class="tb2">
            ...
            <td align="left">
                ...
                <asp:Button ID="btnDel" runat="server" Text="删除" CssClass="bt1" UseSubmitBehavior="false" OnClientClick="if(ChkDel('明细单')==false) return false;" OnClick="btnDel_Click" />
