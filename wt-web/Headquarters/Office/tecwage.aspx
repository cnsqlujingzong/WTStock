<%@ page language="C#"  CodeFile="tecwage.aspx.cs"     autoeventwireup="true" inherits="Headquarters_Office_TecWage" theme="Themes" enableEventValidation="false" %>
...
<body onload="Chkset();" onclick="parent.Sethidden1();">
    ...
    <asp:GridView ID="gvdata" runat="server" AutoGenerateColumns="false" SkinID="statf" OnRowDataBound="gvdata_RowDataBound" EnableViewState="false" ShowFooter="true">
        <Columns>
            ...
            <asp:BoundField HeaderText="提成金额" DataField="Deduct"/>
            <asp:BoundField HeaderText="考勤扣款" DataField="AttMoney"/>
            <asp:BoundField HeaderText="利润提成" DataField="pd"/>
            <asp:BoundField HeaderText="合计应发" DataField="sTotal"/>
    ...
    <asp:HiddenField ID="hfTbTitle" runat="server" Value="ID,工号,姓名,底薪,津贴,提成金额,考勤扣款,利润提成,合计应发,工资帐号,备注" />
    <asp:HiddenField ID="hfTbField" runat="server" Value="ID,JobNO,_Name,Salary,Allowance,Deduct,AttMoney,pd,sTotal,Account,Remark" />
...
function Chkbom()
{
    $("fbon").innerHTML=parent.DrawInfo("员工月度薪资");
}
</script>
