...
public partial class Headquarters_Purchase_PurReturn : Page, IRequiresSessionState
{
	...
	protected void Page_Load(object sender, EventArgs e)
	{
		...
		if (!base.IsPostBack)
		{
			...
			if (num > 0)
			{
				...
				{
					Headquarters_Purchase_PurReturn.bCheck = true;
				}
			}
		...
		if (dataTable.Rows.Count == 1)
		{
			...
			else
			{
				...
				if (num == 0)
				{
					...
					if (Headquarters_Purchase_PurReturn.bCheck)
					{
