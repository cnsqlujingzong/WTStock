<%@ page language="C#"  CodeFile="purchaseadd.aspx.cs"     autoeventwireup="true" inherits="Headquarters_Purchase_PurchaseAdd" theme="Themes" enableEventValidation="false" %>
...
<body onload="Chkset();" onclick="parent.Sethidden1();">
    ...
    <ContentTemplate>
        ...
        <tr>
            ...
            <td style="padding-left:0px;" colspan="2"><asp:TextBox ID="tbDate" runat="server" CssClass="Wdate" onfocus="WdatePicker()"></asp:TextBox></td>
            <td align="right">业务员：</td>
            <td style="padding-left:0px;">
                <asp:DropDownList ID="ddlOperator" runat="server" CssClass="pindl">
                </asp:DropDownList>
            </td>
            <td class="sysred">入库仓库：</td>
            <td style="padding-left:0px;">
        ...
        <tr>
            ...
            <div class="isinDiv">
                <asp:TextBox ID="tbSupName" runat="server" Width="317" CssClass="pin autot" onmousedown="getSearchResult('../Basic/SchSupList.aspx','tbSupName','hfSupID','','btnSupInfo',event);" onkeyup="getSearchResult('../Basic/SchSupList.aspx','tbSupName','hfSupID','','btnSupInfo',event);" AutoCompleteType="Disabled"></asp:TextBox>
            </div>
            </td>
            <td style="padding:0px;" align="right"><input id="btnSlt" type="button" value="" onclick="SltSup();" class="bview"/></td>
            <td align="right">
            备注：</td>
            <td colspan="3" style="padding-left:0px;"><asp:TextBox ID="tbRemark" runat="server" CssClass="pin" Width="341"></asp:TextBox></td>
            <td runat="server" id="tdpc" visible="false">关联订单：<asp:Label ID="lbPlan" runat="server" Text="未关联采购订单"></asp:Label>
        ...
        <tr>
            ...
            <td style="padding-left:0px;" colspan="2"><asp:TextBox ID="tbTel" runat="server" CssClass="pin"></asp:TextBox></td>
            <td>结算方式：</td>
            <td style="padding-left:0px;">
    ...
    <Triggers>
        ...
        <asp:AsyncPostBackTrigger ControlID="btnSupInfo" EventName="Click" />
    </Triggers>
    </asp:UpdatePanel>
    <div class="divh"></div>
    </div>
            ...
            <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
                <ContentTemplate>
                    ...
                    <asp:HiddenField ID="hfBuyPrice" runat="server" Value="0" />
                     ...
                     <asp:Button ID="btnSupInfo" runat="server" Text="..." OnClick="btnSupInfo_Click" />
                     </span>
                </ContentTemplate>
                <Triggers>
                    <asp:AsyncPostBackTrigger ControlID="btnAdd" EventName="Click" />
    ...
    <table cellpadding="0" cellspacing="0" class="tb3">
        <tr>
            ...
            <td><input id="btnPurPlan" type="button" value="采购订单" class="bt1" onclick="parent.ShowDialog(800, 520, 'Purchase/SltPurPlan.aspx', '选择采购订单');" /></td>
...
function ChkSave()
{
   ...
   if($("ddlOperator").value=="-1")
    ...
    {
        if(confirm("现结金额大于价税合计(应付金额),是否继续？"))
            return true;
        else
            return false;
    }
...
function EditSN(unitid,SN,nums,tdsn)
{
...
function Chkbom()
{
    $("fbon").innerHTML=parent.DrawInfo("采购开单");
}
function Caculate()
{
    var tb=$("gvdata");
    ...
    {
        var costprice=tb.rows[i].cells[9].getElementsByTagName("span")[0].innerHTML;
        if(!isNaN(costprice))
        {
