<%@ page language="C#"  CodeFile="purchasemod.aspx.cs"     autoeventwireup="true" inherits="Headquarters_Purchase_PurchaseMod" theme="Themes" enableEventValidation="false" %>
    ...
    <ContentTemplate>
        ...
        <tr>
            ...
            <td colspan="3" style="padding-left:0px;"><asp:TextBox ID="tbRemark" runat="server" CssClass="pin" Width="300"></asp:TextBox>
                ...
                <asp:HiddenField ID="hfSupID" runat="server" /></td>
        </tr>
     </table>
     </ContentTemplate>
    <Triggers>
