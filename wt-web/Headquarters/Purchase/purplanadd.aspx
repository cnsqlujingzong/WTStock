<%@ page language="C#"  CodeFile="purplanadd.aspx.cs"     autoeventwireup="true" inherits="Headquarters_Purchase_PurPlanAdd" theme="Themes" enableEventValidation="false" %>
...
function Chkbom()
{
    $("fbon").innerHTML=parent.DrawInfo("采购订单");
}
</script>
