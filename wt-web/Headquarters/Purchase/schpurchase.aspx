<%@ page language="C#"  CodeFile="schpurchase.aspx.cs"     autoeventwireup="true" inherits="Headquarters_Purchase_SchPurchase" theme="Themes" enableEventValidation="false" %>
    ...
    <div class="ftool">
        ...
        <table cellpadding="0" cellspacing="0" class="tb2">
            ...
            <td>
                ...
                <asp:Button ID="btnChk" runat="server" Text="审核" CssClass="bt1" UseSubmitBehavior="false" OnClientClick="if(ChkConf('审核该[采购单]')==false) return false;" OnClick="btnChk_Click"/>
                <asp:Button ID="btnChkU" runat="server" Text="反审核" CssClass="bt1" UseSubmitBehavior="false" OnClientClick="if(ChkConf('反审核该[采购单]')==false) return false;" OnClick="btnChkU_Click"/>
                <asp:Button ID="btnDel" runat="server" Text="删除" CssClass="bt1" UseSubmitBehavior="false" OnClientClick="if(ChkDel('采购单')==false) return false;" OnClick="btnDel_Click"/>
        ...
        <div class="ftoolright">
            <table cellpadding="0" cellspacing="0" class="tb2">
                <tr>
                <td>
                    <input id="btnPrint" runat="server" type="button" value="打印" class="iprint" onclick="ChkPrint('CGD');" />
                </td>
            ...
            <td>
                <input id="btnSchsH" type="button" value="高级查询" class="bsch" onclick="parent.ShowDialog(460,285, 'Purchase/PurchaseDeCd.aspx', '高级查询');" />
            </td>
            </tr>
            </table>   
        </div>
    ...
    <div id="cnbut">
        <div class="ftool2">
            <div id="mytabs" style="padding-left:2px;">
                ...
                <span id="tabs1" class="tabs_active" >采购明细</span>
...
function ModBill()
{
    ChkMod(800, 480,'Purchase/PurchaseMod.aspx','采购单');
}
...
function Chkbom()
{
    $("fbon").innerHTML=parent.DrawInfo("采购单查询");
}
