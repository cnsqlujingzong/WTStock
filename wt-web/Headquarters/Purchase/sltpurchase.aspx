<%@ page language="C#"  CodeFile="sltpurchase.aspx.cs"     autoeventwireup="true" inherits="Headquarters_Purchase_SltPurchase" theme="Themes" enableEventValidation="false" %>
        ...
        <table cellpadding="0" cellspacing="0" class="tb2">
                ...
                <td>
                   <asp:DropDownList ID="ddlKey" runat="server" CssClass="pindl" onchange="document.getElementById('tbCon').focus();">
                    ...
                    <asp:ListItem Value="8">按仓库查询</asp:ListItem>
