<%@ page language="C#"  CodeFile="sltcus.aspx.cs"     autoeventwireup="true" inherits="Headquarters_Receive_SltCus" theme="Themes" enableEventValidation="false" %>
   ...
   <div class="ftool">
        ...
        <table cellpadding="0" cellspacing="0" class="tb2">
            ...
            <td>
                ...
                <input id="btnNew" type="button" value="新建" class="bt1" onclick="parent.ShowDialog1(600, 400, 'Customer/CusAdd.aspx?f=1', '新建客户');"/>
                </td>
               <td><asp:CheckBox ID="cbDept" runat="server" AutoPostBack="true" OnCheckedChanged="cbDept_CheckedChanged" /><span style="color:#0000ff">只显示本部门的客户</span></td> 
             </tr>
            </table>   
        </div>
...
function ChkIDCus(strname,linkman,tel,adr,zip)
{
