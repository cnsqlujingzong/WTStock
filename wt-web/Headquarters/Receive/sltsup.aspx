<%@ page language="C#"  CodeFile="sltsup.aspx.cs"     autoeventwireup="true" inherits="Headquarters_Receive_SltSup" theme="Themes" enableEventValidation="false" %>
        ...
        <table cellpadding="0" cellspacing="0" class="tb2">
                ...
                <td>
                    <asp:DropDownList ID="ddlKey" runat="server" onchange="document.getElementById('tbCon').focus();" CssClass="pindl">
                        <asp:ListItem Value="_Name">按厂商名称查询</asp:ListItem>
                        <asp:ListItem Value="SupNO">按厂商编号查询</asp:ListItem>
                        ...
                        <asp:ListItem Value="Email">按Email查询</asp:ListItem>
