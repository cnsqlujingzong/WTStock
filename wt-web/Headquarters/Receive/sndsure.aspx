<%@ page language="C#"  CodeFile="sndsure.aspx.cs"     autoeventwireup="true" inherits="Headquarters_Receive_SndSure" theme="Themes" enableEventValidation="false" %>
...
<body onload="Chkset();" onclick="parent.Sethidden1();">
    ...
    <div class="ftool">
        ...
        <table cellpadding="0" cellspacing="0" class="tb2">
            ...
            <td>
                ...
                <input id="btnCheck" type="button" value="确认发货" class="bt1" onclick="ChkNext();" />
                <asp:Button ID="btnUCheck" runat="server" Text="取消" CssClass="bt1" UseSubmitBehavior="false" OnClientClick="if(ChkConf('取消该[发货单]')==false)return false;" OnClick="btnUCheck_Click" />
        ...
        <div class="ftoolright">
            <table cellpadding="0" cellspacing="0" class="tb2">
                ...
                <asp:DropDownList ID="ddlKey" runat="server" CssClass="pindl" onchange="document.getElementById('tbCon').focus();">
                    ...
                    <asp:ListItem Value="SndDept">按发货网点查询</asp:ListItem>
    ...
    <asp:GridView ID="gvbranch" runat="server" AutoGenerateColumns="false" SkinID="gv1" OnRowDataBound="gvbranch_RowDataBound" EnableViewState="false">
        <Columns>
            ...
            <asp:BoundField HeaderText="发货网点" DataField="SndDept" />
    ...
    <Triggers>
        ...
        <asp:AsyncPostBackTrigger ControlID="btnUCheck" EventName="Click" />
    </Triggers>       
    </asp:UpdatePanel>
    </div>
...
function ChkNext()
{
    if(ChkSlt()!=false)
    {
        ChkMod(500,100, 'Receive/SndSureD.aspx', '确认发货');
    }else{return false;}
}

function ChkView()
{
    ChkMod(724,285, 'Receive/SndMod.aspx', '发货单');
}
...
function Chkbom()
{
    $("fbon").innerHTML=parent.DrawInfo("发货确认");
}
</script>
