<%@ page language="C#"  CodeFile="repositoryclassadm.aspx.cs"     autoeventwireup="true" inherits="Headquarters_Repository_RepositoryClassAdm" theme="Themes" enableEventValidation="false" %>
...
<body>
    ...
    <ContentTemplate>
        ...
        <asp:GridView ID="GridView1" runat="server" SkinID="gv4" AutoGenerateColumns="False" OnRowDataBound="GridView1_RowDataBound" Width="70%">
            <Columns>
                ...
                <asp:BoundField HeaderText="分类名称" DataField="_Name" />
            </Columns>
        </asp:GridView>
    ...
    <div class="sdiv">
        ...
        <table cellpadding="0" cellspacing="0" class="tb3">
            <tr>
                ...
                <asp:TextBox ID="tbName" runat="server" CssClass="pin" ToolTip="输入分类名称" Width="160"></asp:TextBox>
    ...
    <tr>
        <td>
            ...
            <asp:Button ID="btnDel" runat="server" Text="删除" CssClass="bt1" OnClientClick="if(ChkDel('分类名称')==false)return false;" OnClick="btnDel_Click" UseSubmitBehavior="false" />
        </td>
        <td align="right">
