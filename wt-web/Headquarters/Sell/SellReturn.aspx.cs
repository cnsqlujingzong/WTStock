...
public partial class Headquarters_Sell_SellReturn : Page, IRequiresSessionState
{
    ...
    protected int BillAdd(out int iTbid)
    {
        SellInfo model = new SellInfo
        {
            ...
            PersonID = int.Parse(this.Session["Session_wtUserID"].ToString()),
    ...
    protected void btnChk_Click(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            if (this.BillAdd(out num) == 0)
            {
                ...
                sell.ChkSell(1, num, result, out strMsg);
