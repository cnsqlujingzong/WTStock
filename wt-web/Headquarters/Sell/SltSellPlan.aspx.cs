...
public partial class Headquarters_Sell_SltSellPlan : Page, IRequiresSessionState
{
	...
	{
		string text = " DeptID=1 and Status='已审核' and isnull(bEnd,1)=1 and EndStatus = '执行中' ";
