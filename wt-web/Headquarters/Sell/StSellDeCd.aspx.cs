...
public partial class Headquarters_Sell_StSellDeCd : Page, IRequiresSessionState
{
	...
	protected void Page_Load(object sender, EventArgs e)
	{
		...
		if (!base.IsPostBack)
		{
			...
			DataTable dataSource2 = DALCommon.GetDataList("StaffList", "[ID],[_Name]", " Status=0 ").Tables[0];
			this.ddlOperator.DataSource = dataSource2;
			...
			this.ddlPerson.DataSource = dataSource2;
			...
			this.ddlChkOperator.DataSource = dataSource2;
