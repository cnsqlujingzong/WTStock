<%@ page language="C#"  CodeFile="sellreturn.aspx.cs"     autoeventwireup="true" inherits="Headquarters_Sell_SellReturn" theme="Themes" enableEventValidation="false" %>
...
<body onload="Chkset();" onclick="parent.Sethidden1();">
    ...
    <table cellpadding="0" cellspacing="0" class="tb3">
        <tr>
            ...
            <td><input id="btnPurPlan" type="button" value="销售单" class="bt1" onclick="parent.ShowDialog(800, 520, 'Sell/SltSell.aspx', '选择销售单');" /></td>
...
function Chkbom()
{
    $("fbon").innerHTML=parent.DrawInfo("销售退货");
}
</script>
