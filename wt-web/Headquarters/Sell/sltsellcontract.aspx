<%@ page language="C#"  CodeFile="sltsellcontract.aspx.cs"     autoeventwireup="true" inherits="Headquarters_Sell_SltSellContract" theme="Themes" enableEventValidation="false" %>
   ...
   <div class="ftool">
        ...
        <table cellpadding="0" cellspacing="0" class="tb2">
                ...
                <td>
                   <asp:DropDownList ID="ddlKey" runat="server" CssClass="pindl" onchange="document.getElementById('tbCon').focus();">
                    ...
                    <asp:ListItem Value="4">按客联系人查询</asp:ListItem>
                    <asp:ListItem Value="5">按联系电话查询</asp:ListItem>
                    <asp:ListItem Value="6">按业务员查询</asp:ListItem>
                    <asp:ListItem Value="7">按经办人查询</asp:ListItem>
        ...
        <div class="ftoolright">
            ...
            <td style="padding-right:80px;">
                ...
                <input id="btnConf" type="button" value="确定" class="bt1" onclick="SltPurPlan();" />
            </td>
            </tr>
            </table>
        </div>
    ...
    <div id="cnbut" style="width:800px; height:180px;">
        <div class="ftool2">
            <div id="mytabs" style="padding-left:2px;">
                ...
                <span id="tabs1" class="tabs_active" >合同订单明细</span>
...
{
    ClrID(id);
    //window.setTimeout($("btnShow").click(),3000);
    $("btnShow").click();
}
...
function SltPurPlan()
{
    ...
    try{
        parent.<%=Str_Fid %>.$("hfSltID1").value=list;
