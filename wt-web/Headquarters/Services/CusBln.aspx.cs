...
public partial class Headquarters_Services_CusBln : Page, IRequiresSessionState
{
	private string id;
	...
	protected void btnAdd_Click(object sender, EventArgs e)
	{
		...
		DataTable gridViewSource = this.GridViewSource;
		decimal amount;
		decimal.TryParse(this.tbAmount.Text, out amount);
		...
		else
		{
			...
			else
			{
				...
				decimal num5 = 0m;
				decimal num6 = 0m;
				int iOperator = int.Parse((string)this.Session["Session_wtUserID"]);
				...
				if (gridViewSource.Rows.Count > 0)
				{
					...
					if (num7 == 0)
					{
						...
						num7 = dALServices.CusBln(1, this.id.TrimEnd(new char[]
						{
							','
