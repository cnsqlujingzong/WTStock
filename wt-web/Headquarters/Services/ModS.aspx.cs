...
public partial class Headquarters_Services_ModS : Page, IRequiresSessionState
{
	private int id;

	private bool bEnforceInput;
	...
	protected void Page_Load(object sender, EventArgs e)
	{
		...
		if (!base.IsPostBack)
		{
			...
			if (dataTable.Rows.Count > 0)
			{
				...
				DataTable dataTable3 = DALCommon.GetDataList("ServicesList", "Fault,DisposalOper,bTake", " [ID]=" + dataTable.Rows[0]["BillID"].ToString()).Tables[0];
