...
public partial class Headquarters_Services_RcvBackSnd : Page, IRequiresSessionState
{
	private string id;
	...
	protected void btnAdd_Click(object sender, EventArgs e)
	{
		...
		for (int i = 0; i < array.Length; i++)
		{
			...
			if (num3 != 0)
			{
				int num4 = dALServices.RcvBackSnd(num3, int.Parse((string)this.Session["Session_wtUserID"]), FunLibrary.ChkInput(this.tbReason.Text), out empty);
				if (num4 == 0)
				{
					num2++;
				}
