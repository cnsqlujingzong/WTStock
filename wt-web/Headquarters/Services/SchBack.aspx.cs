...
// Type: Headquarters_Services_SchBack
...
public partial class Headquarters_Services_SchBack : Page, IRequiresSessionState
{
    private int id;
    ...
    protected void btnAdd_Click(object sender, EventArgs e)
    {
        ...
        new DALServices().BackSteps(this.id, int.Parse((string)this.Session["Session_wtUserID"]), int.Parse(this.hfBeginStep.Value), int.Parse(this.ddlBackTo.SelectedValue), FunLibrary.ChkInput(this.tbReason.Text), out strMsg);
