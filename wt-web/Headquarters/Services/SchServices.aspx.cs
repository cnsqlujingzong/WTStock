...
public partial class Headquarters_Services_SchServices : Page, IRequiresSessionState
{
	...
	protected void FillData(string sortExpression, string direction)
	{
				...
				if (i > 1)
				{
					...
					else
					{
						...
						if (text2 != "ID")
						{
							...
							{
								HiddenField expr_489 = this.hfTbTitle;
								expr_489.Value = expr_489.Value + "," + text3;
							}
							...
							{
								HiddenField expr_4D9 = this.hfTbField;
								expr_4D9.Value = expr_4D9.Value + "," + text2;
							}
						}
					}
				}
		...
		expr_522.Value += ",Speding";
		HiddenField expr_53E = this.hfTbTitle;
		expr_53E.Value += ",处理时间";
	}
