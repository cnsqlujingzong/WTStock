    ...
    <div class="main">
        ...
        <div class="fdiv">
            ...
            <tr>
                ...
                <td align="right">
                    <input type="button" id="btnAddAttach" onclick="AddAttach()" value="增加附件" runat="server" class="bt1"/>
...
function AddAttach()
{
    parent.ShowDialog2(450, 93,"../Headquarters/Services/serAttachsAdd.aspx?f=2&fid=iframeDialog1&t=<%=aType %>&bid=<%=Str_bid %>","添加附件");
}
