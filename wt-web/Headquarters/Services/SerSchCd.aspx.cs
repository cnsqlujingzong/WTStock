...
public partial class Headquarters_Services_SerSchCd : Page, IRequiresSessionState
{
	...
	protected void btnSch_Click(object sender, EventArgs e)
	{
		...
		string text27 = FunLibrary.ChkInput(this.tbBackViewStart.Text);
		string text28 = FunLibrary.ChkInput(this.tbBackViewEnd.Text);
		string text29 = FunLibrary.ChkInput(this.tbArea.Text);
		string text30 = FunLibrary.ChkInput(this.tbSellContNO.Text);
		...
		if (text27 != "")
		{
			text = text + " and VisitDate>='" + text27 + "'";
		}
		if (text28 != "")
		{
			text = text + " and VisitDate<='" + text28 + " 23:59:59'";
		}
		if (text29 != "")
		{
			text = text + " and Area like '%" + text29 + "%'";
		}
		if (text30 != "")
		{
			text = text + " and ContractNO  like '%" + text30 + "%'";
		}
