...
public partial class Headquarters_Services_ServicesAddBat : Page, IRequiresSessionState
{
	...
	protected void Page_Load(object sender, EventArgs e)
	{
		...
		if (!base.IsPostBack)
		{
			...
			DataTable dataTable = DALCommon.GetDataList("StaffList", "[ID]", " bTechnician=1 and [ID]=" + (string)this.Session["Session_wtUserID"]).Tables[0];
