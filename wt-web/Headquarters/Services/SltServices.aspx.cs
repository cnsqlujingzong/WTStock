...
public partial class Headquarters_Services_SltServices : Page, IRequiresSessionState
{
	...
	{
		string text = " OutSourcing=0 and DisposalID=1 and (curStatus='待处理' or curStatus='处理中') ";
