<%@ page language="C#"  CodeFile="adds.aspx.cs"     autoeventwireup="true" inherits="Headquarters_Services_AddS" enableeventvalidation="false" %>
            ...
            <ContentTemplate>
                <table cellpadding="0" cellspacing="0" class="tb5">
                    ...
                    <tr>
                        ...
                        <td style="padding:0px;"><input id="btnSltStaff" runat="server" type="button" onclick="SltTec();" title="选择技术员" class="bview"/></td>
                    </tr>
