<%@ page language="C#"  CodeFile="cusbln.aspx.cs"     autoeventwireup="true" inherits="Headquarters_Services_CusBln" theme="Themes" enableEventValidation="false" %>
        ...
        <ContentTemplate>
            <table cellpadding="0" cellspacing="0" class="tb5">
                <tr>
                    ...
                    <td align="right" class="red">
                    实收金额：</td>
                    <td style="padding-left:0px;"><asp:TextBox ID="tbRealMoney" runat="server" CssClass="pinb"></asp:TextBox></td>
                </tr>
                <tr>
                    <td align="right" class="red">
                    现结金额：</td>
