<%@ page language="C#"  CodeFile="modi.aspx.cs"     autoeventwireup="true" inherits="Headquarters_Services_ModI" enableEventValidation="false" %>
            ...
            <ContentTemplate>
                <table cellpadding="0" cellspacing="0" class="tb3">
                    ...
                    <tr>
                        ...
                        <td style="padding:0px;display:none;"><input id="btnSltStaff" type="button" onclick="SltTec();" class="bview"/></td>
                    </tr>
                    <tr>
