<%@ page language="C#"  CodeFile="serschcd.aspx.cs"     autoeventwireup="true" inherits="Headquarters_Services_SerSchCd" enableeventvalidation="false" %>
            ...
            <ContentTemplate>
               <table cellpadding="0" cellspacing="0" class="tb3">
                ...
                <tr>
                    ...
                    <td style="padding-left:0px;">
                        <asp:DropDownList ID="ddlcurStatus" runat="server" CssClass="pindl">
                            ...
                            <asp:ListItem Value="待回访">待回访</asp:ListItem>
                ...
                <tr>
                    ...
                    <td style="padding-left:0px;"><asp:TextBox ID="tbOverTimeStart" runat="server" CssClass="Wdate" onfocus="WdatePicker()"></asp:TextBox></td>
                    <td align="right">至：</td>
                    <td style="padding-left:0px;"><asp:TextBox ID="tbOverTimeEnd" runat="server" CssClass="Wdate" onfocus="WdatePicker()"></asp:TextBox></td>
                </tr>
                <tr>
                    <td align="right">结算时间：</td>
                    <td style="padding-left:0px;"><asp:TextBox ID="tbJSTimeStart" runat="server" CssClass="Wdate" onfocus="WdatePicker()"></asp:TextBox></td>
                    <td align="right">至：</td>
                    <td style="padding-left:0px;"><asp:TextBox ID="tbJSTimeEnd" runat="server" CssClass="Wdate" onfocus="WdatePicker()"></asp:TextBox></td>
                </tr>
                <tr>
                    <td align="right">审核时间：</td>
                    <td style="padding-left:0px;"><asp:TextBox ID="tbChkTimeStart" runat="server" CssClass="Wdate" onfocus="WdatePicker()"></asp:TextBox></td>
                    <td align="right">至：</td>
                    <td style="padding-left:0px;"><asp:TextBox ID="tbChkTimeEnd" runat="server" CssClass="Wdate" onfocus="WdatePicker()"></asp:TextBox></td>
                </tr>
                <tr>
                    <td align="right">回访时间：</td>
                    <td style="padding-left:0px;"><asp:TextBox ID="tbBackViewStart" runat="server" CssClass="Wdate" onfocus="WdatePicker()"></asp:TextBox></td>
                    <td align="right">至：</td>
                    <td style="padding-left:0px;"><asp:TextBox ID="tbBackViewEnd" runat="server" CssClass="Wdate" onfocus="WdatePicker()"></asp:TextBox></td>
                </tr>
                <tr>
                    <td align="right">销售合同号：</td>
                    <td style="padding-left:0px;"><asp:TextBox ID="tbSellContNO" runat="server" CssClass="pin"></asp:TextBox></td>
                    <td align="right">所属区域：</td>
                    <td style="padding-left:0px;">
                            <div class="isinDiv">
                            <asp:TextBox ID="tbArea" runat="server" CssClass="pin pinin" AutoCompleteType="Disabled"></asp:TextBox>
                            <asp:DropDownList ID="ddlArea" runat="server" CssClass="pininsl" onchange="document.getElementById('tbArea').value=this.options[this.selectedIndex].text;NewAreas('3');">
                        </asp:DropDownList>
                        </div>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td style="padding-left:0px;">
                    <asp:DropDownList ID="ddlSerType" runat="server" CssClass="pindl">
                    </asp:DropDownList>
                    </td>
                    <td align="right"></td>
                    <td style="padding-left:0px;" colspan="3"><asp:CheckBox ID="cbSeeBack" runat="server" Text="已回访" TextAlign="Right" /></td>
                </tr>
