<%@ page language="C#"  CodeFile="servicesadd.aspx.cs"     autoeventwireup="true" inherits="Headquarters_Services_ServicesAdd" theme="Themes" enableeventvalidation="false" %>
...
<body>
    ...
    <div class="tldiv2">
        <table cellpadding="0" cellspacing="0" class="tb1">
            <tr>
                <td width="310"><a href="#" onclick="parent.ShowDialog(870,555, '../Headquarters/Services/ServicesAddBat.aspx?tel=<%=Str_Tel %>&cusid=<%=Str_CusID %>', '批量受理');">切换到批量模式</a></td>
    ...
    <div class="sdivs" style="padding:3px 0 3px 0px;width:852px;">
       ...
       <table cellpadding="0" cellspacing="0" class="tb1">
            <tr>
                <td align="right" class="auto-style1" style="padding:0px;">客户名称</td>
            ...
            <tr>
                <td align="right" style="padding-left:0px;" class="auto-style3">
                使用人：</td>
                <td style="padding-left:0px;width:126px;">
                <div class="isinDiv">
                ...
                <%--所属部门：--%></td>
                <td style="padding-left:0px;">
                 <div class="isinDiv" style="display:none"><!---by coding-->
            ...
            <tr>
                <td  align="right" style="padding:0px" class="auto-style3">联系地址:</td>
                <td colspan="3" style="padding-left:0px;">
    ...
    <Triggers>
        ...
        <ContentTemplate>
            ...
            <tr>
                ...
                <td align="right" colspan="2"><%--by coding 机器类别：--%>序列号：</td>
                <td style="padding-left:0px;">
               <div class="isinDiv" style="display:none"><!---by coding -->
                    ...
                    <asp:TextBox ID="tbSN1" runat="server" CssClass="pin2" onkeydown="EnterTextBoxSN(event, this);" onblur="ChkSN();"></asp:TextBox>
            ...
            <tr>
                ...
                <td colspan="3" rowspan="2" style="padding-left:0px;">
                    ...
                    <asp:HiddenField ID="hfFault" runat="server" />
                    </td>
...
function SltCus()
{
    parent.ShowDialog1(800, 500, '../Headquarters/Services/SltCus.aspx?f=1&strname='+escape($("tbCusName").value)+strtel, '选择客户');
}
function ChkNO()
{
...
function SltDev()
{
    ...
    if(cusid=="")
    {
        parent.ShowDialog1(800, 500, '../Headquarters/Customer/SltDev.aspx?f=1&psn='+escape($("tbSN1").value)+'&strname='+escape($("tbCusName").value)+strtel, '选择机器档案');
    }
    else
    {
        parent.ShowDialog1(800, 500, '../Headquarters/Customer/SltDev.aspx?f=1&psn='+escape($("tbSN1").value)+'&strname='+escape($("tbCusName").value)+'&cusid='+cusid+strtel, '选择机器档案');
    }
}
function SltModel()
{
    parent.ShowDialog1(400, 510, '../Headquarters/Services/SltModel.aspx?f=1&sBrand='+escape($("tbBrand").value)+'&sClass='+escape($("tbClass").value)+strtel, '选择型号');
}
function SltAsp()
{
    parent.ShowDialog1(400, 510, '../Headquarters/Basic/SltAsp.aspx?f=1'+strtel, '机器外观');
}
function SltAcc()
{
    parent.ShowDialog1(400, 510, '../Headquarters/Basic/SltAcc.aspx?f=1'+strtel, '随机附件');
}
function SltFault()
{
    parent.ShowDialog1(600, 510, '../Headquarters/Basic/SltFault.aspx?f=1'+strtel, '常见故障');
}
function SltTec()
{
    parent.ShowDialog1(400, 510, '../Headquarters/Services/SltTec.aspx?f=1'+strtel, '技术员');
}
function SltTemp()
{
    parent.ShowDialog1(800, 520, '../Headquarters/Basic/SltDevConfItem.aspx?f=1'+strtel, '选择配置');
}
...
function ViewCus()
{
    ...
    {
        //新建客户
        parent.ShowDialog1(600, 450, '../Headquarters/Customer/CusAdd.aspx?f=1' + strtel, '新建客户');
    }
    else
    {
        //修改客户
        parent.ShowDialog1(600, 450, '../Headquarters/Customer/CusMod.aspx?f=1&id=' + cusid + strtel, '客户信息');
    }
}
function FaultAttach()
{
    var ids=$("hfAttachs").value;
    parent.ShowDialog1(480, 243, '../Headquarters/Services/SerAttachs.aspx?t=1&aids='+ids+strtel, '报称故障附件');
}
function ViewHistory()
{
    ...
    parent.ShowDialog1(800, 520, '../Headquarters/Customer/CusHistory.aspx?f=1&cusid='+cusid+strtel, '相关业务');
}
function ChkUpload()
{   
    if($("dUpload").innerHTML=="")
    {
        parent.ShowDialog1(600, 380, '../Headquarters/Services/UpLoad.aspx?p=1'+strtel, '上传附件');
    }
    else
    {
        if(confirm("已经存在一个附件，继续上传将替换该附件，是否继续？"))
        {
            parent.ShowDialog1(600, 380, '../Headquarters/Services/UpLoad.aspx?pd=1'+strtel, '上传附件');
        }
    }
}
...
<script type="text/javascript">
    ...
    // addressInit('cmbProvince', 'cmbCity', 'cmbArea', '北京', '北京', '东城区');
</script>
