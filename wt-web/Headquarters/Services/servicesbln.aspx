<%@ page language="C#"  CodeFile="servicesbln.aspx.cs"     autoeventwireup="true" inherits="Headquarters_Services_ServicesBln" theme="Themes" enableEventValidation="false" %>
...
<body onload="Chkset();" onclick="parent.Sethidden1();">
    ...
    <div class="ftool">
        ...
        <table cellpadding="0" cellspacing="0" class="tb2">
            ...
            <input id="btnBln" runat="server" type="button" value="结算" class="bt1" onclick="ChkBln();" />
            <input id="btnBack" type="button" value="驳回" class="bt1" onclick="ChkBack();" runat="server" />
    ...
    <asp:GridView ID="gvdata" runat="server" AutoGenerateColumns="false" SkinID="gv1" OnRowDataBound="gvdata_RowDataBound" EnableViewState="false">
        <Columns>
            ...
            <asp:BoundField HeaderText="客户类别" DataField="CusType" />
            <asp:BoundField HeaderText="客户ID" DataField="CustomerID" />
...
function SltValue(i,cb,type,nameid,name)
{
   if($(cb).checked)
    ...
    if(isNull($("hfCusType").value))
    {
        $("hfCusType").value=type;
        $("hfCusName").value=name;
        $("hfCusID").value=nameid;
    }
    if($("hfCusType").value+$("hfCusID").value!=type+nameid)
    {
        alert("只能选择同一客户的服务单结算或驳回！");
        $("hfcbID").value=$("hfcbID").value.replace(i+",","");
        $(cb).checked=false;
    }
...
function ChkBln()
{
    ...
    {    
        parent.ShowDialog(880,512, 'Services/CusBln.aspx?id='+id+'&type='+escape($("hfCusType").value)+'&corp='+escape($("hfCusName").value)+'&corpid='+$("hfCusID").value, '结算');
    }else{return false;}
}
...
function ChkBack()
{
    ...
    {    
        parent.ShowDialog(460,98, 'Services/BlnBack.aspx?id='+id, '驳回');
    }else{return false;}
}
function ChkView()
{
...
function Chkbom()
{
    $("fbon").innerHTML=parent.DrawInfo("完工结算");
}
</script>
