<%@ page language="C#"  CodeFile="sltservices.aspx.cs"     autoeventwireup="true" inherits="Headquarters_Services_SltServices" theme="Themes" enableEventValidation="false" %>
   ...
   <div class="ftool">
    ...
    <asp:GridView ID="gvdata" runat="server" AutoGenerateColumns="false" SkinID="gv1" OnRowDataBound="gvdata_RowDataBound" EnableViewState="false">
        <Columns>
            ...
            <asp:BoundField HeaderText="使用数量" DataField="Qty" />
