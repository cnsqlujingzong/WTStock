<%@ page language="C#"  CodeFile="slttec.aspx.cs"     autoeventwireup="true" inherits="Headquarters_Services_SltTec" theme="Themes" enableEventValidation="false" %>
   ...
   <div class="ftool">
        ...
        <table cellpadding="0" cellspacing="0" class="tb2">
                ...
                <td>
                    ...
                    <input id="btnSchLocation" type="button" value="查看位置" class="bt1" onclick="ChkModC(800, 600,'Basic/StSerMap.aspx','员工所在位置');" />
                    </td>
                 </tr>
            </table>   
        </div>
    ...
    <asp:GridView ID="gvdata" runat="server" AutoGenerateColumns="false" SkinID="gv1" OnRowDataBound="gvdata_RowDataBound" EnableViewState="false">
        <Columns>
            ...
            <asp:BoundField HeaderText="进行中的服务单" DataField="BillNum" />
            <asp:BoundField HeaderText="服务单区域" DataField="BillArea" />
        </Columns>
    </asp:GridView>
...
function ChkPass()
{
    ...
    if("<%=Str_X %>"=="2")
        parent.<%=Str_Fid %>.$("tbDisposal").value=m;
    else
