...
// Type: Headquarters_Stat_BroughBackSellDe
...
public partial class Headquarters_Stat_BroughBackSellDe : Page, IRequiresSessionState
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (this.deptid == -1)
            ...
            strCondition = str + (object)" and DeptID = '" + (string)(object)this.deptid + "' and ChkDate between '" + this.startdate + "' and '" + this.enddate + " 23:59:59'  and GoodsNO = '" + this.GoodsNO + "'";
