...
public partial class Headquarters_Stat_MaterialDeByAppOperator : Page, IRequiresSessionState
{
	...
	protected void btnSch_Click(object sender, EventArgs e)
	{
		...
		if (this.ddlStaffName.SelectedValue != "-1")
		{
			text = text + " and AppID =" + this.ddlStaffName.SelectedValue;
		}
		this.FillData(text);
	}
