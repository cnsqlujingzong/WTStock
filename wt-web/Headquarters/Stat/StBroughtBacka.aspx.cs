...
public partial class Headquarters_Stat_StBroughtBacka : Page, IRequiresSessionState
{
	...
	protected void Page_Load(object sender, EventArgs e)
	{
		...
		if (!base.IsPostBack)
		{
			...
			if (num > 0)
			{
				...
				if (!dALRight.GetRight(num, "tj_r12"))
				{
	...
	protected void FillData(string sortExpression, string direction)
	{
		...
		this.gvdata.DataSource = DALCommon.GetStIStr("tj_ck_lt_hz", 2, text3).Tables[0];
	...
	protected void gvdata_RowDataBound(object sender, GridViewRowEventArgs e)
	{
		...
		if (e.Row.RowType == DataControlRowType.Footer)
		{
			...
			e.Row.Cells[9].Text = this.dr6.ToString("#0.00");
		}
	}
	...
	protected void btnExcel_Click(object sender, EventArgs e)
	{
		...
		DataTable dt = DALCommon.GetStIStr("tj_ck_lt_hz", 2, text3).Tables[0];
