...
public partial class Headquarters_Stat_StSellReturng : Page, IRequiresSessionState
{
	...
	protected void FillData(string sortExpression, string direction)
	{
		...
		this.gvdata.DataSource = DALCommon.GetStData("tj_xs_th", 0, text, strOrderFld);
	...
	{
		DataTable dt = DALCommon.GetStData("tj_xs_th", 0, this.hfSql.Value, this.hfOrderName.Value + " " + this.hfOrder.Value).Tables[0];
