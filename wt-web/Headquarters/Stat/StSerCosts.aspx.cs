...
public partial class Headquarters_Stat_StSerCosts : Page, IRequiresSessionState
{
	...
	protected void Page_Load(object sender, EventArgs e)
	{
		...
		if (!base.IsPostBack)
		{
			...
			OtherFunction.BindServicesType(this.ddlServicesType);
			this.ddlServicesType.Items.Insert(0, new ListItem("全部", "-1"));
			this.FillData();
		}
	}
	...
	protected void FillData()
	{
		...
		if (this.ddlServicesType.SelectedValue != "-1")
		{
			text3 = text3 + " and sl.TypeID=" + this.ddlServicesType.SelectedValue;
		}
		DataSet dataSet = dALServices.StSerCosts(4, text3, text, text2);
	...
	protected void btnExcel_Click(object sender, EventArgs e)
	{
		...
		DataTable dataTable = dALServices.StSerCosts(4, text3, text, text2).Tables[0];
