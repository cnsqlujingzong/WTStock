...
public partial class Headquarters_Stat_StSerMaterial : Page, IRequiresSessionState
{
	...
	protected void FillData(string sortExpression, string direction)
	{
		...
		{
			text = text + " and b.DeptID=" + this.ddlBranch.SelectedValue + "";
		}
		...
		if (this.gvdata.Rows.Count > 0)
		{
			for (int i = 0; i < this.gvdata.HeaderRow.Cells.Count; i++)
			{
				if (i > 0)
				{
					...
					{
						HiddenField expr_29A = this.hfTbTitle;
						expr_29A.Value = expr_29A.Value + "," + text2;
					}
					...
					{
						HiddenField expr_2EA = this.hfTbField;
						expr_2EA.Value = expr_2EA.Value + "," + dataField;
					}
				}
			}
		}
