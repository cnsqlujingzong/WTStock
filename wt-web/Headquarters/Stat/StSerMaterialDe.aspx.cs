...
public partial class Headquarters_Stat_StSerMaterialDe : Page, IRequiresSessionState
{
	...
	protected void FillData()
	{
		...
		{
			int deptid = 0;
			int.TryParse(base.Request.QueryString["deptid"], out deptid);
			...
			DataSet dataSource = dALServices.SerMaterialDe(num, minValue, datee, deptid, base.Request.QueryString["hc"] != null);
