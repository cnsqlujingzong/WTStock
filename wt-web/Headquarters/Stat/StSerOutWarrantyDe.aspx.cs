...
public partial class Headquarters_Stat_StSerOutWarrantyDe : Page, IRequiresSessionState
{
	...
	protected void FillData()
	{
		...
		DataSet dataSet = dALServices.StSerCosts(31, text, strDateS, strDateE);
	...
	protected void btnExcel_Click(object sender, EventArgs e)
	{
		...
		DataTable dataTable = dALServices.StSerCosts(31, text3, text, text2).Tables[0];
		...
		bool flag = false;
		DataToExcel.DataTableToExcel(dataTable, tbTitle, Guid.NewGuid().ToString() + ".xls", "保外维修成本明细", out flag, out empty);
		if (!flag)
		{
			this.FillData();
