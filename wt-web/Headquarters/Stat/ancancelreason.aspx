<%@ page language="C#"  CodeFile="ancancelreason.aspx.cs"     autoeventwireup="true" inherits="Headquarters_Stat_AnCancelReason" enableEventValidation="false" %>
...
<body onload="ChkGetImg();" onclick="parent.Sethidden1();">
    ...
    <img id="img" src="../../Public/Images/li1.gif" title="取消原因分析" alt="统计图" galleryimg="no"/> 
    </form>
</body>
</html>
...
function ChkGetImg()
{
    ...
    document.getElementById("img").src="../../Public/Handler/PicCancelReason.ashx?dept="+dept+"&year="+year+"&width="+widths+"&height="+heights+"&c="+num;
}
</script>
