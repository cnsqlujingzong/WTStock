<%@ page language="C#"  CodeFile="anoperationtype.aspx.cs"     autoeventwireup="true" inherits="Headquarters_Stat_AnOperationType" enableEventValidation="false" %>
...
<body onload="ChkGetImg();" onclick="parent.Sethidden1();">
    ...
    <img id="img" src="../../Public/Images/li1.gif" title="服务类别分析" alt="统计图" galleryimg="no"/> 
    </form>
</body>
</html>
...
function ChkGetImg()
{
    ...
    document.getElementById("img").src="../../Public/Handler/PicOperationType.ashx?dept="+dept+"&year="+year+"&width="+widths+"&height="+heights+"&c="+num;
}
</script>
