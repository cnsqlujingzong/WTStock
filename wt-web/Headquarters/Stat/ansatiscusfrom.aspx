<%@ page language="C#"  CodeFile="ansatiscusfrom.aspx.cs"     autoeventwireup="true" inherits="Headquarters_Stat_AnSatisCusFrom" enableEventValidation="false" %>
...
<body onload="ChkGetImg();" onclick="parent.Sethidden1();">
    ...
    <img id="img" src="../../Public/Images/li1.gif" title="客户来源分析" alt="统计图" galleryimg="no"/> 
    </form>
</body>
</html>
...
function ChkGetImg()
{
    ...
    document.getElementById("img").src="../../Public/Handler/PicSatisCusFrom.ashx?dept="+escape(dept)+"&timeb="+timeb+"&timee="+timee+"&width="+widths+"&height="+heights+"&c="+num;
}
</script>
