<%@ page language="C#"  CodeFile="broughtbackde.aspx.cs"     autoeventwireup="true" inherits="Headquarters_Stat_BroughtBackDe" theme="Themes" enableEventValidation="false" %>
    ...
    <div class="sdivs" style="width:852px; height:455px;">
        <asp:GridView ID="gvdata" runat="server" AutoGenerateColumns="false" SkinID="gv3" OnRowDataBound="gvdata_RowDataBound" EnableViewState="false" ShowFooter="true">
            <Columns>
                ...
                <asp:BoundField HeaderText="申请人" DataField="operator" />
...
function ShowDetail()
{
    ...
    if(type=="领料")
    parent.ShowDialog1(800, 480, 'Stock/BroughtBackMod.aspx?ids='+id+'&f=1', type+'单');
    else
    parent.ShowDialog1(800, 480,'Stock/BroughtBackMod.aspx?ids='+id+'&f=1', type+'单');
}
function SerView(id)
