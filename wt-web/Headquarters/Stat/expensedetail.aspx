<%@ page language="C#"  CodeFile="expensedetail.aspx.cs"     autoeventwireup="true" inherits="Headquarters_Stat_ExpenseDetail" theme="Themes" enableeventvalidation="false" %>
...
<body onload="Chkset();" onclick="parent.Sethidden1();">
    ...
    <asp:GridView ID="gvbranch" runat="server" AutoGenerateColumns="false" SkinID="gv1" OnRowDataBound="gvbranch_RowDataBound" EnableViewState="false">
        <Columns>
            ...
            <asp:BoundField HeaderText="备注" DataField="Remark1" />
        </Columns>
    </asp:GridView>
