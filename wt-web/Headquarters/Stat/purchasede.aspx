<%@ page language="C#"  CodeFile="purchasede.aspx.cs"     autoeventwireup="true" inherits="Headquarters_Stat_PurchaseDe" theme="Themes" enableEventValidation="false" %>
...
function ShowDetail()
{
    ...
    if(type=="领料")
    parent.ShowDialog1(800, 480, 'Purchase/PurchaseMod.aspx?ids='+id+'&f=1', type+'单');
    else
    parent.ShowDialog1(800, 480,'Purchase/PurchaseMod.aspx?ids='+id+'&f=1', type+'单');
}
