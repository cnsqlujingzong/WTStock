<%@ page language="C#"  CodeFile="starr.aspx.cs"     autoeventwireup="true" inherits="Headquarters_Stat_StArr" theme="Themes" enableEventValidation="false" %>
...
<body onload="Chkset();" onclick="parent.Sethidden1();">
    ...
    <asp:GridView ID="gvdata" runat="server" AutoGenerateColumns="false" SkinID="statf" OnRowDataBound="gvdata_RowDataBound" EnableViewState="false" ShowFooter="true">
        <Columns>
            ...
            <asp:BoundField HeaderText="单位名称" DataField="by_name"/>
            <asp:BoundField HeaderText="所属" DataField="Dept"/>
            <asp:BoundField HeaderText="应收总金额" DataField="Amount"/>
            <asp:BoundField HeaderText="应收已结算金额" DataField="HaveAmount"/>
            <asp:BoundField HeaderText="应收未结算金额" DataField="NotChargeAmount"/>
            <asp:BoundField HeaderText="应付总金额" DataField="iAmount"/>
            <asp:BoundField HeaderText="应付已结算金额" DataField="iHaveAmount"/>
            <asp:BoundField HeaderText="应付未结算金额" DataField="iNotChargeAmount"/>
        </Columns>
    </asp:GridView>
    ...
    <asp:HiddenField ID="hfTbTitle" runat="server" Value="ID,单位名称,所属,应收总金额,应收已结算金额,应收未结算金额,应付总金额,应付已结算金额,应付未结算金额" />
...
function ChkView()
{
    ...
    parent.ShowDialog(870,513, 'Stat/ArrDe.aspx?id='+id+'&iflag=0&deptid='+deptid+'&startdate='+startdate+'&enddate='+enddate, '明细');
}
function Chkset()
{
    Chkwh();
...
function Chkbom()
{
    $("fbon").innerHTML=parent.DrawInfo("应收应付汇总表");
}
</script>
