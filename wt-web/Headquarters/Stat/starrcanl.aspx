<%@ page language="C#"  CodeFile="starrcanl.aspx.cs"     autoeventwireup="true" inherits="Headquarters_Stat_StArrCanl" theme="Themes" enableEventValidation="false" %>
...
<body onload="Chkset();" onclick="parent.Sethidden1();">
    ...
    <asp:GridView ID="gvdata" runat="server" AutoGenerateColumns="false" SkinID="statf" OnRowDataBound="gvdata_RowDataBound" EnableViewState="false">
        <Columns>
            ...
            <asp:BoundField HeaderText="坏帐金额" DataField="CancelAmount"/>
...
function Chkbom()
{
    $("fbon").innerHTML=parent.DrawInfo("应收应付坏帐表");
}
</script>
