<%@ page language="C#"  CodeFile="stbillview.aspx.cs"     autoeventwireup="true" inherits="Headquarters_Stat_StBillView" theme="Themes" enableEventValidation="false" %>
...
<body onload="Chkset();" onclick="parent.Sethidden1();">
    ...
    <asp:GridView ID="gvdata" runat="server" AutoGenerateColumns="false" SkinID="statf" OnRowDataBound="gvdata_RowDataBound" EnableViewState="false" Width="60%">
        <Columns>
            ...
            <asp:BoundField HeaderText="日期" DataField="日期" HtmlEncode="false" DataFormatString="{0:yyyy-MM-dd}" />
            <asp:BoundField HeaderText="受理" DataField="受理" />
            <asp:BoundField HeaderText="处理" DataField="处理" />
            <asp:BoundField HeaderText="结算" DataField="结算" />
            <asp:BoundField HeaderText="回访" DataField="回访" />
            <asp:BoundField HeaderText="审核" DataField="审核" />
            <asp:BoundField HeaderText="完工率" DataField="完工率"/>
        </Columns>
    </asp:GridView>
...
function Chkbom()
{
    $("fbon").innerHTML=parent.DrawInfo("服务单概览");
}
</script>
