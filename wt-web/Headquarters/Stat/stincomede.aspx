<%@ page language="C#"  CodeFile="stincomede.aspx.cs"     autoeventwireup="true" inherits="Headquarters_Stat_StIncomeDe" theme="Themes" enableEventValidation="false" %>
    ...
    <div class="ftool">
        <div class="ftoolleft">
          ...
          <table cellpadding="0" cellspacing="0" class="tb2">
            ...
            <ContentTemplate>
                <asp:DropDownList ID="ddlKey" runat="server" CssClass="pindl" OnSelectedIndexChanged="ddlKey_SelectedIndexChanged" AutoPostBack="true" >
          ...
          <Triggers>
            <asp:AsyncPostBackTrigger ControlID="ddlKey" EventName="SelectedIndexChanged" />
          </Triggers>
            </asp:UpdatePanel>
            </td>
            <td>
...
function ChkView()
{
    ChkMod(670,245, 'Financial/InPayView.aspx', '收款单');
}
function Chkset()
{
    Chkwh();
...
function Chkbom()
{
    $("fbon").innerHTML=parent.DrawInfo("收款单明细表");
}
</script>
