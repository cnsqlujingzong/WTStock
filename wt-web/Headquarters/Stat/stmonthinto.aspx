<%@ page language="C#"  CodeFile="stmonthinto.aspx.cs"     autoeventwireup="true" inherits="Headquarters_Stat_StMonthInTo" theme="Themes" enableEventValidation="false" %>
...
<body onload="Chkset();" onclick="parent.Sethidden1();">
    ...
    <asp:HiddenField ID="hfTbTitle" runat="server" Value="业务月度,应收金额,优惠金额1,实收金额,应付金额,优惠金额2,实付金额,实收-实付" />
...
function ChkView()
{
    ...
    parent.ShowDialog(870,513, 'Stat/InToDe.aspx?billdate='+billdate+'&iflag=1&deptid='+deptid, '明细');
}
function Chkset()
{
    Chkwh();
...
function Chkbom()
{
    $("fbon").innerHTML=parent.DrawInfo("收支月报表");
}
</script>
