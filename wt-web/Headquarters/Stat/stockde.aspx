<%@ page language="C#"  CodeFile="stockde.aspx.cs"     autoeventwireup="true" inherits="Headquarters_Stat_StockDe" theme="Themes" enableEventValidation="false" %>
...
<body>
    ...
    <div class="main">
    <div class="maincon">
    <div id="sa" runat ="server" style="width:856px;">
    <div class="fdivs">
    <div class="sdivs" style="width:852px; height:455px;">
        <asp:GridView ID="gvdata" runat="server" AutoGenerateColumns="false" SkinID="gv3" OnRowDataBound="gvdata_RowDataBound" EnableViewState="false" ShowFooter="true">
            <Columns>
                <asp:BoundField HeaderText="单据属性" DataField="billtype" />
                <asp:BoundField HeaderText="业务类型" DataField="type" />
...
function ShowDetail()
{
    ...
    if(type=="入库")
        parent.ShowDialog1(800, 520, 'Stock/StockINMod.aspx?ids=' + id + '&f=1', type + '单');
    else
    parent.ShowDialog1(800, 520,'Stock/StockOutMod.aspx?ids='+id+'&f=1', type+'单');
}
function Purchase(id,title)
{
    parent.ShowDialog1(800, 480,'Purchase/PurchaseMod.aspx?ids='+id+'&f=1',title);
}
function BroughtBack(id,title)
{
    parent.ShowDialog1(800, 480,'Stock/BroughtBackMod.aspx?ids='+id+'&f=1',title);
}
function Sell(id,title)
{
    parent.ShowDialog1(800, 480,'Sell/SellMod.aspx?ids='+id+'&f=1',title);
}
function Lease(id)
{
    parent.ShowDialog1(800, 480,'Lease/LeaseMod.aspx?ids='+id+'&f=1','业务单');
}
