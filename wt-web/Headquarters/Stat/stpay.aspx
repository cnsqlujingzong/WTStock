<%@ page language="C#"  CodeFile="stpay.aspx.cs"     autoeventwireup="true" inherits="Headquarters_Stat_StPay" theme="Themes" enableEventValidation="false" %>
...
function ChkView()
{
    ...
    if($("r3").checked)
        iflag=4;
    parent.ShowDialog(870,513, 'Stat/InToDe.aspx?billdate='+billdate+'&f=2&iflag='+iflag+'&deptid='+deptid+'&startdate='+startdate+'&enddate='+enddate, '明细');
}
function Chkset()
{
    Chkwh();
...
function Chkbom()
{
    $("fbon").innerHTML=parent.DrawInfo("付款单汇总表");
}
</script>
