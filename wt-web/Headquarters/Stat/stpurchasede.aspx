<%@ page language="C#"  CodeFile="stpurchasede.aspx.cs"     autoeventwireup="true" inherits="Headquarters_Stat_StPurchaseDe" theme="Themes" enableEventValidation="false" %>
...
<body onload="Chkset();" onclick="parent.Sethidden1();">
    ...
    <div class="ftool">
        ...
        <table cellpadding="0" cellspacing="0" class="tb2">
            ...
            <asp:ListItem Value="BillID">按单据编号查询</asp:ListItem>
                ...
                <asp:ListItem Value="Provider">按供应商查询</asp:ListItem>
            ...
            <td>
                <input id="btnSchsH" type="button" value="高级查询" class="bsch" onclick="parent.ShowDialog(460,260, 'Stat/StPurchaseDeCd.aspx', '高级查询');" />
            </td>
            <td>
    ...
    <asp:UpdatePanel ID="UpdatePanel2" runat="server">
        <ContentTemplate>
            <span class="bs1" style="color:#0000ff;">总合计金额:<asp:Label ID="Label1" runat="server" Text="0"></asp:Label></span>
        </ContentTemplate>
    <Triggers>
        <asp:AsyncPostBackTrigger ControlID="btnClr" EventName="Click" />
        <asp:AsyncPostBackTrigger ControlID="btnOrder" EventName="Click" />
...
function Chkbom()
{
    $("fbon").innerHTML=parent.DrawInfo("采购明细汇总表");
}
</script>
