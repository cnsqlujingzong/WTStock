<%@ page language="C#"  CodeFile="stpurchasedecd.aspx.cs"     autoeventwireup="true" inherits="Headquarters_Stat_StPurchaseDeCd" enableEventValidation="false" %>
               ...
               <table cellpadding="0" cellspacing="0" class="tb3">
                <tr>
                    ...
                    <td style="padding-left:0px;">
                        <asp:TextBox ID="tbProvider" runat="server" CssClass="pin"></asp:TextBox>
                    </td>
