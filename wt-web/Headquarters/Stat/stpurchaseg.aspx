<%@ page language="C#"  CodeFile="stpurchaseg.aspx.cs"     autoeventwireup="true" inherits="Headquarters_Stat_StPurchaseg" theme="Themes" enableEventValidation="false" %>
...
<body onload="Chkset();" onclick="parent.Sethidden1();">
    ...
    <asp:HiddenField ID="hfTbField" runat="server" Value="GoodsNO,_Name,Spec,Unit,Qty,Total" />
...
function ChkView()
{
    ...
    parent.ShowDialog(870,513, 'Stat/PurchaseDe.aspx?billdate='+billdate+'&iflag=2&deptid='+deptid+'&startdate='+startdate+'&enddate='+enddate, '明细');
}
function Chkset()
{
    Chkwh();
...
function Chkbom()
{
    $("fbon").innerHTML=parent.DrawInfo("产品采购汇总表");
}
</script>
