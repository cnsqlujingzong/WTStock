<%@ page language="C#"  CodeFile="stpurchasep.aspx.cs"     autoeventwireup="true" inherits="Headquarters_Stat_StPurchasep" theme="Themes" enableEventValidation="false" %>
...
function ChkView()
{
    ...
    parent.ShowDialog(870,513, 'Stat/PurchaseDe.aspx?billdate='+billdate+'&iflag=3&deptid='+deptid+'&startdate='+startdate+'&enddate='+enddate, '明细');
}
function Chkset()
{
    Chkwh();
...
function Chkbom()
{
    $("fbon").innerHTML=parent.DrawInfo("供应商采购汇总表");
}
</script>
