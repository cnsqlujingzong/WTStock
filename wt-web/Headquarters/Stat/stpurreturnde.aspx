<%@ page language="C#"  CodeFile="stpurreturnde.aspx.cs"     autoeventwireup="true" inherits="Headquarters_Stat_StPurReturnDe" theme="Themes" enableEventValidation="false" %>
...
<body onload="Chkset();" onclick="parent.Sethidden1();">
    ...
    <div class="ftool">
        ...
        <table cellpadding="0" cellspacing="0" class="tb2">
            ...
            <td>
                <input id="btnSchsH" type="button" value="高级查询" class="bsch" onclick="parent.ShowDialog(460,260, 'Stat/StPurchaseDeCd.aspx?f=1', '高级查询');" />
            </td>
            <td>
...
function Chkbom()
{
    $("fbon").innerHTML=parent.DrawInfo("退货明细汇总表");
}
</script>
