<%@ page language="C#"  CodeFile="stpurreturng.aspx.cs"     autoeventwireup="true" inherits="Headquarters_Stat_StPurReturng" theme="Themes" enableEventValidation="false" %>
...
<body onload="Chkset();" onclick="parent.Sethidden1();">
    ...
    <asp:HiddenField ID="hfTbTitle" runat="server" Value="编号,名称,规格,单位,数量,金额,价税合计"/>
    <asp:HiddenField ID="hfTbField" runat="server" Value="GoodsNO,_Name,Spec,Unit,Qty,Total,GoodsAmount" />
...
function ChkView()
{
    ...
    parent.ShowDialog(870,513, 'Stat/PurchaseDe.aspx?billdate='+billdate+'&iflag=4&deptid='+deptid+'&startdate='+startdate+'&enddate='+enddate, '明细');
}
function Chkset()
{
    Chkwh();
