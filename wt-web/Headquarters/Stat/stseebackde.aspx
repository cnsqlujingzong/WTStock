<%@ page language="C#"  CodeFile="stseebackde.aspx.cs"     autoeventwireup="true" inherits="Headquarters_Stat_StSeeBackDe" theme="Themes" enableeventvalidation="false" %>
...
<body onload="Chkset();" onclick="parent.Sethidden1();">
    ...
    <asp:GridView ID="gvdata" runat="server" AutoGenerateColumns="false" SkinID="gv1" OnRowDataBound="gvdata_RowDataBound" EnableViewState="false">
        <Columns>
            ...
            <asp:BoundField HeaderText="回访时间" DataField="VisitDate" />
            <asp:BoundField HeaderText="被回访人" DataField="VisitCusName" />
            <asp:BoundField HeaderText="客户意见" DataField="VisitOpinon" />
            <asp:BoundField HeaderText="回访备注" DataField="VisitRemark" />
            <asp:BoundField HeaderText="回访人" DataField="VisitOperator" />
            <asp:BoundField HeaderText="回访形式" DataField="VisitStyle" />
            <asp:BoundField HeaderText="回访情况" DataField="HFQK" />
