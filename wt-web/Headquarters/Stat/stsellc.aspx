<%@ page language="C#"  CodeFile="stsellc.aspx.cs"     autoeventwireup="true" inherits="Headquarters_Stat_StSellc" theme="Themes" enableEventValidation="false" %>
...
<body onload="Chkset();" onclick="parent.Sethidden1();">
    ...
    <div class="ftool">
        <div class="ftoolleft">
          <table cellpadding="0" cellspacing="0" class="tb2">
            ...
            <td>客户名称：</td>
            <td style="padding-left:0px;">
                <asp:TextBox ID="tbCusName" runat="server" CssClass="pink" ToolTip="输入查询关键字"></asp:TextBox>
            </td>
            <td align="left">
    ...
    <asp:HiddenField ID="hfTbTitle" runat="server" Value="ID,客户编号,名称,数量,金额,价税合计,成本,毛利" />
    <asp:HiddenField ID="hfTbField" runat="server" Value="ID,CustomerNO,_Name,Qty,Total,GoodsAmount,SellCost,SellProfit" />
...
function ChkView()
{
    ...
    parent.ShowDialog(870,513, 'Stat/SellDe.aspx?billdate='+billdate+'&iflag=4&deptid='+deptid+'&startdate='+startdate+'&enddate='+enddate, '明细');
}
function Chkset()
{
    Chkwh();
...
function Chkbom()
{
    $("fbon").innerHTML=parent.DrawInfo("客户销售汇总表");
}
</script>
