<%@ page language="C#"  CodeFile="stsellde.aspx.cs"     autoeventwireup="true" inherits="Headquarters_Stat_StSellDe" theme="Themes" enableEventValidation="false" %>
    ...
    <div class="ftool">
        ...
        <table cellpadding="0" cellspacing="0" class="tb2">
            ...
            <asp:ListItem Value="BillID">按单据编号查询</asp:ListItem>
                ...
                <asp:ListItem Value="ClassName">按产品类别查询</asp:ListItem>
                <asp:ListItem Value="DepartmentName" >按所属部门查询</asp:ListItem>
