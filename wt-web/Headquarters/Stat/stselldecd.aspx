<%@ page language="C#"  CodeFile="stselldecd.aspx.cs"     autoeventwireup="true" inherits="Headquarters_Stat_StSellDeCd" enableEventValidation="false" %>
            ...
            <ContentTemplate>
               <table cellpadding="0" cellspacing="0" class="tb3">
                ...
                <tr>
                    ...
                    <td style="padding-left:0px;">
                        <asp:TextBox ID="tbCusClass" runat="server" CssClass="pin"></asp:TextBox>
                    </td>
                </tr>
            </table>
            </ContentTemplate>
