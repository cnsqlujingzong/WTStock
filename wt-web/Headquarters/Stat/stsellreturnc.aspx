<%@ page language="C#"  CodeFile="stsellreturnc.aspx.cs"     autoeventwireup="true" inherits="Headquarters_Stat_StSellReturnc" theme="Themes" enableEventValidation="false" %>
...
<body onload="Chkset();" onclick="parent.Sethidden1();">
    ...
    <asp:HiddenField ID="hfTbTitle" runat="server" Value="ID,客户编号,名称,数量,金额,价税合计,成本" />
    <asp:HiddenField ID="hfTbField" runat="server" Value="ID,CustomerNO,_Name,Qty,Total,GoodsAmount,SellCost" />
...
function ChkView()
{
    ...
    parent.ShowDialog(870,513, 'Stat/SellDe.aspx?billdate='+billdate+'&iflag=6&deptid='+deptid+'&startdate='+startdate+'&enddate='+enddate, '明细');
}
function Chkset()
{
    Chkwh();
...
function Chkbom()
{
    $("fbon").innerHTML=parent.DrawInfo("客户退货汇总表");
}
</script>
