<%@ page language="C#"  CodeFile="stsellreturng.aspx.cs"     autoeventwireup="true" inherits="Headquarters_Stat_StSellReturng" theme="Themes" enableEventValidation="false" %>
...
<body onload="Chkset();" onclick="parent.Sethidden1();">
    ...
    <asp:HiddenField ID="hfTbTitle" runat="server" Value="ID,编号,名称,规格,单位,数量,金额,价税合计,成本" />
    <asp:HiddenField ID="hfTbField" runat="server" Value="GoodsNO,_Name,Spec,Unit,Qty,Total,GoodsAmount,SellCost" />
...
function ChkView()
{
    ...
    parent.ShowDialog(870,513, 'Stat/SellDe.aspx?billdate='+billdate+'&iflag=5&deptid='+deptid+'&startdate='+startdate+'&enddate='+enddate, '明细');
}
function Chkset()
{
    Chkwh();
...
function Chkbom()
{
    $("fbon").innerHTML=parent.DrawInfo("产品退货汇总表");
}
</script>
