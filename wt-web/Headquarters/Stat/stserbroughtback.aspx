<%@ page language="C#"  CodeFile="stserbroughtback.aspx.cs"     autoeventwireup="true" inherits="Headquarters_Stat_StSerBroughtBack" theme="Themes" enableEventValidation="false" %>
...
<body onload="Chkset();" onclick="parent.Sethidden1();">
    ...
    <table cellpadding="0" cellspacing="0" class="pages">
        ...
        <asp:HiddenField ID="hfTbTitle" runat="server" Value="服务单号,完成时间,服务类别,客户名称,技术员,产品编号,产品名称,出库仓库,出库数量,出库序列号,良品入库仓库,良品入库数量,良品入库序列号,废品入库仓库,废品入库数量,废品入库序列号"/>
        <asp:HiddenField ID="hfTbField" runat="server" Value="BillID,DoneDate,ServicesType,CustomerName,Operators,GoodsNO,GoodsName,fOutStock,fOutCount,fOutSN,fInStock,fInCount,fInSN,wInStock,wInCount,wInSN" />
    </ContentTemplate>
    <Triggers>
