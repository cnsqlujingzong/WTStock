<%@ page language="C#"  CodeFile="stsercosts.aspx.cs"     autoeventwireup="true" inherits="Headquarters_Stat_StSerCosts" theme="Themes" enableEventValidation="false" %>
    ...
    <div class="ftool">
        <div class="ftoolleft">
          <table cellpadding="0" cellspacing="0" class="tb2">
            ...
            <td class="red">服务类别</td>
            <td style="padding-left:0px;">
                <asp:DropDownList ID="ddlServicesType" runat="server" CssClass="pindl" Width="100">
                    <asp:ListItem Value=""></asp:ListItem>
                </asp:DropDownList>
            </td>
            <td>日期从：</td>
...
function ChkView(cid)
{
    var dates=$("tbDateB").value;
    var datee=$("tbDateE").value;
    var dept=$("ddlBranch").value;
    var sertype=$("ddlServicesType").value
    parent.ShowDialog(800, 480, 'Stat/StSerCostsDe.aspx?cid='+cid+'&sertype='+sertype+'&deptid='+dept+'&startdate='+dates+'&enddate='+datee, '明细');
}
function Chkset()
{
    Chkwh();
