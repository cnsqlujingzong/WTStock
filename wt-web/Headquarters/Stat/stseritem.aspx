<%@ page language="C#"  CodeFile="stseritem.aspx.cs"     autoeventwireup="true" inherits="Headquarters_Stat_StSerItem" theme="Themes" enableEventValidation="false" %>
...
<body onload="Chkset();" onclick="parent.Sethidden1();">
    ...
    <asp:HiddenField ID="hfOrderName" runat="server" Value="ItemID" />
    <asp:HiddenField ID="hfOrderTitle" runat="server" Value="ItemID" />
...
function Chkbom()
{
    $("fbon").innerHTML=parent.DrawInfo("服务项目汇总表");
}
</script>
