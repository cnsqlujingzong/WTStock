<%@ page language="C#"  CodeFile="stservicec.aspx.cs"     autoeventwireup="true" inherits="Headquarters_Stat_StServicec" theme="Themes" enableEventValidation="false" %>
...
<body onload="Chkset();" onclick="parent.Sethidden1();">
    ...
    <asp:GridView ID="gvdata" runat="server" AutoGenerateColumns="false" SkinID="statf" OnRowDataBound="gvdata_RowDataBound" EnableViewState="false" ShowFooter="true">
        <Columns>
            ...
            <asp:BoundField HeaderText="客户名称" DataField="by_name" DataFormatString="{0:yyyy-MM-dd}" HtmlEncode="false" />
    ...
    <asp:HiddenField ID="hfTbTitle" runat="server" Value="ID,客户名称,材料费,人工费,附加费,优惠金额,合计,材料成本,额外成本,送修成本,营业额,毛利" />
...
function ChkView()
{
    ...
    parent.ShowDialog(870,513, 'Stat/ServicesDe.aspx?billdate='+billdate+'&iflag=2&deptid='+deptid+'&startdate='+startdate+'&enddate='+enddate, '明细');
}
function Chkset()
{
    Chkwh();
...
function Chkbom()
{
    $("fbon").innerHTML=parent.DrawInfo("服务汇总表");
}
</script>
