<%@ page language="C#"  CodeFile="stserwarranty.aspx.cs"     autoeventwireup="true" inherits="Headquarters_Stat_StSerWarranty" theme="Themes" enableEventValidation="false" %>
...
function ChkView(cid)
{
    ...
    parent.ShowDialog(800, 480, 'Stat/StSerWarrantyDe.aspx?cid='+cid+'&deptid='+dept+'&startdate='+dates+'&enddate='+datee, '明细');
}
function Chkset()
{
    Chkwh();
