<%@ page language="C#"  CodeFile="ststockday.aspx.cs"     autoeventwireup="true" inherits="Headquarters_Stat_StStockDay" theme="Themes" enableEventValidation="false" %>
...
<body onload="Chkset();" onclick="parent.Sethidden1();">
    ...
    <asp:GridView ID="gvdata" runat="server" AutoGenerateColumns="false" SkinID="statf" OnRowDataBound="gvdata_RowDataBound" EnableViewState="false" ShowFooter="true">
        <Columns>
            ...
            <asp:BoundField HeaderText="出库金额" DataField="CostPrice" DataFormatString="{0:n2}" HtmlEncode="false"/>
        </Columns>
    </asp:GridView>
    ...
    <asp:HiddenField ID="hfTbTitle" runat="server" Value="日期,入库数量,入库金额,出库数量,出库金额" />
    <asp:HiddenField ID="hfTbField" runat="server" Value="FDate,InQty,InTotal,OutQty,CostPrice" />
...
function ChkView()
{
    ...
    parent.ShowDialog(870,513, 'Stat/StockDe.aspx?billdate='+billdate+'&deptid='+deptid, '明细');
}
function Chkset()
{
    Chkwh();
...
function Chkbom()
{
    $("fbon").innerHTML=parent.DrawInfo("仓库日报表");
}
</script>
