<%@ page language="C#"  CodeFile="ststocking.aspx.cs"     autoeventwireup="true" inherits="Headquarters_Stat_StStockINg" theme="Themes" enableEventValidation="false" %>
...
function ChkView()
{
    ...
    parent.ShowDialog(870,513, 'Stat/StockDe.aspx?billdate='+billdate+'&deptid='+deptid+'&iflag=2'+'&startdate='+startdate+'&enddate='+enddate, '明细');
}
function Chkset()
{
    Chkwh();
...
function Chkbom()
{
    $("fbon").innerHTML=parent.DrawInfo("产品入库汇总表");
}
