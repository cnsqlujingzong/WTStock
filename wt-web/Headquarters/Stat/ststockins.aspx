<%@ page language="C#"  CodeFile="ststockins.aspx.cs"     autoeventwireup="true" inherits="Headquarters_Stat_StStockINs" theme="Themes" enableEventValidation="false" %>
...
function ChkView()
{
    ...
    parent.ShowDialog(870,513, 'Stat/StockDe.aspx?billdate='+escape(billdate)+'&deptid='+deptid+'&iflag=3'+'&startdate='+startdate+'&enddate='+enddate, '明细');
}
function Chkbom()
{
    $("fbon").innerHTML=parent.DrawInfo("仓库入库汇总表");
}
</script>
