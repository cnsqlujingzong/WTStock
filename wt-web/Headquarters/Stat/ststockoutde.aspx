<%@ page language="C#"  CodeFile="ststockoutde.aspx.cs"     autoeventwireup="true" inherits="Headquarters_Stat_StStockOUTDe" theme="Themes" enableEventValidation="false" %>
...
<body onload="Chkset();" onclick="parent.Sethidden1();">
    ...
    <div class="ftool">
        ...
        <table cellpadding="0" cellspacing="0" class="tb2">
            ...
            <asp:ListItem Value="BillID">按单据编号查询</asp:ListItem>
                ...
                <asp:ListItem Value="Reason">按出库原因查询</asp:ListItem>
                <asp:ListItem Value="OperationID">按业务编号查询</asp:ListItem>
                ...
                <asp:ListItem Value="BillRemark">按单据备注查询</asp:ListItem>
            ...
            <td>
                <input id="btnSchsH" type="button" value="高级查询" class="bsch" onclick="parent.ShowDialog(460,345, 'Stat/StStockDeCd.aspx?f=1', '高级查询');" />
            </td>
            <td>
    ...
    <asp:GridView ID="gvdata" runat="server" AutoGenerateColumns="false" SkinID="statf" OnRowDataBound="gvdata_RowDataBound" EnableViewState="false">
        <Columns>
            ...
            <asp:BoundField HeaderText="产品类别" DataField="ClassName" />
    ...
    <table cellpadding="0" cellspacing="0" width="100%">
        <tr>
            ...
            <td align="right" style="padding-right:30px;">
                ...
                <ContentTemplate>
                   <span class="sysred">出库总金额：</span>
                   <asp:Label ID="lbAmount" runat="server" CssClass="sysred" Text="0.00"></asp:Label>
                   <span class="sysred">出库总成本：</span>
                   <asp:Label ID="lbCost" runat="server" CssClass="sysred" Text="0.00"></asp:Label>
                </ContentTemplate>
                <Triggers>
                    <asp:AsyncPostBackTrigger ControlID="btnSch" EventName="Click" />
                    <asp:AsyncPostBackTrigger ControlID="btnSchH" EventName="Click" />
...
function Chkbom()
{
    $("fbon").innerHTML=parent.DrawInfo("出库明细汇总表");
}
</script>
