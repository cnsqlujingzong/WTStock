<%@ page language="C#"  CodeFile="ststockoutg.aspx.cs"     autoeventwireup="true" inherits="Headquarters_Stat_StStockOUTg" theme="Themes" enableEventValidation="false" %>
...
<body onload="Chkset();" onclick="parent.Sethidden1();">
          ...
          <table cellpadding="0" cellspacing="0" class="tb2">
            ...
            <td>
                ...
                <asp:DropDownList ID="ddrSchType" runat="server">
                    ...
                    <asp:ListItem Value="3">按产品属性查询</asp:ListItem>
                    <asp:ListItem Value="4">按产品规格查询</asp:ListItem>
                </asp:DropDownList>
            </td>
            <td>
    ...
    <asp:GridView ID="gvdata" runat="server" AutoGenerateColumns="false" SkinID="statf" OnRowDataBound="gvdata_RowDataBound" EnableViewState="false" ShowFooter="true">
        <Columns>
            ...
            <asp:BoundField HeaderText="金额" DataField="StockOUTCost" />
        </Columns>
    </asp:GridView>
...
function ChkView()
{
    ...
    parent.ShowDialog(870,513, 'Stat/StockDe.aspx?billdate='+billdate+'&deptid='+deptid+'&iflag=4'+'&startdate='+startdate+'&enddate='+enddate, '明细');
}
function Chkset()
{
    Chkwh();
...
function Chkbom()
{
    $("fbon").innerHTML=parent.DrawInfo("产品出库汇总表");
}
