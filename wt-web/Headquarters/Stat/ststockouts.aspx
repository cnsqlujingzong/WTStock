<%@ page language="C#"  CodeFile="ststockouts.aspx.cs"     autoeventwireup="true" inherits="Headquarters_Stat_StStockOUTs" theme="Themes" enableEventValidation="false" %>
...
function ChkView()
{
    ...
    parent.ShowDialog(870,513, 'Stat/StockDe.aspx?billdate='+escape(billdate)+'&deptid='+deptid+'&iflag=5'+'&startdate='+startdate+'&enddate='+enddate, '明细');
}
function Chkset()
{
    Chkwh();
...
function Chkbom()
{
    $("fbon").innerHTML=parent.DrawInfo("仓库出库汇总表");
}
</script>
