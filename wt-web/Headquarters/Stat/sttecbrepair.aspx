<%@ page language="C#"  CodeFile="sttecbrepair.aspx.cs"     autoeventwireup="true" inherits="Headquarters_Stat_StTecbRepair" theme="Themes" enableEventValidation="false" %>
...
<body onload="Chkset();" onclick="parent.Sethidden1();">
    ...
    <asp:GridView ID="gvdata" runat="server" AutoGenerateColumns="false" SkinID="statf" OnRowDataBound="gvdata_RowDataBound" EnableViewState="false">
        <Columns>
            ...
            <asp:BoundField HeaderText="返修工单量" DataField="Qty"/>
            <asp:BoundField HeaderText="总工单量" DataField="TotalQty"/>
            <asp:BoundField HeaderText="工单返修率" DataField="Rate" DataFormatString="{0:00%}" HtmlEncode="false"/>
        </Columns>
    </asp:GridView>
    ...
    <asp:HiddenField ID="hfTbTitle" runat="server" Value="所属,编号,技术员,返修工单量,总工单量,工单返修率" />
...
function Chkbom()
{
    $("fbon").innerHTML=parent.DrawInfo("技术员返修汇总表");
}
</script>
