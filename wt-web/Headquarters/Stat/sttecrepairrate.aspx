<%@ page language="C#"  CodeFile="sttecrepairrate.aspx.cs"     autoeventwireup="true" inherits="Headquarters_Stat_StTecRepairRate" theme="Themes" enableEventValidation="false" %>
...
<body onload="Chkset();" onclick="parent.Sethidden1();">
    ...
    <asp:GridView ID="gvdata" runat="server" AutoGenerateColumns="false" SkinID="statf" OnRowDataBound="gvdata_RowDataBound" EnableViewState="false">
        <Columns>
            ...
            <asp:BoundField HeaderText="技术员" DataField="_Name"/>
            <asp:BoundField HeaderText="重复工单量" DataField="Qty"/>
            <asp:BoundField HeaderText="总工单量" DataField="TotalQty"/>
            <asp:BoundField HeaderText="工单重复维修率" DataField="Rate" DataFormatString="{0:00%}" HtmlEncode="false"/>
        </Columns>
    </asp:GridView>
    ...
    <asp:HiddenField ID="hfTbTitle" runat="server" Value="所属,编号,技术员,重复工单量,总工单量,工单重复维修率" />
...
function ChkView()
{
    ...
    parent.ShowDialog(870,513, 'Stat/ServicesDe.aspx?billdate='+escape(billdate)+'&iflag=3&deptid='+deptid+'&startdate='+startdate+'&enddate='+enddate, '明细');
}
function Chkset()
{
    Chkwh();
...
function Chkbom()
{
    $("fbon").innerHTML=parent.DrawInfo("技术员重复维修率");
}
</script>
