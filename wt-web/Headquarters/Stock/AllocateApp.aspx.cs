...
public partial class Headquarters_Stock_AllocateApp : Page, IRequiresSessionState
{
	...
	protected void Page_Load(object sender, EventArgs e)
	{
		...
		if (!base.IsPostBack)
		{
			...
			this.ddlAppBranch.SelectedValue = "1";
	...
	protected void btnSure_Click(object sender, EventArgs e)
	{
		...
		if (dataTable.Rows.Count > 0)
		{
			...
			for (int i = 0; i < dataTable.Rows.Count; i++)
			{
				...
				DataTable dataTable2 = DALCommon.GetGoodsPriceList(3, 1, iGoodsid, iUnitid, 0, -1).Tables[0];
