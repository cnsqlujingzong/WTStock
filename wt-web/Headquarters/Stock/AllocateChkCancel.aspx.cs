...
public partial class Headquarters_Stock_AllocateChkCancel : Page, IRequiresSessionState
{
	private int id;
	...
	protected void btnAdd_Click(object sender, EventArgs e)
	{
		...
		int num = dALAllocate.ChkAllocateCancel(this.id, iOperator, FunLibrary.ChkInput(this.tbName.Text), out empty);
		if (num == 0)
		{
