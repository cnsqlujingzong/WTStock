...
public partial class Headquarters_Stock_BroughtBackMod : Page, IRequiresSessionState
{
	private int id;
	...
	protected void Page_Load(object sender, EventArgs e)
	{
		...
		if (!base.IsPostBack)
		{
			...
			if (num > 0)
			{
				...
				{
					Headquarters_Stock_BroughtBackMod.isLowPricePower = true;
				}
			}
	...
	protected void btnChk_Click(object sender, EventArgs e)
	{
		...
		else
		{
			...
			if (num == 0)
			{
				if (!Headquarters_Stock_BroughtBackMod.isLowPricePower)
				{
					if (!flag)
					{
				...
				dALBroughtBack.ChkBroughtBack(1, this.id, iOperator, out str);
