...
public partial class Headquarters_Stock_GoodsClassAdm : Page, IRequiresSessionState
{
	...
	protected void btnAdds_Click(object sender, EventArgs e)
	{
		...
		else
		{
			...
			string str;
			int num = dALDataClass.Add("GoodsClass", dataClassInfo, out str);
			if (num == 0)
			{
	...
	protected void btnMod_Click(object sender, EventArgs e)
	{
		...
		else
		{
			...
			string str;
			int num = dALDataClass.Update(0, "GoodsClass", dataClassInfo, chkfld, iNewParentid, out str);
			if (num == 0)
			{
	...
	protected void btnDel_Click(object sender, EventArgs e)
	{
		...
		int num = dALDataClass.Delete("GoodsClass", iD, out empty);
		if (num == 0)
		{
			this.hfRecID.Value = "-1";
			this.FillData();
	...
	protected void TreeView1_SelectedNodeChanged(object sender, EventArgs e)
	{
		...
		DALDataClass dALDataClass = new DALDataClass();
		DataClassInfo model = dALDataClass.GetModel("GoodsClass", int.Parse(this.hfRecID.Value));
		if (model != null)
		{
