...
public partial class Headquarters_Stock_InnerOutChk : Page, IRequiresSessionState
{
	...
	protected string strParm()
	{
		...
		if (num > 0 && this.hfSeparate.Value == "1")
		{
			...
			text = string.Concat(new object[]
			{
				...
				int.Parse(this.Session["Session_wtUserID"].ToString()),
				")) "
			});
		}
	...
	protected void btnChk_Click(object sender, EventArgs e)
	{
		...
		int num = dALInnerAllocate.ChkInnerStockOut(1, iTbid, iOperator, out empty);
		this.FillData(this.hfOrderName.Value, this.hfOrder.Value);
		string text = "";
		if (num != 0)
		{
