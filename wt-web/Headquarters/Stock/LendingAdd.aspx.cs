...
public partial class Headquarters_Stock_LendingAdd : Page, IRequiresSessionState
{
	...
	protected int BillAdd(out int iTbid, out string strMsg)
	{
		...
		lendingReturnInfo.iPerson = int.Parse(this.Session["Session_wtUserID"].ToString());
