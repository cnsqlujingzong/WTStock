...
public partial class Headquarters_Stock_SchDisBiling : Page, IRequiresSessionState
{
	...
	protected void btnChk_Click(object sender, EventArgs e)
	{
		...
		int num = dALDisassembling.ChkDis(1, iTbid, iOperator, out empty);
		this.FillData(this.hfOrderName.Value, this.hfOrder.Value);
		string text = "";
		if (num != 0)
		{
	...
	protected void btnChkU_Click(object sender, EventArgs e)
	{
		...
		int iOperator = 0;
		int.TryParse((string)this.Session["Session_wtUserID"], out iOperator);
		int num = dALDisassembling.ChkDisU(1, iTbid, iOperator, out empty);
		this.FillData(this.hfOrderName.Value, this.hfOrder.Value);
		string text = "";
		if (num != 0)
		{
	...
	protected void btnDel_Click(object sender, EventArgs e)
	{
		...
		int iOperator = 0;
		int.TryParse((string)this.Session["Session_wtUserID"], out iOperator);
		int num = dALDisassembling.Delete(1, iTbid, iOperator, out empty);
		this.FillData(this.hfOrderName.Value, this.hfOrder.Value);
		if (num == 0)
		{
			this.hfRecID.Value = "-1";
