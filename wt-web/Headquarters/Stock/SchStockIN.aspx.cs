...
public partial class Headquarters_Stock_SchStockIN : Page, IRequiresSessionState
{
	...
	protected void Page_Load(object sender, EventArgs e)
	{
		...
		if (!base.IsPostBack)
		{
			...
			if (num > 0)
			{
				...
				{
					Headquarters_Stock_SchStockIN.bSeeBasePrice = false;
				}
			}
	...
	protected void btnChk_Click(object sender, EventArgs e)
	{
		...
		int num = dALStockIN.ChkStockIn(1, iTbid, iOperator, out empty);
		this.FillData(this.hfOrderName.Value, this.hfOrder.Value);
		string text = "";
		if (num != 0)
		{
	...
	protected void btnChkU_Click(object sender, EventArgs e)
	{
		...
		int iOperator = 0;
		int.TryParse((string)this.Session["Session_wtUserID"], out iOperator);
		int num = dALStockIN.ChkStockInU(1, iTbid, iOperator, out empty);
		this.FillData(this.hfOrderName.Value, this.hfOrder.Value);
		string text = "";
		if (num != 0)
		{
	...
	protected void btnDel_Click(object sender, EventArgs e)
	{
		...
		int iOperator = 0;
		int.TryParse((string)this.Session["Session_wtUserID"], out iOperator);
		int num = dALStockIN.Delete(1, iTbid, iOperator, out empty);
		this.FillData(this.hfOrderName.Value, this.hfOrder.Value);
		if (num == 0)
		{
			this.hfRecID.Value = "-1";
	...
	protected void GridView2_RowDataBound(object sender, GridViewRowEventArgs e)
	{
		e.Row.Cells[0].Visible = false;
		e.Row.Cells[0].Attributes.Add("style", "padding:auto 5px;");
		if (!Headquarters_Stock_SchStockIN.bSeeBasePrice)
		{
	...
	{
		DataTable dt = DALCommon.GetDataList("ck_stockindetail", "StockName,GoodsNO,_Name,Attr,Spec,ProductBrand,Unit,Qty,Price,Total,SN,MainTenancePeriod,Remark", " BillID=" + this.hfRecID.Value).Tables[0];
