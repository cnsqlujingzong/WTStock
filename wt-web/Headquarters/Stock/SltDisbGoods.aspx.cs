...
// Type: Headquarters_Stock_SltDisbGoods
...
public partial class Headquarters_Stock_SltDisbGoods : Page, IRequiresSessionState
{
    ...
    protected void LoadClass()
    {
        ...
        Headquarters_Stock_SltDisbGoods.BindTreeNode(treeNode, dt, treeNode.Value);
    ...
    public static void BindTreeNode(TreeNode node, DataTable dt, string parentid)
    {
        foreach (DataRow dataRow in dt.Select(" Father=" + parentid))
        {
            ...
            Headquarters_Stock_SltDisbGoods.BindTreeNode(treeNode, dt, dataRow["ID"].ToString());
        }
    }
    ...
    protected void gvgds_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        ...
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            e.Row.Attributes.Add("onclick", "ChkID('" + e.Row.Cells[0].Text + "','" + e.Row.Cells[2].Text.Replace("'", "").Replace("\"", "").Replace("&nbsp;", "") + "');");
