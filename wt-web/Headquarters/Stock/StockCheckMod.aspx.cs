...
public partial class Headquarters_Stock_StockCheckMod : Page, IRequiresSessionState
{
	private int id;
	...
	protected void btnChk_Click(object sender, EventArgs e)
	{
		...
		else
		{
			...
			if (num == 0)
			{
				...
				dALStockCheck.ChkStockCheck(1, this.id, iOperator, out str);
