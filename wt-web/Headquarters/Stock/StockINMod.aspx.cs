...
public partial class Headquarters_Stock_StockINMod : Page, IRequiresSessionState
{
	private int id;
	...
	protected void Page_Load(object sender, EventArgs e)
	{
		...
		if (!base.IsPostBack)
		{
			...
			if (num > 0)
			{
				...
				if (!dALRight.GetRight(num, "ck_r15"))
				{
				...
				{
					Headquarters_Stock_StockINMod.bSeeBasePrice = false;
				}
			}
	...
	protected void gvdata_RowDataBound(object sender, GridViewRowEventArgs e)
	{
		...
		if (!Headquarters_Stock_StockINMod.bSeeBasePrice)
		{
	...
	protected void btnChk_Click(object sender, EventArgs e)
	{
		...
		else
		{
			...
			if (num == 0)
			{
				...
				dALStockIN.ChkStockIn(1, this.id, iOperator, out str);
