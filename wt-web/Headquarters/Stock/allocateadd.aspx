<%@ page language="C#"  CodeFile="allocateadd.aspx.cs"     autoeventwireup="true" inherits="Headquarters_Stock_AllocateAdd" theme="Themes" enableeventvalidation="false" %>
...
<body onload="Chkset();" onclick="parent.Sethidden1();">
    ...
    <ContentTemplate>
        ...
        <tr>
            <td>调出仓库：</td>
            <td style="padding-left:0px;">
                <asp:DropDownList ID="ddlStockOut" runat="server" CssClass="pindl">
                </asp:DropDownList>
            </td>
            <td>调入仓库：</td>
            <td style="padding-left:0px;">
                <asp:DropDownList ID="ddlStockIn" runat="server" CssClass="pindl">
                </asp:DropDownList>
            </td>
            <td align="right">备注：</td>
            <td style="padding-left:0px;"><asp:TextBox ID="tbRemark" runat="server" CssClass="pin" Width="328"></asp:TextBox></td>
        </tr>
     </table>
     </ContentTemplate>
    <Triggers>
        ...
        <div id="fdiv" class="fdiv">
            ...
            <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
                <ContentTemplate>
                    ...
                    <asp:HiddenField ID="hfReg" runat="server" />
...
function Chkbom()
{
    $("fbon").innerHTML=parent.DrawInfo("内部调拨");
}
