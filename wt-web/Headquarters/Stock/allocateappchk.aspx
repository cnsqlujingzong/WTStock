<%@ page language="C#"  CodeFile="allocateappchk.aspx.cs"     autoeventwireup="true" inherits="Headquarters_Stock_AllocateAppChk" theme="Themes" enableEventValidation="false" %>
    ...
    <div class="ftool">
        ...
        <table cellpadding="0" cellspacing="0" class="tb2">
            ...
            <td>
                ...
                <input id="btnChk" type="button" value="审核" class="bt1" onclick="ChkBill();" />
...
function ChkBill()
{
    ChkMod(800, 480,'Stock/AllocateChkConf.aspx','调拨审核');
}
function ChkCancel()
{
    ChkMod(460, 100,'Stock/AllocateChkCancel.aspx','驳回调拨单');
}
function Chkset()
{
    Chkwh2();
...
function Chkbom()
{
    $("fbon").innerHTML=parent.DrawInfo("调拨审核");
}
