<%@ page language="C#"  CodeFile="allocateerror.aspx.cs"     autoeventwireup="true" inherits="Headquarters_Stock_AllocateError" theme="Themes" enableEventValidation="false" %>
    ...
    <div class="ftool">
        ...
        <table cellpadding="0" cellspacing="0" class="tb2">
            ...
            <td>
                ...
                <input id="btnChk" type="button" value="处理" class="bt1" onclick="ChkDo();" />
        ...
        <ContentTemplate>
            <asp:GridView ID="GridView2" runat="server" AutoGenerateColumns="false" SkinID="gv4" OnRowDataBound="GridView2_RowDataBound"  EnableViewState="false" ShowFooter="true" >
                <Columns>
                    ...
                    <asp:BoundField HeaderText="差异数量" DataField="ErrorQty" />
                    ...
                    <asp:BoundField HeaderText="差异金额" DataField="ErrorTotal" />
...
function ChkDo()
{
    ChkMod(460, 100,'Stock/AllocateDo.aspx','调拨差异处理');
}
function Chkset()
{
    Chkwh2();
...
function Chkbom()
{
    $("fbon").innerHTML=parent.DrawInfo("调拨差异处理");
}
