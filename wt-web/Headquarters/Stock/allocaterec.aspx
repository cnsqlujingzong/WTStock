<%@ page language="C#"  CodeFile="allocaterec.aspx.cs"     autoeventwireup="true" inherits="Headquarters_Stock_AllocateRec" theme="Themes" enableEventValidation="false" %>
    ...
    <div class="ftool">
        ...
        <table cellpadding="0" cellspacing="0" class="tb2">
            ...
            <td>
                ...
                <input id="btnRec" type="button" value="发货" class="bt1" onclick="RecBill();" />
                <input id="btnCancel" type="button" value="驳回" class="bt1" onclick="ChkCancel();" />
                <span style="display:none;">
                    <asp:Button ID="btnClr" runat="server" Text="保留选中" CssClass="bt1" UseSubmitBehavior="false" OnClick="btnClr_Click" />
                    <asp:Button ID="btnOrder" runat="server" Text="排序" CssClass="bt1" UseSubmitBehavior="false" OnClick="btnOrder_Click" />
                    <asp:Button ID="btnShow" runat="server" Text="显示ʾ" CssClass="bt1" OnClick="btnShow_Click" UseSubmitBehavior="false"/>
                </span>
            </td>
            </tr>
        </table>
...
function RecBill() {
    ChkMod(800, 480, 'Stock/AllocateRecConf.aspx', '调拨发货');
}
function ChkCancel() {
    ChkMod(460, 100, 'Stock/AllocateRecBack.aspx', '驳回调拨单');
}
...
function Chkbom() {
    $("fbon").innerHTML = parent.DrawInfo("调拨发货");
}
