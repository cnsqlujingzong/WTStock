<%@ page language="C#"  CodeFile="allocatesignconf.aspx.cs"     autoeventwireup="true" inherits="Headquarters_Stock_AllocateSignConf" theme="Themes" enableEventValidation="false" %>
...
<body>
    ...
    <ContentTemplate>
        ...
        <tr>
            ...
            <td style="padding-left:0px;">
                <asp:DropDownList ID="ddlOperator" runat="server" CssClass="pindl" Width="115" Enabled="false">
                </asp:DropDownList>
            </td>
            <td>受理网点：</td>
            <td style="padding-left:0px;">
                <asp:DropDownList ID="ddlBranch" runat="server" CssClass="pindl" Width="115" Enabled="false">
                </asp:DropDownList>
            </td>
        </tr>
        <tr>
            ...
            <td style="padding-left:0px;">
                <asp:DropDownList ID="ddlInStock" runat="server" CssClass="pindl" Width="124">
                </asp:DropDownList>
            </td>
            <td align="right">备注：</td>
            <td colspan="3" style="padding-left:0px;"><asp:TextBox ID="tbRemark" runat="server" CssClass="pin" Width="298"></asp:TextBox></td>
        </tr>
     </table>
     </ContentTemplate>
    <Triggers>
            ...
            <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
                <ContentTemplate>
                    <asp:GridView ID="gvdata" runat="server" AutoGenerateColumns="false" SkinID="gv3" OnRowDataBound="gvdata_RowDataBound">
                        ...
                        <asp:TemplateField HeaderText="验收数量">
                            <ItemTemplate>
                                <asp:TextBox ID="tbQty" runat="server" Text='<%# Eval("RecQty") %>' CssClass="tbstyle" onfocus="select();"></asp:TextBox>
                        ...
                        <asp:TemplateField HeaderText="单价">
                            <ItemTemplate>
                                <asp:TextBox ID="tbPrice" runat="server" Text='<%# Eval("Price") %>' CssClass="tbstyle" ReadOnly="true" onfocus="select();"></asp:TextBox>
                            </ItemTemplate>
                        </asp:TemplateField>
    ...
    <table cellpadding="0" cellspacing="0" class="tb4">
        <tr>
            ...
            签收日期：</td>
            <td style="padding-left:0px;">
                <asp:TextBox ID="tbRecDate" runat="server" CssClass="Wdate" onfocus="WdatePicker()"></asp:TextBox>
            </td>
            <td style="padding-left:10px;">
            现付金额：</td>
            <td style="padding-left:0px;">
...
function EditSN(goodsid,unitid,SN,nums)
{
   ...
   parent.ShowDialog1(400, 300, 'Stock/EditSN.aspx?goodsid='+goodsid+'&unitid='+unitid+'&snvalue='+escape($(SN).value)+'&snid='+SN+'&gdsnum='+escape(gdsnum), '编辑序列号');
}
</script>
