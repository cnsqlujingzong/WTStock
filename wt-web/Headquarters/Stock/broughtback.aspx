<%@ page language="C#"  CodeFile="broughtback.aspx.cs"     autoeventwireup="true" inherits="Headquarters_Stock_BroughtBack" theme="Themes" enableEventValidation="false" %>
                ...
                <ContentTemplate>
                    <asp:GridView ID="gvdata" runat="server" AutoGenerateColumns="false" SkinID="gv3" OnRowDataBound="gvdata_RowDataBound" OnRowDeleting="gvdata_RowDeleting">
                        ...
                        <asp:TemplateField HeaderText="金额">
                            <ItemTemplate>
                                <asp:Label ID="lbAmount" runat="server" Text='<%# Eval("Total","{0:f2}") %>'></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>
