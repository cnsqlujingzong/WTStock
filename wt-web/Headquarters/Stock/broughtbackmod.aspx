<%@ page language="C#"  CodeFile="broughtbackmod.aspx.cs"     autoeventwireup="true" inherits="Headquarters_Stock_BroughtBackMod" theme="Themes" enableEventValidation="false" %>
    ...
    <table cellpadding="0" cellspacing="0" class="tb4">
        <tr>
            ...
            <td>
                ...
                <input id="tbSltGoods" type="button" value="选择产品" class="bt1" onclick="$('hfType').value='2';parent.ShowDialog1(800, 520, 'Stock/SltGoods.aspx', '选择产品');" />
            </td>
...
function ChkOperType()
{
    if($("ddlReason").value=="1")
        $("lbOperator").innerHTML="领";
    else
        $("lbOperator").innerHTML="退";
}
...
function ChkGD(bid)
{
    parent.ShowDialog3(860,444, 'Services/SerView.aspx?ids='+bid, '服务单');
}
</script>
