<%@ page language="C#"  CodeFile="goodsclassadm.aspx.cs"     autoeventwireup="true" inherits="Headquarters_Stock_GoodsClassAdm" enableEventValidation="false" %>
    ...
    <ContentTemplate>
        ...
        <div class="sdiv">
            <table cellpadding="0" cellspacing="0" class="tb3">
                <tr>
                    ...
                    <td>
                        <asp:DropDownList ID="ddlFather" runat="server" CssClass="pindl">
                        </asp:DropDownList>
                    </td>
                    <td>
                        分类名：
        ...
        <tr>
            <td>
                ...
                <asp:Button ID="btnDel" runat="server" ToolTip="删除" Text="删除"  CssClass="bt1" OnClientClick="if(ChkDel('产品类别')==false)return false;" OnClick="btnDel_Click" UseSubmitBehavior="false" />
            </td>
            <td align="right">
