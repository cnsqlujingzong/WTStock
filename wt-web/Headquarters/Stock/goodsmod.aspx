<%@ page language="C#"  CodeFile="goodsmod.aspx.cs"     autoeventwireup="true" inherits="Headquarters_Stock_GoodsMod" theme="Themes" enableEventValidation="false" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div id="divinfo1" class="divinfo" style="height:360px;overflow:auto;">
            ...
            <tr>
                ...
                <table cellpadding="0" cellspacing="0" class="tb3">
                    ...
                    <tr>
                        ...
                        <td style="padding-left:0px;">
                            <asp:TextBox ID="tbBrand" runat="server" CssClass="pin" AutoCompleteType="Disabled" onmousedown="getSearchResult1('../Customer/SchBrand.aspx','tbBrand','hfBrand','1','',event);" onkeyup="getSearchResult1('../Customer/SchBrand.aspx','tbBrand','hfBrand','1','',event);" ></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td align="right">PCB ：</td>
                        <td style="padding-left:0px;"><asp:TextBox ID="txt_pcb" runat="server" CssClass="pin" old="" ></asp:TextBox></td>
                  
                          </tr>
                        <tr>
                        <td align="right">最低销售价：</td>
                        <td style="padding-left:0px;"><asp:TextBox ID="tbPriceLow" runat="server" CssClass="pin" old="" onblur="ChkMoney(this);"></asp:TextBox></td>
                        <td align="right">
                    ...
                    <tr>
                        ...
                        <td style="padding-left:0px;">
                            <asp:TextBox ID="tbProvider" runat="server" CssClass="pin" AutoCompleteType="Disabled" onmousedown="getSearchResult1('../Customer/SchSuppLierList.aspx','tbProvider','hfSupplier','1','',event);" onkeyup="getSearchResult1('../Customer/SchSuppLierList.aspx','tbProvider','hfSupplier','1','',event);" ></asp:TextBox>
                        </td>
                    ...
                    <tr>
                        ...
                        <td colspan="3" style="padding-left:0px;">
                             <asp:TextBox ID="tbRemark" runat="server" CssClass="pin" Width="341" TextMode="MultiLine" ></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td align="right"></td>
                    ...
                    <table cellpadding="0" cellspacing="0" class="tb2">
                        <tr>
                            ...
                            <td style="padding-left:5px;">
                                <input id="btnSltGds" type="button" value="选择产品" class="bt1" onclick="parent.ShowDialog1(800, 520, 'Stock/SltGoods.aspx?id='+<%=Str_ID %>, '选择产品');"/>
                            </td>
                        </tr>
                    </table>
                </div>
