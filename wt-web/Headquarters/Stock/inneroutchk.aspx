<%@ page language="C#"  CodeFile="inneroutchk.aspx.cs"     autoeventwireup="true" inherits="Headquarters_Stock_InnerOutChk" theme="Themes" enableEventValidation="false" %>
...
<body onload="Chkset();" onclick="parent.Sethidden1();">
    ...
    <div class="ftool">
        ...
        <table cellpadding="0" cellspacing="0" class="tb2">
            ...
            <td>
                ...
                <asp:Button ID="btnChk" runat="server" Text="审核" CssClass="bt1" UseSubmitBehavior="false" OnClientClick="if(ChkConf('审核该[内部调拨单]')==false) return false;" OnClick="btnChk_Click"/>
    ...
    <asp:HiddenField ID="hfSeparate" runat="server" />
    </ContentTemplate>
    <Triggers>
