<%@ page language="C#"  CodeFile="inputstockcheck.aspx.cs"     autoeventwireup="true" inherits="Headquarters_Stock_InputStockCheck" enableeventvalidation="false" %>
...
<%--                  <input id="Button1" type="button" value="确定" class="bt1" onclick="ChkSltList();"/>--%>
