<%@ page language="C#"  CodeFile="regulate.aspx.cs"     autoeventwireup="true" inherits="Headquarters_Stock_Regulate" theme="Themes" enableEventValidation="false" %>
...
<body onload="Chkset();" onclick="parent.Sethidden1();">
    ...
    <ContentTemplate>
        ...
        <tr>
            <td class="sysred" align="right">仓库：</td>
            <td style="padding-left:0px;">
...
function Chkbom()
{
    $("fbon").innerHTML=parent.DrawInfo("调价开单");
}
</script>
