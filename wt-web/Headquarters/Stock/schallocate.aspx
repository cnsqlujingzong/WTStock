<%@ page language="C#"  CodeFile="schallocate.aspx.cs"     autoeventwireup="true" inherits="Headquarters_Stock_SchAllocate" theme="Themes" enableEventValidation="false" %>
    ...
    <div class="ftool">
        ...
        <table cellpadding="0" cellspacing="0" class="tb2">
            ...
            <td>
                ...
                <input id="btnMod" runat="server" type="button" value="查看修改" class="bt1" onclick="ModBill();" />
                <asp:Button ID="btnChk" runat="server" Text="递交审核" CssClass="bt1" UseSubmitBehavior="false" OnClientClick="if(ChkConf('递交审核该[调拨单]')==false) return false;" OnClick="btnChk_Click"/>
                <asp:Button ID="btnDel" runat="server" Text="删除" CssClass="bt1" UseSubmitBehavior="false" OnClientClick="if(ChkDel('调拨单')==false) return false;" OnClick="btnDel_Click"/>
        ...
        <ContentTemplate>
            <asp:GridView ID="GridView2" runat="server" AutoGenerateColumns="false" SkinID="gv4" OnRowDataBound="GridView2_RowDataBound"  EnableViewState="false" ShowFooter="true" >
                <Columns>
                    ...
                    <asp:BoundField HeaderText="签收数量" DataField="RecQty" />
                    ...
                    <asp:BoundField HeaderText="签收金额" DataField="Totalr" />
        ...
        <table cellpadding="0" cellspacing="0" width="100%">
            <tr>
                ...
                <td>
                    ...
                    <span class="sblue">待发货</span>
                    <span class="syellow">待签收</span>
                    <span class="sgreen">已结束</span>
                    <span class="sgay">被驳回</span>
                </td>
            </tr>
        </table>
    </div>
...
function ModBill()
{
    ChkMod(800, 480,'Stock/AllocateMod.aspx','调拨单');
}
...
function Chkbom()
{
    $("fbon").innerHTML=parent.DrawInfo("网点调拨单查询");
}
