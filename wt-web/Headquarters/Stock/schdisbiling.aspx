<%@ page language="C#"  CodeFile="schdisbiling.aspx.cs"     autoeventwireup="true" inherits="Headquarters_Stock_SchDisBiling" theme="Themes" enableEventValidation="false" %>
    ...
    <div class="ftool">
        ...
        <table cellpadding="0" cellspacing="0" class="tb2">
            ...
            <td>
                ...
                <asp:Button ID="btnChk" runat="server" Text="审核" CssClass="bt1" UseSubmitBehavior="false" OnClientClick="if(ChkConf('审核该[拆装单]')==false) return false;" OnClick="btnChk_Click"/>
                <asp:Button ID="btnChkU" runat="server" Text="反审核" CssClass="bt1" UseSubmitBehavior="false" OnClientClick="if(ChkConf('反审核该[拆装单]')==false) return false;" OnClick="btnChkU_Click"/>
                <asp:Button ID="btnDel" runat="server" Text="删除" CssClass="bt1" UseSubmitBehavior="false" OnClientClick="if(ChkDel('拆装单')==false) return false;" OnClick="btnDel_Click"/>
        ...
        <div class="ftoolright">
            <table cellpadding="0" cellspacing="0" class="tb2">
                <tr>
                <td>
                <input id="btnPrint" runat="server" type="button" value="打印" class="iprint" onclick="ChkPrint('CZD');" />
                </td>
                ...
                <asp:DropDownList ID="ddlKey" runat="server" CssClass="pindl" onchange="document.getElementById('tbCon').focus();">
                    ...
                    <asp:ListItem Value="2">按单据类别查询</asp:ListItem>
                    <asp:ListItem Value="3">按制单日期查询</asp:ListItem>
                    <asp:ListItem Value="4">按制单人查询</asp:ListItem>
                    <asp:ListItem Value="5">按经办人查询</asp:ListItem>
                    <asp:ListItem Value="6">按仓库查询</asp:ListItem>
                    <asp:ListItem Value="7">按产品编号查询</asp:ListItem>
                    <asp:ListItem Value="8">按产品名称查询</asp:ListItem>
                    <asp:ListItem Value="9">按产品规格查询</asp:ListItem>
                    <asp:ListItem Value="10">按产品品牌查询</asp:ListItem>
                    <asp:ListItem Value="11">按审核日期查询</asp:ListItem>
                    <asp:ListItem Value="12">按审核人查询</asp:ListItem>
    ...
    <div id="cnbut">
        <div class="ftool2">
            <div id="mytabs" style="padding-left:2px;">
                ...
                <span id="tabs1" class="tabs_active" >拆装明细</span>
...
function ModBill()
{
    ChkMod(800, 480,'Stock/DisBilingMod.aspx','拆装单');
}
...
function Chkbom()
{
    $("fbon").innerHTML=parent.DrawInfo("拆装单查询");
}
