<%@ page language="C#"  CodeFile="schinnerallocate.aspx.cs"     autoeventwireup="true" inherits="Headquarters_Stock_SchInnerAllocate" theme="Themes" enableEventValidation="false" %>
...
<body onload="Chkset();" onclick="parent.Sethidden1();">
    ...
    <div class="ftool">
        ...
        <table cellpadding="0" cellspacing="0" class="tb2">
            ...
            <td>
                ...
                <asp:Button ID="btnChkU" runat="server" Text="驳回" CssClass="bt1" UseSubmitBehavior="false" OnClientClick="if(ChkConf('驳回该[内部调拨单]')==false) return false;" OnClick="btnChkU_Click"/>
                <asp:Button ID="btnDel" runat="server" Text="删除" CssClass="bt1" UseSubmitBehavior="false" OnClientClick="if(ChkDel('内部调拨单')==false) return false;" OnClick="btnDel_Click"/>
        ...
        <div class="ftoolright">
            <table cellpadding="0" cellspacing="0" class="tb2">
                <tr>
                <td>
                <input id="btnPrint" runat="server" type="button" value="打印" class="iprint" onclick="ChkPrint('NBDBD');" />
                </td>
                ...
                <asp:DropDownList ID="ddlKey" runat="server" CssClass="pindl" onchange="document.getElementById('tbCon').focus();">
                    ...
                    <asp:ListItem Value="5">按调出仓库查询</asp:ListItem>
                    <asp:ListItem Value="6">按调入仓库查询</asp:ListItem>
    ...
    <asp:GridView ID="gvdata" runat="server" AutoGenerateColumns="false" SkinID="gv1" OnRowDataBound="gvdata_RowDataBound" EnableViewState="false">
        <Columns>
            ...
            <asp:BoundField HeaderText="调出仓库" DataField="StockOut" />
            <asp:BoundField HeaderText="调入仓库" DataField="StockIn" />
        ...
        <table cellpadding="0" cellspacing="0" width="100%">
            <tr>
                ...
                <td>
                    ...
                    <span class="sblue">已出库审核</span>
                    <span class="sgreen">已入库审核</span>
                </td>
            </tr>
        </table>
    </div>
...
{
    ClrID(id);
    $("hfStatus").value=$(id).cells[1].innerHTML;
    $("btnShow").click();
}

function ModBill()
{
    ChkMod(800, 480,'Stock/IAllocateMod.aspx','内部调拨单');
}
...
function Chkbom()
{
    $("fbon").innerHTML=parent.DrawInfo("内部调拨单查询");
}
