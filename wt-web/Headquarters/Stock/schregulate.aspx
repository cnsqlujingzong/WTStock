<%@ page language="C#"  CodeFile="schregulate.aspx.cs"     autoeventwireup="true" inherits="Headquarters_Stock_SchRegulate" theme="Themes" enableEventValidation="false" %>
    ...
    <div class="ftool">
        ...
        <table cellpadding="0" cellspacing="0" class="tb2">
            ...
            <td>
                ...
                <asp:Button ID="btnChk" runat="server" Text="审核" CssClass="bt1" UseSubmitBehavior="false" OnClientClick="if(ChkConf('审核该[调价单]')==false) return false;" OnClick="btnChk_Click"/>
                <asp:Button ID="btnChkU" runat="server" Text="反审核" CssClass="bt1" UseSubmitBehavior="false" OnClientClick="if(ChkConf('反审核该[调价单]')==false) return false;" OnClick="btnChkU_Click"/>
                <asp:Button ID="btnDel" runat="server" Text="删除" CssClass="bt1" UseSubmitBehavior="false" OnClientClick="if(ChkDel('调价单')==false) return false;" OnClick="btnDel_Click"/>
        ...
        <div class="ftoolright">
            <table cellpadding="0" cellspacing="0" class="tb2">
                <tr>
                <td>
                <input id="btnPrint" runat="server" type="button" value="打印" class="iprint" onclick="ChkPrint('TJD');" />
                </td>
    ...
    <div id="cnbut">
        <div class="ftool2">
            <div id="mytabs" style="padding-left:2px;">
                ...
                <span id="tabs1" class="tabs_active" >调价明细</span>
        ...
        <ContentTemplate>
            <asp:GridView ID="GridView2" runat="server" AutoGenerateColumns="false" SkinID="gv4" OnRowDataBound="GridView2_RowDataBound"  EnableViewState="false" >
                <Columns>
                    ...
                    <asp:BoundField HeaderText="调整前金额" DataField="Total" />
                    <asp:BoundField HeaderText="调整后单价" DataField="RegulatePrice" />
                    <asp:BoundField HeaderText="调整后金额" DataField="RegulateTotal" />
                    <asp:BoundField HeaderText="备注"  DataField="Remark"/>
                </Columns>
            </asp:GridView>
...
function ModBill()
{
    ChkMod(800, 480,'Stock/RegulateMod.aspx','调价单');
}
...
function Chkbom()
{
    $("fbon").innerHTML=parent.DrawInfo("调价单查询");
}
