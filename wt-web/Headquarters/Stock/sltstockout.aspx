<%@ page language="C#"  CodeFile="sltstockout.aspx.cs"     autoeventwireup="true" inherits="Headquarters_Stock_SltStockOut" theme="Themes" enableEventValidation="false" %>
...
<body>
   ...
   <div class="ftool">
        ...
        <table cellpadding="0" cellspacing="0" class="tb2">
                ...
                <td>
                   <asp:DropDownList ID="ddlKey" runat="server" CssClass="pindl" onchange="document.getElementById('tbCon').focus();">
                    <asp:ListItem Value="d">今日业务</asp:ListItem>
    ...
    <div id="cndiv" style="height:460px; width:800px;">
