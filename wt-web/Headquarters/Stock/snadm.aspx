<%@ page language="C#"  CodeFile="snadm.aspx.cs"     autoeventwireup="true" inherits="Headquarters_Stock_SNAdm" theme="Themes" enableEventValidation="false" %>
...
function Goods(id)
{
    parent.ShowDialog(620, 425,'Stock/GoodsMod.aspx?ids='+id,'修改产品');
}
function StockIN(id)
{
...
{
    parent.ShowDialog(800, 480,'Purchase/PurchaseMod.aspx?ids='+id,title);
}
