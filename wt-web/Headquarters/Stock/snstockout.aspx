<%@ page language="C#"  CodeFile="snstockout.aspx.cs"     autoeventwireup="true" inherits="Headquarters_Stock_SNStockOUT" theme="Themes" enableEventValidation="false" %>
...
<body>
    ...
    <div class="ftool2">
        <div id="mytabs" style="padding-left:2px;">
            ...
            <span class="tabs_active" >出库明细</span>
        ...
        <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
          <ContentTemplate>
            <asp:GridView ID="gvdata" runat="server" AutoGenerateColumns="false" SkinID="gv3" OnRowDataBound="gvdata_RowDataBound" OnRowDeleting="gvdata_RowDeleting">
                ...
                <asp:BoundField HeaderText="出库单号" DataField="BillID" />
    ...
    <div class="ftool2">
        <div id="mytabs2" style="padding-left:2px;">
            <span class="tabs_activeleft"></span>
            <span class="tabs_active" >出库序列号</span>
            <span class="tabs_activeright"></span>
        </div>
    </div>
    ...
    <table cellpadding="0" cellspacing="0" class="tb2" width="100%">
        <tr>
            <td align="right" style="padding-right:7px;">
                ...
                <input id="tbSlt" type="button" value="出库明细" class="bt1" onclick="parent.ShowDialog1(800, 500, 'Stock/SltStockOut.aspx', '选择出库明细');" />
