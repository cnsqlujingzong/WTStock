<%@ page language="C#"  CodeFile="stockout.aspx.cs"     autoeventwireup="true" inherits="Headquarters_Stock_StockOut" theme="Themes" enableEventValidation="false" %>
...
function Chkbom()
{
    $("fbon").innerHTML=parent.DrawInfo("其他出库");
}
</script>
