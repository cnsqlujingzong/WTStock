<%@ page language="C#"  CodeFile="stockradm.aspx.cs"     autoeventwireup="true" inherits="Headquarters_Stock_StockrAdm" theme="Themes" enableEventValidation="false" %>
...
<body onload="Chkset();" onclick="parent.Sethidden1();">
    ...
    <asp:GridView ID="gvgds" runat="server" AutoGenerateColumns="false" SkinID="gv1" OnRowDataBound="gvgds_RowDataBound" EnableViewState="false">
        <Columns>
            ...
            <asp:BoundField HeaderText="总库存" DataField="Stockr" />
...
function ShowGds()
{
    ChkMod(620, 425,'Stock/GoodsMod.aspx','修改产品');
}
function Chkset()
{
    Chkwh4();
...
function Chkbom()
{
    $("fbon").innerHTML=parent.DrawInfo("废品库存");
}
</script>
