<%@ page language="C#"  CodeFile="unitmod.aspx.cs"     autoeventwireup="true" inherits="Headquarters_Stock_UnitMod" enableEventValidation="false" %>
...
function ChkAdd(str)
{
    ...
    parent.iframeDialog.$("btnModUnit").click();
    parent.CloseDialog1();
}
