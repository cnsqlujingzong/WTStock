...
public partial class Headquarters_System_CusBirthDay : Page, IRequiresSessionState
{
	...
	{
		string text = " DeptID=1 and  month(Birthday)=month(getdate()) and day(Birthday)=day(getdate()) ";
