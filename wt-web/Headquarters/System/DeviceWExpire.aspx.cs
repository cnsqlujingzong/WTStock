...
public partial class Headquarters_System_DeviceWExpire : Page, IRequiresSessionState
{
	...
	{
		string text = " DeptID=1 and Warranty='厂家保修期' and datediff(d,getdate(),WarrantyEnd)<0 ";
