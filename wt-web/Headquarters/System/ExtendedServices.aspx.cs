...
public partial class Headquarters_System_ExtendedServices : Page, IRequiresSessionState
{
	...
	protected void FillData(string sortExpression, string direction)
	{
		...
		text += " and (curStatus='待处理' or curStatus='处理中') and ((yPoint>bPoint and bPoint>0)) ";
