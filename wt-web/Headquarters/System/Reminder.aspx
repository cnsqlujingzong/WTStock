<%@ page language="C#"  CodeFile="Reminder.aspx.cs"     autoeventwireup="true" inherits="Headquarters_System_Reminder" theme="Themes" enableEventValidation="false" %>
...
<body>
   ...
   <div class="ftool">
        ...
        <table cellpadding="0" cellspacing="0" class="tb2">
                ...
                <td>
                   <asp:DropDownList ID="ddlKey" runat="server" CssClass="pindl" onchange="document.getElementById('tbCon').focus();">
                        ...
                        <asp:ListItem Value="-1" Selected="True">查询全部</asp:ListItem>
                    </asp:DropDownList>
            </td>
            <td>
    ...
    <div id="cndiv" style="height:480px; width:920px;overflow-x:scroll;overflow-y:auto;">
