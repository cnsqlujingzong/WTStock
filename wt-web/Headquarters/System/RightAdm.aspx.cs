...
public partial class Headquarters_System_RightAdm : Page, IRequiresSessionState
{
	...
	{
		string text = " DeptID=1 and bDefault=0 ";
	...
	protected void btnDel_Click(object sender, EventArgs e)
	{
		...
		int num = dALRight.Delete(1, iTbid, iOperator, out empty);
		this.FillData(this.hfOrderName.Value, this.hfOrder.Value);
		if (num == 0)
		{
			this.hfRecID.Value = "-1";
