...
public partial class Headquarters_System_StaffBirthDay : Page, IRequiresSessionState
{
	...
	{
		string text = " DeptID=1 and Status='在职' and month(BirthDate)=month(getdate()) and day(BirthDate)=day(getdate())";
