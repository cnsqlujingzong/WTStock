<%@ page language="C#"  CodeFile="expiregoods.aspx.cs"     autoeventwireup="true" inherits="Headquarters_System_ExpireGoods" theme="Themes" enableEventValidation="false" %>
        ...
        <table cellpadding="0" cellspacing="0" class="tb2">
                ...
                <td>
                    <asp:DropDownList ID="ddlWaring" runat="server">
                        ...
                        <asp:ListItem Value="5">5天内到期</asp:ListItem>
                        <asp:ListItem Value="7">7天内到期</asp:ListItem>
                        <asp:ListItem Value="14">14天内到期</asp:ListItem>
