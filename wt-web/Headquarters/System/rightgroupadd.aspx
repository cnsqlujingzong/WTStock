<%@ page language="C#"  CodeFile="rightgroupadd.aspx.cs"     autoeventwireup="true" inherits="Headquarters_System_RightGroupAdd" enableEventValidation="false" %>
...
<body>
    ...
    <div id="div1" class="divinfo" style="height:406px;">
        <table cellpadding="0" cellspacing="0" class="tb6">
            ...
            <tr>
                <td ><asp:CheckBox ID="cb_ck_all" runat="server" onclick="Chkcb(this,'ck_r',83);" /> <span style="color:#000000">全选</span></td>
            </tr>
        </table>
    </div>
    </div>
    ...
    <table cellpadding="0" cellspacing="0" class="tb6">
            ...
            <tr>
                <td colspan="7"><asp:CheckBox ID="cb_xs_all" runat="server" onclick="Chkcb(this,'xs_r',19);"  /> <span style="color:#000000">全选</span></td>
            </tr>  
     </table>
     </fieldset>
    </div>
    ...
    <div id="div4" class="divinfo" style="height:406px;">
        <table cellpadding="0" cellspacing="0" class="tb6">
            ...
            <tr>
                ...
                <tr>
                    <td><asp:CheckBox ID="gd_r19" runat="server" /> 驳回服务单</td>
            ...
            <tr>
                <td colspan="7"><asp:CheckBox ID="cb_gd_all" runat="server" onclick="Chkcb(this,'gd_r',27);"  /> <span style="color:#000000">全选</span></td>
            </tr>  
     </table>
    ...
    <div id="div14" class="divinfo" style="height:406px;">
        <table cellpadding="0" cellspacing="0" class="tb6">
            ...
            <tr>
                ...
                <td colspan="2"><asp:CheckBox ID="bg_r30" runat="server"/> 员工工作汇总</td>
            </tr>
            <tr>
                <td colspan="7"><asp:CheckBox ID="cb_bg_all" runat="server" onclick="Chkcb(this,'bg_r',30);"  /> <span style="color:#000000">全选</span></td>
            </tr>  
        </table> 
    ...
    <div id="div20" class="divinfo" style="height:406px;">
        <table cellpadding="0" cellspacing="0" class="tb6">
            ...
            <tr>
                <td colspan="6"><asp:CheckBox ID="cb_jc_all" runat="server" onclick="Chkcb(this,'jc_r',36);"  /> <span style="color:#000000">全选</span></td>
            </tr>  
        </table>
