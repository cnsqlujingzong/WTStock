<%@ page language="C#"  CodeFile="stockb.aspx.cs"     autoeventwireup="true" inherits="Headquarters_System_StockB" theme="Themes" enableEventValidation="false" %>
...
<body>
   ...
   <div class="ftool">
        ...
        <table cellpadding="0" cellspacing="0" class="tb2">
                ...
                <td>
                   <asp:DropDownList ID="ddlKey" runat="server" CssClass="pindl" onchange="document.getElementById('tbCon').focus();">
                        ...
                        <asp:ListItem Value="10">按供应商查询</asp:ListItem>
            ...
            <td>
                ...
                <td>
                <input id="btnSchsH" type="button" value="高级查询" class="bsch" onclick="parent.ShowDialog1(460,205, 'System/SchHStock.aspx', '高级查询');" />
                </td>
                <td>
                    <input type="button" value="采购开单" class="bt1" onclick="Purchasing();" />
                </td>
             </tr>
            </table>   
        </div>
        <div class="ftoolright">
            ...
            <td>
                <span style="display:none;">
                    ...
                    <asp:Button ID="btnSchH" runat="server" Text="高级查询" CssClass="bt1" UseSubmitBehavior="false" OnClick="btnSchH_Click" />
                </span>
            </td>
    ...
    <asp:GridView ID="gvdata" runat="server" AutoGenerateColumns="false" SkinID="gv1" OnRowDataBound="gvdata_RowDataBound" EnableViewState="false">
        <Columns>
            ...
            <asp:TemplateField HeaderText="全选">
                ...
                <HeaderTemplate>
                    <input id="cball" type="checkbox" value="全选" class="cb1" onclick="SltAllValue();" title="全选/取消全选"/>
                </HeaderTemplate>
            </asp:TemplateField>
    ...
    <table cellpadding="0" cellspacing="0" class="pages">
        ...
        <asp:HiddenField ID="hfSchH" runat="server" />
...
function Purchasing()
{
    var value = document.getElementById("hfcbID").value;
    if(value=="")
    {
        window.alert("请勾选记录！");
        return false;
    }
    parent.parent.SetFrame('cgkd',"Purchase/PurchaseAdd.aspx?f="+value, '采购开单');
