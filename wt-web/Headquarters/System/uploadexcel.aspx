<%@ page language="C#"  CodeFile="uploadexcel.aspx.cs"     autoeventwireup="true" inherits="Headquarters_System_UpLoadExcel" enableEventValidation="false" %>
...
<body>
    ...
    <tr>
        <td>            
            ...
            <span style="color:#666;">(*点浏览选择要上传的Excel文件，再点上传)</span> 
        </td>
        <td align="right">
            <input id="btnCls" type="button" value="关闭" class="bt1" onclick="parent.CloseDialog<%=StrF1 %>();"/> 
        </td>
    </tr>
    </table>
    </div>
...
document.onkeydown=function(){if(event.keyCode==27){try{parent.CloseDialog<%=StrF1 %>();}catch(e){}}}
