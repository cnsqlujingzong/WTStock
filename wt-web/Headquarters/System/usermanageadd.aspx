<%@ page language="C#"  CodeFile="usermanageadd.aspx.cs"     autoeventwireup="true" inherits="Headquarters_System_UserManageAdd" enableEventValidation="false" %>
        ...
        <div id="sa" style="width:686px;">
            ...
            <ContentTemplate>
                ...
                <tr>
                    ...
                    <td><span class="si2">(密码长度在1到20位之间)</span></td>
                </tr>
                <tr>
            ...
            <tr>
                <td style="padding-left:5px;color:#0000ff">
                    ...
                    <asp:Label ID="lbInfo" runat="server" Visible="false" style=" background:#dd0000; color:#ffffff; padding:2px 15px;"></asp:Label><asp:HiddenField ID="hfOverFlag" runat="server" Value="-1"></asp:HiddenField>
                </td>
                <td align="right">
...
function ChkAdd()
{
    ...
    {
        alert("您的系统中用户数已达到上限，继续新建用户系统会被锁定。");
        return false;
    }
}
