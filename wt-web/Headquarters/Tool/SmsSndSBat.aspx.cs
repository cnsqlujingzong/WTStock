...
public partial class Headquarters_Tool_SmsSndSBat : Page, IRequiresSessionState
{
	...
	protected void FillData()
	{
		...
		DataSet list_HL = DALCommon.GetList_HL(1, "ks_splmobilelist", "", this.pageSize, this.jsPager.CurrentPageIndex, text, "id", out num);
	...
	protected void btnSnd_Click(object sender, EventArgs e)
	{
		...
		DataTable dataTable = DALCommon.GetDataList("ks_splmobilelist", "lid,t,Tel", text).Tables[0];
