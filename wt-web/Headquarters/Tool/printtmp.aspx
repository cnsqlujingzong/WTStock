<%@ page language="C#"  CodeFile="printtmp.aspx.cs"     autoeventwireup="true" inherits="Headquarters_Tool_Printtmp" theme="Themes" enableEventValidation="false" %>
...
<body>
    ...
    <tr>
        <td>
            ...
            <input id="Button1" type="button" value="上传" class="bt1" onclick="ChkTmp('Upload');"/>
...
function ChkTmp(act)
{
    ...
    window.open("../Print/interface_print.aspx?type="+act+"&obj="+arr[0]+"&a="+num,"","width=1024,height=768,toolbar=no,left="+w+",top=20,location=no,directories=yes,status=yes,menubar=yes,resizable=yes,scrollbars=yes");
}
