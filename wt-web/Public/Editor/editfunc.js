...
function setMode(bStatus){
	...
	if(bStatus){
		...
		if(gIsIE){
			HtmlEditor.style.height = "246px";
			divEditor.style.height = "246px";
		}else{
			HtmlEditor.style.height = "243px";
			divEditor.style.height = "243px";
		}
...
function createLink() {
	var sURL=window.prompt("输入链接例如 ( http://www.differsoft.com/):", "http://");
