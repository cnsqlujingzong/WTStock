<%@ page language="C#"  CodeFile="uploadacc.aspx.cs"       autoeventwireup="true" inherits="Public_Editor_UploadAcc" enableEventValidation="false" %>
...
<body>
    ...
    <tr>
        <td>            
            ...
            <span style="color:#666;">(*点浏览选择要上传的附件，再点上传，建议文件不要超过100M)</span> 
        </td>
        <td align="right">
