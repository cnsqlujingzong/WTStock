<%@ WebHandler Language="C#" Class="PicRepairDis" %>
...
public class PicRepairDis : IHttpHandler, IRequiresSessionState
{
    public void ProcessRequest(HttpContext context)
    {
        ...
        int iflag = 4;
        int.TryParse(context.Request["iflag"], out iflag);
        string strtype = "按品牌";
        if (iflag == 5)
            strtype = "按类别";
        ...
        //标题
        g.DrawString("修品分布图-" + strtype, new Font("黑体", 14, FontStyle.Regular), new SolidBrush(Color.Black), new PointF(280, 15));
