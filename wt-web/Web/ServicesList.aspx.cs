...
public partial class Web_ServicesList : Page, IRequiresSessionState
{
	...
	protected void DisplayData()
	{
		...
		this.GridView1.DataSource = DALCommon.GetList_HL(1, "fw_services", "", this.pageSize, this.jsPager.CurrentPageIndex, strCondition, "ID Desc", out num);
	...
	protected void GridView1_RowDataBound(object sender, GridViewRowEventArgs e)
	{
		...
		if (e.Row.RowType == DataControlRowType.DataRow)
		{
			...
			e.Row.Cells[11].Text = "<a href=\"SerView.aspx?id=" + e.Row.Cells[1].Text + "\" title=\"查看详细信息\">查看</a>";
