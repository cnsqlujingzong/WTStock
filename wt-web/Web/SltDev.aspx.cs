...
public partial class Web_SltDev : Page, IRequiresSessionState
{
	...
	protected void GridView1_RowDataBound(object sender, GridViewRowEventArgs e)
	{
		...
		if (e.Row.RowType == DataControlRowType.DataRow)
		{
			...
			e.Row.Attributes.Add("onclick", string.Concat(new string[]
			{
				...
				e.Row.Cells[0].Text,
				"');ChkValue('",
				e.Row.Cells[2].Text.Replace("&nbsp;", ""),
				"','",
				e.Row.Cells[3].Text.Replace("&nbsp;", ""),
				"','",
				e.Row.Cells[4].Text.Replace("&nbsp;", ""),
				"','",
				e.Row.Cells[5].Text.Replace("&nbsp;", ""),
				"','",
				e.Row.Cells[6].Text.Replace("&nbsp;", ""),
				"','",
				e.Row.Cells[9].Text.Replace("&nbsp;", ""),
				"','",
				e.Row.Cells[10].Text.Replace("&nbsp;", ""),
				"','",
				e.Row.Cells[11].Text.Replace("&nbsp;", ""),
				"','",
				e.Row.Cells[12].Text.Replace("&nbsp;", ""),
				"','",
				e.Row.Cells[8].Text.Replace("&nbsp;", ""),
				"','",
