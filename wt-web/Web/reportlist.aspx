<%@ page language="C#"  CodeFile="reportlist.aspx.cs"     autoeventwireup="true" inherits="Web_ReportList" enableEventValidation="false" %>
...
<body>
    ...
    <div class="item"><span style="padding-right:30px;">我的报修单</span><span id="span_info" style="display:none;"></span></div>
    <div class="tool">
            ...
            <tr>
                <td>
                    <asp:DropDownList ID="ddlkey" runat="server" CssClass="slt1">
                        ...
                        <asp:ListItem Value="Status">=按当前状态=</asp:ListItem>
    ...
    <div class="list" id="list">
        ...
        <div id="d_empty" runat="server"><p class="p1" runat="server" id="p1">无相应的报修单!</p></div>
