<%@ page language="C#"  CodeFile="schlease.aspx.cs"     autoeventwireup="true" inherits="Web_SchLease" theme="Themes" enableEventValidation="false" %>
...
<body onload="Chkset();">
    ...
    <div class="ftool">
        ...
        <table cellpadding="0" cellspacing="0" class="tb2">
            ...
            <td>
                ...
                <asp:Button ID="btnDel" runat="server" Text="删除" CssClass="bt1" UseSubmitBehavior="false" OnClientClick="if(ChkDel('业务单')==false)return false;" OnClick="btnDel_Click"/>
        ...
        <div class="ftoolright">
            <table cellpadding="0" cellspacing="0" class="tb2">
                <tr>
                <td>
                <input id="btnPrint" style="display:none;" runat="server" type="button" value="打印" class="iprint" onclick="ChkPrint('ZLD');" />
                </td>
                ...
                <asp:DropDownList ID="ddlKey" runat="server" CssClass="pindl" onchange="document.getElementById('tbCon').focus();">
                    ...
                    <asp:ListItem Value="14">按业务状态查询</asp:ListItem>
            ...
            <td>
                <input id="btnSchsH" style="display:none;" type="button" value="高级查询" class="bsch" onclick="parent.ShowDialog(460,260, 'Lease/LeaseCd.aspx', '高级查询');" />
            </td>
            </tr>
            </table>   
        </div>
    ...
    <asp:GridView ID="gvdata" runat="server" AutoGenerateColumns="false" SkinID="gv1" OnRowDataBound="gvdata_RowDataBound" EnableViewState="false">
        <Columns>
            ...
            <asp:BoundField HeaderText="解约日期" DataField="ReleaseDate" />
            <asp:BoundField HeaderText="解约人" DataField="ReleaseOper" />
    ...
    <div id="cnbut" style="overflow:hidden;">
        ...
        <div style="border-bottom:#808080 1px solid;">
           <table cellpadding="0" cellspacing="0" class="tb2" style="display:none;">
            <tr>
                <td style="padding-left:0px;">
        ...
        <table cellpadding="0" cellspacing="0" width="100%">
            <tr>
                ...
                <td>
                    ...
                    <span class="sgreen">正常</span>
                    <span class="sblue">解约</span>
