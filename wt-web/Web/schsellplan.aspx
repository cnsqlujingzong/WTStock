<%@ page language="C#"  CodeFile="schsellplan.aspx.cs"     autoeventwireup="true" inherits="Web_SchSellPlan" theme="Themes" enableEventValidation="false" %>
    ...
    <div class="ftool">
        ...
        <div class="ftoolright">
            <table cellpadding="0" cellspacing="0" class="tb2">
                <tr>
                <td>
                <input style="display:none;" id="btnPrint" runat="server" type="button" value="打印" class="iprint" onclick="ChkPrint('XSDD');" />
                </td>
...
function ModBill()
{
    ChkMod(800, 480,'Sell/SellPlanMod.aspx','销售订单');
}
